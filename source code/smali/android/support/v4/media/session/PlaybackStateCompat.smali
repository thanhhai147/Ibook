...
.field final U1:Ljava/lang/CharSequence;

.field final V1:J

.field W1:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;",
...
.field final Y1:Landroid/os/Bundle;

.field private Z1:Ljava/lang/Object;
...
.method constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/List;JLandroid/os/Bundle;)V
    ...
    .line 5
    iput v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->x:F
    ...
    .line 7
    iput v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->N:I

    move-object v1, p10

    .line 8
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->U1:Ljava/lang/CharSequence;

    move-wide v1, p11

    .line 9
    iput-wide v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->V1:J
    ...
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->W1:Ljava/util/List;

    move-wide/from16 v1, p14

    .line 11
    iput-wide v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->X1:J

    move-object/from16 v1, p16

    .line 12
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->Y1:Landroid/os/Bundle;
...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    iput v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->x:F
    ...
    iput-wide v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->V1:J
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->U1:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->W1:Ljava/util/List;
    ...
    iput-wide v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->X1:J
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->Y1:Landroid/os/Bundle;
...
.method public static a(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 17
    iput-object v0, v1, Landroid/support/v4/media/session/PlaybackStateCompat;->Z1:Ljava/lang/Object;
...
.method public toString()Ljava/lang/String;
    ...
    iget v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->x:F
    ...
    iget-wide v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->V1:J
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->U1:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->W1:Ljava/util/List;
    ...
    iget-wide v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->X1:J
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 3
    iget v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->x:F

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeFloat(F)V

    .line 4
    iget-wide v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->V1:J
    ...
    .line 7
    iget-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->U1:Ljava/lang/CharSequence;

    invoke-static {v0, p1, p2}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    .line 8
    iget-object p2, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->W1:Ljava/util/List;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeTypedList(Ljava/util/List;)V

    .line 9
    iget-wide v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->X1:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    .line 10
    iget-object p2, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->Y1:Landroid/os/Bundle;
