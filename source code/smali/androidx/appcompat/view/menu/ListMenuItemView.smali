...
.field private Z1:Landroid/content/Context;
...
.field private d2:Landroid/view/LayoutInflater;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Ld/a/j;->L1:[I

    const/4 v2, 0x0

    invoke-static {v0, p2, v1, p3, v2}, Landroidx/appcompat/widget/v0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/v0;
    ...
    iput-object p3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->X1:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p2, p3, v0}, Landroidx/appcompat/widget/v0;->n(II)I

    move-result p3

    iput p3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->Y1:I
    ...
    iput-boolean p3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a2:Z

    .line 7
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->Z1:Landroid/content/Context;
    ...
    iput-object p3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b2:Landroid/graphics/drawable/Drawable;
    ...
    iput-boolean p3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->c2:Z
...
.method private b(Landroid/view/View;I)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->W1:Landroid/widget/LinearLayout;
...
.method private d()V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->y:Landroid/widget/CheckBox;
...
.method private getInflater()Landroid/view/LayoutInflater;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->d2:Landroid/view/LayoutInflater;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->d2:Landroid/view/LayoutInflater;
...
.method private setSubMenuArrowVisible(Z)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->U1:Landroid/widget/ImageView;
...
.method protected onFinishInflate()V
    ...
    .line 2
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->X1:Landroid/graphics/drawable/Drawable;
    ...
    .line 4
    iget v1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->Y1:I
    ...
    .line 5
    iget-object v2, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->Z1:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->U1:Landroid/widget/ImageView;

    if-eqz v0, :cond_1

    .line 8
    iget-object v1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b2:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->W1:Landroid/widget/LinearLayout;
...
.method protected onMeasure(II)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a2:Z
...
.method public setCheckable(Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->y:Landroid/widget/CheckBox;
    ...
    .line 6
    iget-object v1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->y:Landroid/widget/CheckBox;
    ...
    .line 16
    :cond_5
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->y:Landroid/widget/CheckBox;
...
.method public setForceShowIcon(Z)V
    ...
    .line 1
    iput-boolean p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->e2:Z

    iput-boolean p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a2:Z
...
.method public setGroupDividerEnabled(Z)V
    ...
    .line 2
    iget-boolean v1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->c2:Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->e2:Z
    ...
    .line 2
    iget-boolean v2, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a2:Z
    ...
    iget-boolean v3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a2:Z
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->x:Landroid/widget/TextView;

    invoke-virtual {v0, p1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 2
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->x:Landroid/widget/TextView;
