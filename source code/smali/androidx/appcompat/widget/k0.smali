...
.field private g:Landroidx/appcompat/widget/k0$e;
...
.method private a(Ljava/lang/String;Landroidx/appcompat/widget/k0$d;)V
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/k0;->b:Ld/e/g;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/k0;->b:Ld/e/g;
...
.method private declared-synchronized b(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Ld/e/d;->o(JLjava/lang/Object;)V
    :try_end_0
...
.method private c(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    .line 6
    :cond_1
    invoke-virtual {v0, p2, p3}, Ld/e/h;->b(ILjava/lang/Object;)V
...
.method private f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 7
    :cond_1
    iget-object v3, p0, Landroidx/appcompat/widget/k0;->g:Landroidx/appcompat/widget/k0$e;
    ...
    .line 8
    :cond_2
    invoke-interface {v3, p0, p1, p2}, Landroidx/appcompat/widget/k0$e;->a(Landroidx/appcompat/widget/k0;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private declared-synchronized i(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Ld/e/d;->p(J)V
    :try_end_2
...
.method public static declared-synchronized l(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    .line 3
    invoke-virtual {v1, p0, p1, v2}, Landroidx/appcompat/widget/k0$c;->j(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private n(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 3
    invoke-virtual {p1, p2}, Ld/e/h;->f(I)Ljava/lang/Object;
...
.method private static p(Landroidx/appcompat/widget/k0;)V
    ...
    .line 2
    new-instance v0, Landroidx/appcompat/widget/k0$f;

    invoke-direct {v0}, Landroidx/appcompat/widget/k0$f;-><init>()V

    const-string v1, "vector"

    invoke-direct {p0, v1, v0}, Landroidx/appcompat/widget/k0;->a(Ljava/lang/String;Landroidx/appcompat/widget/k0$d;)V
...
.method private r(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    iget-object v0, p0, Landroidx/appcompat/widget/k0;->c:Ld/e/h;
    ...
    .line 3
    invoke-virtual {v0, p2}, Ld/e/h;->f(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/k0;->b:Ld/e/g;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/k0;->c:Ld/e/h;
    ...
    .line 19
    iget-object v8, p0, Landroidx/appcompat/widget/k0;->c:Ld/e/h;

    invoke-virtual {v8, p2, v3}, Ld/e/h;->b(ILjava/lang/Object;)V

    .line 20
    iget-object v8, p0, Landroidx/appcompat/widget/k0;->b:Ld/e/g;

    invoke-virtual {v8, v3}, Ld/e/g;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroidx/appcompat/widget/k0$d;
    ...
    .line 22
    invoke-interface {v3, p1, v1, v7, v8}, Landroidx/appcompat/widget/k0$d;->a(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 27
    iget-object p1, p0, Landroidx/appcompat/widget/k0;->c:Ld/e/h;

    invoke-virtual {p1, p2, v2}, Ld/e/h;->b(ILjava/lang/Object;)V
...
.method private v(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 8
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/k0;->g:Landroidx/appcompat/widget/k0$e;

    if-eqz v0, :cond_2

    invoke-interface {v0, p1, p2, p4}, Landroidx/appcompat/widget/k0$e;->e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method declared-synchronized m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/k0$e;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method o(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/k0$e;->d(I)Landroid/graphics/PorterDuff$Mode;
...
.method declared-synchronized t(Landroid/content/Context;Landroidx/appcompat/widget/a1;I)Landroid/graphics/drawable/Drawable;
    .locals 1
...
.method public declared-synchronized u(Landroidx/appcompat/widget/k0$e;)V
    .locals 0
    ...
    .line 1
    :try_start_0
    iput-object p1, p0, Landroidx/appcompat/widget/k0;->g:Landroidx/appcompat/widget/k0$e;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method x(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-interface {v0, p1, p2, p3}, Landroidx/appcompat/widget/k0$e;->c(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
