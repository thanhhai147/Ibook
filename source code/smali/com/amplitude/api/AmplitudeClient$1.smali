...
.method public run()V
    ...
    invoke-static {v0}, Lcom/amplitude/api/AmplitudeClient;->access$100(Lcom/amplitude/api/AmplitudeClient;)Ljava/lang/String;
    ...
    iget-object v4, v3, Lcom/amplitude/api/AmplitudeClient;->httpClient:Lokhttp3/OkHttpClient;

    iget-object v5, p0, Lcom/amplitude/api/AmplitudeClient$1;->val$apiKey:Ljava/lang/String;

    iget-object v3, v3, Lcom/amplitude/api/AmplitudeClient;->deviceId:Ljava/lang/String;

    invoke-virtual {v0, v4, v5, v3}, Lcom/amplitude/api/Diagnostics;->enableLogging(Lokhttp3/OkHttpClient;Ljava/lang/String;Ljava/lang/String;)Lcom/amplitude/api/Diagnostics;
    ...
    .line 12
    :try_start_1
    iget-object v4, p0, Lcom/amplitude/api/AmplitudeClient$1;->val$client:Lcom/amplitude/api/AmplitudeClient;

    iput-object v0, v4, Lcom/amplitude/api/AmplitudeClient;->userId:Ljava/lang/String;
    ...
    invoke-virtual {v4, v3, v0}, Lcom/amplitude/api/DatabaseHelper;->insertOrReplaceKeyValue(Ljava/lang/String;Ljava/lang/String;)J
    ...
    invoke-static {v0, v3, v4, v5}, Lcom/amplitude/api/AmplitudeClient;->access$300(Lcom/amplitude/api/AmplitudeClient;Ljava/lang/String;J)J

    move-result-wide v6

    iput-wide v6, v0, Lcom/amplitude/api/AmplitudeClient;->previousSessionId:J

    .line 18
    iget-object v0, p0, Lcom/amplitude/api/AmplitudeClient$1;->this$0:Lcom/amplitude/api/AmplitudeClient;

    iget-wide v6, v0, Lcom/amplitude/api/AmplitudeClient;->previousSessionId:J
    ...
    .line 19
    iput-wide v6, v0, Lcom/amplitude/api/AmplitudeClient;->sessionId:J

    :cond_4
    const-string v3, "sequence_number"

    .line 20
    invoke-static {v0, v3, v8, v9}, Lcom/amplitude/api/AmplitudeClient;->access$300(Lcom/amplitude/api/AmplitudeClient;Ljava/lang/String;J)J

    move-result-wide v6

    iput-wide v6, v0, Lcom/amplitude/api/AmplitudeClient;->sequenceNumber:J
    ...
    iput-wide v6, v0, Lcom/amplitude/api/AmplitudeClient;->lastEventId:J
    ...
    iput-wide v6, v0, Lcom/amplitude/api/AmplitudeClient;->lastIdentifyId:J
