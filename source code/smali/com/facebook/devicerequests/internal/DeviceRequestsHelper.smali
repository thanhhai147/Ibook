...
.method public static generateQRCode(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    .line 3
    :try_start_1
    new-instance v3, Lf/f/f/k;

    invoke-direct {v3}, Lf/f/f/k;-><init>()V

    sget-object v5, Lf/f/f/a;->Z1:Lf/f/f/a;
    ...
    .line 4
    invoke-virtual/range {v3 .. v8}, Lf/f/f/k;->a(Ljava/lang/String;Lf/f/f/a;IILjava/util/Map;)Lf/f/f/x/b;
    ...
    .line 8
    invoke-virtual {p0, v6, v3}, Lf/f/f/x/b;->f(II)Z
    ...
    move-result-object p0
    :try_end_1
    .catch Lf/f/f/v; {:try_start_1 .. :try_end_1} :catch_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :try_end_2
    .catch Lf/f/f/v; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
