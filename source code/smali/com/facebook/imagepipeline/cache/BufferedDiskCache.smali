...
.method private containsAsync(Lcom/facebook/cache/common/CacheKey;)Le/f;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v1}, Le/f;->c(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Le/f;
    ...
    .line 5
    invoke-static {v0}, Le/f;->k(Ljava/lang/Exception;)Le/f;
...
.method private foundPinnedImage(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/imagepipeline/image/EncodedImage;)Le/f;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    invoke-static {p2}, Le/f;->l(Ljava/lang/Object;)Le/f;
...
.method private getAsync(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Le/f;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p2}, Le/f;->c(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Le/f;
    ...
    .line 5
    invoke-static {p2}, Le/f;->k(Ljava/lang/Exception;)Le/f;
...
.method public contains(Lcom/facebook/cache/common/CacheKey;)Le/f;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    :cond_0
    invoke-direct {p0, p1}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->containsAsync(Lcom/facebook/cache/common/CacheKey;)Le/f;
...
.method public get(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Le/f;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    invoke-direct {p0, p1, v0}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->foundPinnedImage(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/imagepipeline/image/EncodedImage;)Le/f;
    ...
    :cond_2
    :try_start_1
    invoke-direct {p0, p1, p2}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->getAsync(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Le/f;
...
.method public remove(Lcom/facebook/cache/common/CacheKey;)Le/f;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
