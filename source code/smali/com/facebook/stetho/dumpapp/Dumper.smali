...
.field private final mParser:Ln/a/a/a/c;
...
.method public constructor <init>(Ljava/lang/Iterable;)V
    ...
    invoke-direct {v0}, Ln/a/a/a/d;-><init>()V

    invoke-direct {p0, p1, v0}, Lcom/facebook/stetho/dumpapp/Dumper;-><init>(Ljava/lang/Iterable;Ln/a/a/a/c;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/Iterable;Ln/a/a/a/c;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    iput-object p2, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Ln/a/a/a/c;
...
.method private doDump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    .line 1
    iget-object v0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Ln/a/a/a/c;

    iget-object v1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v1, v1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Ln/a/a/a/l;

    const/4 v2, 0x1

    invoke-interface {v0, v1, p4, v2}, Ln/a/a/a/c;->a(Ln/a/a/a/l;[Ljava/lang/String;Z)Ln/a/a/a/b;
    ...
    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionHelp:Ln/a/a/a/i;

    invoke-virtual {v0}, Ln/a/a/a/i;->l()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p4, v0}, Ln/a/a/a/b;->d(Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionListPlugins:Ln/a/a/a/i;
    ...
    .line 6
    :cond_1
    invoke-virtual {p4}, Ln/a/a/a/b;->c()Ljava/util/List;
    ...
    .line 7
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/facebook/stetho/dumpapp/Dumper;->dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Ln/a/a/a/b;)V
...
.method private dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Ln/a/a/a/b;)V
    .locals 7
    ...
    iget-object v4, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Ln/a/a/a/c;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/facebook/stetho/dumpapp/DumperContext;-><init>(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Ln/a/a/a/c;Ljava/util/List;)V
...
.method private dumpUsage(Ljava/io/PrintStream;)V
    ...
    .line 4
    :try_start_0
    invoke-virtual {v0}, Ln/a/a/a/f;->f()I

    move-result v2

    iget-object p1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v3, p1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Ln/a/a/a/l;

    .line 5
    invoke-virtual {v0}, Ln/a/a/a/f;->d()I

    move-result v4

    .line 6
    invoke-virtual {v0}, Ln/a/a/a/f;->c()I
    ...
    .line 7
    invoke-virtual/range {v0 .. v5}, Ln/a/a/a/f;->g(Ljava/io/PrintWriter;ILn/a/a/a/l;II)V
    :try_end_0
...
.method public dump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    move-result p1
    :try_end_0
    .catch Ln/a/a/a/m; {:try_start_0 .. :try_end_0} :catch_3
