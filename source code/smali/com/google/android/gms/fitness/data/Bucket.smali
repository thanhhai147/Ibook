...
.field private final q:Lcom/google/android/gms/fitness/data/f;
...
.method constructor <init>(JJLcom/google/android/gms/fitness/data/f;ILjava/util/List;IZ)V
    ...
    .line 2
    iput-boolean v0, p0, Lcom/google/android/gms/fitness/data/Bucket;->U1:Z
    ...
    .line 5
    iput-object p5, p0, Lcom/google/android/gms/fitness/data/Bucket;->q:Lcom/google/android/gms/fitness/data/f;

    .line 6
    iput p6, p0, Lcom/google/android/gms/fitness/data/Bucket;->x:I

    .line 7
    iput-object p7, p0, Lcom/google/android/gms/fitness/data/Bucket;->y:Ljava/util/List;

    .line 8
    iput p8, p0, Lcom/google/android/gms/fitness/data/Bucket;->N:I

    .line 9
    iput-boolean p9, p0, Lcom/google/android/gms/fitness/data/Bucket;->U1:Z
...
.method public constructor <init>(Lcom/google/android/gms/fitness/data/RawBucket;Ljava/util/List;)V
    ...
    iget-object v5, p1, Lcom/google/android/gms/fitness/data/RawBucket;->q:Lcom/google/android/gms/fitness/data/f;

    iget v6, p1, Lcom/google/android/gms/fitness/data/RawBucket;->x:I

    iget-object v0, p1, Lcom/google/android/gms/fitness/data/RawBucket;->y:Ljava/util/List;
    ...
    .line 14
    :cond_0
    iget v8, p1, Lcom/google/android/gms/fitness/data/RawBucket;->N:I

    iget-boolean v9, p1, Lcom/google/android/gms/fitness/data/RawBucket;->U1:Z
...
# virtual methods
.method public C0(Lcom/google/android/gms/fitness/data/DataType;)Lcom/google/android/gms/fitness/data/DataSet;
    .locals 3

    .line 1
    iget-object v0, p0, Lcom/google/android/gms/fitness/data/Bucket;->y:Ljava/util/List;
    ...
    .line 2
    invoke-virtual {v1}, Lcom/google/android/gms/fitness/data/DataSet;->G0()Lcom/google/android/gms/fitness/data/DataType;
...
.method public W0(Ljava/util/concurrent/TimeUnit;)J
    .locals 3
...
.method public final a()Z
    ...
    .line 1
    iget-boolean v0, p0, Lcom/google/android/gms/fitness/data/Bucket;->U1:Z
...
.method public b1()Lcom/google/android/gms/fitness/data/f;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/google/android/gms/fitness/data/Bucket;->q:Lcom/google/android/gms/fitness/data/f;

    return-object v0
.end method

.method public c1(Ljava/util/concurrent/TimeUnit;)J
    .locals 3
...
.method public final e1(Lcom/google/android/gms/fitness/data/Bucket;)Z
    .locals 5
    ...
    iget v0, p0, Lcom/google/android/gms/fitness/data/Bucket;->x:I

    iget v1, p1, Lcom/google/android/gms/fitness/data/Bucket;->x:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lcom/google/android/gms/fitness/data/Bucket;->N:I

    iget p1, p1, Lcom/google/android/gms/fitness/data/Bucket;->N:I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v1, p0, Lcom/google/android/gms/fitness/data/Bucket;->x:I

    iget v3, p1, Lcom/google/android/gms/fitness/data/Bucket;->x:I

    if-ne v1, v3, :cond_2

    iget-object v1, p0, Lcom/google/android/gms/fitness/data/Bucket;->y:Ljava/util/List;

    iget-object v3, p1, Lcom/google/android/gms/fitness/data/Bucket;->y:Ljava/util/List;
    ...
    iget v1, p0, Lcom/google/android/gms/fitness/data/Bucket;->N:I

    iget v3, p1, Lcom/google/android/gms/fitness/data/Bucket;->N:I

    if-ne v1, v3, :cond_2

    iget-boolean v1, p0, Lcom/google/android/gms/fitness/data/Bucket;->U1:Z

    iget-boolean p1, p1, Lcom/google/android/gms/fitness/data/Bucket;->U1:Z
...
.method public toString()Ljava/lang/String;
    ...
    .line 6
    invoke-static {v1}, Lcom/google/android/gms/fitness/data/Bucket;->d1(I)Ljava/lang/String;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 6
    invoke-virtual {p0}, Lcom/google/android/gms/fitness/data/Bucket;->b1()Lcom/google/android/gms/fitness/data/f;
    ...
    .line 8
    iget p2, p0, Lcom/google/android/gms/fitness/data/Bucket;->x:I
    ...
    .line 10
    invoke-virtual {p0}, Lcom/google/android/gms/fitness/data/Bucket;->G0()Ljava/util/List;
    ...
    .line 12
    invoke-virtual {p0}, Lcom/google/android/gms/fitness/data/Bucket;->y0()I
