...
.method public initialize(Landroid/graphics/SurfaceTexture;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p1}, Lexpo/modules/gl/GLObjectManagerModule;->getModuleRegistry()Ln/e/b/e;
    ...
    check-cast v3, Ln/e/b/l/j;

    .line 7
    const-class v1, Ln/e/b/l/p;

    invoke-virtual {p1, v1}, Ln/e/b/e;->f(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Ln/e/b/l/p;
    ...
    invoke-direct/range {v1 .. v6}, Lexpo/modules/gl/GLContext$1;-><init>(Lexpo/modules/gl/GLContext;Ln/e/b/l/j;Ln/e/b/l/r/c;Lexpo/modules/gl/GLContext;Ljava/lang/Runnable;)V

    invoke-interface {v0, p1}, Ln/e/b/l/r/c;->runOnClientCodeQueueThread(Ljava/lang/Runnable;)V
...
.method public takeSnapshot(Ljava/util/Map;Landroid/content/Context;Ln/e/b/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lexpo/modules/gl/GLContext$3;-><init>(Lexpo/modules/gl/GLContext;Ljava/util/Map;Landroid/content/Context;Ln/e/b/h;)V
