...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lexpo/modules/localauthentication/LocalAuthenticationModule;->authenticateAsync(Ljava/util/Map;Ln/e/b/h;)V
.end annotation
...
.field final synthetic val$fragmentActivity:Landroidx/fragment/app/e;
...
# direct methods
.method constructor <init>(Lexpo/modules/localauthentication/LocalAuthenticationModule;Ln/e/b/h;Ljava/util/Map;Landroidx/fragment/app/e;)V
    .locals 0
    ...
    iput-object p2, p0, Lexpo/modules/localauthentication/LocalAuthenticationModule$2;->val$promise:Ln/e/b/h;

    iput-object p3, p0, Lexpo/modules/localauthentication/LocalAuthenticationModule$2;->val$options:Ljava/util/Map;

    iput-object p4, p0, Lexpo/modules/localauthentication/LocalAuthenticationModule$2;->val$fragmentActivity:Landroidx/fragment/app/e;
...
.method public run()V
    ...
    iget-object v1, p0, Lexpo/modules/localauthentication/LocalAuthenticationModule$2;->val$promise:Ln/e/b/h;

    invoke-static {v0, v1}, Lexpo/modules/localauthentication/LocalAuthenticationModule;->access$402(Lexpo/modules/localauthentication/LocalAuthenticationModule;Ln/e/b/h;)Ln/e/b/h;
    ...
    iget-object v4, p0, Lexpo/modules/localauthentication/LocalAuthenticationModule$2;->val$promise:Ln/e/b/h;

    invoke-static {v2, v4}, Lexpo/modules/localauthentication/LocalAuthenticationModule;->access$402(Lexpo/modules/localauthentication/LocalAuthenticationModule;Ln/e/b/h;)Ln/e/b/h;
    ...
    iget-object v6, p0, Lexpo/modules/localauthentication/LocalAuthenticationModule$2;->val$fragmentActivity:Landroidx/fragment/app/e;

    invoke-static {v4}, Lexpo/modules/localauthentication/LocalAuthenticationModule;->access$500(Lexpo/modules/localauthentication/LocalAuthenticationModule;)Landroidx/biometric/BiometricPrompt$a;

    move-result-object v7

    invoke-direct {v5, v6, v2, v7}, Landroidx/biometric/BiometricPrompt;-><init>(Landroidx/fragment/app/e;Ljava/util/concurrent/Executor;Landroidx/biometric/BiometricPrompt$a;)V
    ...
    .line 18
    invoke-virtual {v2, v0}, Landroidx/biometric/BiometricPrompt$d$a;->d(Ljava/lang/CharSequence;)Landroidx/biometric/BiometricPrompt$d$a;
    ...
    .line 20
    invoke-virtual {v2, v0}, Landroidx/biometric/BiometricPrompt$d$a;->b(I)Landroidx/biometric/BiometricPrompt$d$a;

    .line 21
    :goto_1
    invoke-virtual {v2}, Landroidx/biometric/BiometricPrompt$d$a;->a()Landroidx/biometric/BiometricPrompt$d;
    ...
    invoke-virtual {v1, v0}, Landroidx/biometric/BiometricPrompt;->a(Landroidx/biometric/BiometricPrompt$d;)V
    :try_end_0
    ...
    .line 23
    :catch_0
    iget-object v0, p0, Lexpo/modules/localauthentication/LocalAuthenticationModule$2;->val$promise:Ln/e/b/h;

    const-string v1, "E_INTERNAL_ERRROR"

    const-string v2, "Canceled authentication due to an internal error"

    invoke-interface {v0, v1, v2}, Ln/e/b/h;->reject(Ljava/lang/String;Ljava/lang/String;)V
