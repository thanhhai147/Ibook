...
.field private mTask:Ln/e/c/j/d;
...
.method public constructor <init>(Landroid/content/Context;Ln/e/c/j/f;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Ln/e/c/j/a;-><init>(Landroid/content/Context;Ln/e/c/j/f;)V
...
.method private executeTaskWithLocationBundles(Ljava/util/ArrayList;Ln/e/c/j/c;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lexpo/modules/location/taskConsumers/LocationTaskConsumer;->mTask:Ln/e/c/j/d;
    ...
    .line 4
    iget-object p1, p0, Lexpo/modules/location/taskConsumers/LocationTaskConsumer;->mTask:Ln/e/c/j/d;

    invoke-interface {p1, v0, v1, p2}, Ln/e/c/j/d;->execute(Landroid/os/Bundle;Ljava/lang/Error;Ln/e/c/j/c;)V

    goto :goto_0

    .line 5
    :cond_0
    invoke-interface {p2, v1}, Ln/e/c/j/c;->onFinished(Ljava/util/Map;)V
...
.method private maybeReportDeferredLocations()V
    ...
    .line 2
    :cond_0
    invoke-virtual {p0}, Ln/e/c/j/a;->getContext()Landroid/content/Context;
    ...
    .line 14
    invoke-virtual {p0}, Ln/e/c/j/a;->getTaskManagerUtils()Ln/e/c/j/f;

    move-result-object v2

    iget-object v3, p0, Lexpo/modules/location/taskConsumers/LocationTaskConsumer;->mTask:Ln/e/c/j/d;

    invoke-interface {v2, v0, v3, v1}, Ln/e/c/j/f;->scheduleJob(Landroid/content/Context;Ln/e/c/j/d;Ljava/util/List;)V
...
.method private maybeStartForegroundService()V
    ...
    .line 2
    :cond_0
    new-instance v0, Ln/e/b/j/a;

    iget-object v1, p0, Lexpo/modules/location/taskConsumers/LocationTaskConsumer;->mTask:Ln/e/c/j/d;

    invoke-interface {v1}, Ln/e/c/j/d;->getOptions()Ljava/util/Map;

    move-result-object v1

    invoke-direct {v0, v1}, Ln/e/b/j/a;-><init>(Ljava/util/Map;)V
    ...
    .line 4
    iget-object v2, p0, Lexpo/modules/location/taskConsumers/LocationTaskConsumer;->mTask:Ln/e/c/j/d;

    invoke-interface {v2}, Ln/e/c/j/d;->getOptions()Ljava/util/Map;

    move-result-object v2

    invoke-static {v2}, Lexpo/modules/location/taskConsumers/LocationTaskConsumer;->shouldUseForegroundService(Ljava/util/Map;)Z
    ...
    .line 10
    invoke-interface {v0, v2}, Ln/e/b/j/c;->e(Ljava/lang/String;)Ln/e/b/j/c;

    move-result-object v0

    invoke-interface {v0}, Ln/e/b/j/c;->toBundle()Landroid/os/Bundle;
    ...
    invoke-interface {v2}, Ln/e/c/j/d;->getAppId()Ljava/lang/String;
    ...
    invoke-interface {v2}, Ln/e/c/j/d;->getName()Ljava/lang/String;
...
.method private preparePendingIntent()Landroid/app/PendingIntent;
    ...
    invoke-interface {v0, v1, v2}, Ln/e/c/j/f;->createTaskIntent(Landroid/content/Context;Ln/e/c/j/d;)Landroid/app/PendingIntent;
...
.method private shouldReportDeferredLocations()Z
    ...
    .line 5
    new-instance v4, Ln/e/b/d;

    iget-object v5, p0, Lexpo/modules/location/taskConsumers/LocationTaskConsumer;->mTask:Ln/e/c/j/d;

    invoke-interface {v5}, Ln/e/c/j/d;->getOptions()Ljava/util/Map;

    move-result-object v5

    invoke-direct {v4, v5}, Ln/e/b/d;-><init>(Ljava/util/Map;)V

    const-string v5, "deferredUpdatesDistance"

    .line 6
    invoke-interface {v4, v5}, Ln/e/b/l/c;->getDouble(Ljava/lang/String;)D
    ...
    .line 7
    invoke-interface {v4, v7}, Ln/e/b/l/c;->a(Ljava/lang/String;)J
...
.method public static shouldUseForegroundService(Ljava/util/Map;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private startLocationUpdates()V
    ...
    invoke-virtual {v0, v2, v3}, Lcom/google/android/gms/location/e;->x(Lcom/google/android/gms/location/LocationRequest;Landroid/app/PendingIntent;)Lf/f/b/e/k/i;
    :try_end_0
...
.method private stopLocationUpdates()V
    ...
    .line 2
    invoke-virtual {v0, v1}, Lcom/google/android/gms/location/e;->v(Landroid/app/PendingIntent;)Lf/f/b/e/k/i;
...
.method public didExecuteJob(Landroid/app/job/JobService;Landroid/app/job/JobParameters;)Z
    ...
    invoke-interface {v0, p2}, Ln/e/c/j/f;->extractDataFromJobParams(Landroid/app/job/JobParameters;)Ljava/util/List;
    ...
    invoke-direct {p0, v1, v0}, Lexpo/modules/location/taskConsumers/LocationTaskConsumer;->executeTaskWithLocationBundles(Ljava/util/ArrayList;Ln/e/c/j/c;)V
...
.method public didReceiveBroadcast(Landroid/content/Intent;)V
    ...
    .line 2
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/location/LocationResult;->v0(Landroid/content/Intent;)Lcom/google/android/gms/location/LocationResult;
    ...
    .line 3
    invoke-virtual {p1}, Lcom/google/android/gms/location/LocationResult;->C0()Ljava/util/List;
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/location/e;->u()Lf/f/b/e/k/i;
    ...
    invoke-virtual {p1, v0}, Lf/f/b/e/k/i;->c(Lf/f/b/e/k/d;)Lf/f/b/e/k/i;
    :try_end_0
    .catch Ljava/lang/SecurityException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public didRegister(Ln/e/c/j/d;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lexpo/modules/location/taskConsumers/LocationTaskConsumer;->mTask:Ln/e/c/j/d;
...
.method public didUnregister()V
    ...
    .line 3
    iput-object v0, p0, Lexpo/modules/location/taskConsumers/LocationTaskConsumer;->mTask:Ln/e/c/j/d;
...
.method public setOptions(Ljava/util/Map;)V
    ...
    .line 1
    invoke-super {p0, p1}, Ln/e/c/j/a;->setOptions(Ljava/util/Map;)V
