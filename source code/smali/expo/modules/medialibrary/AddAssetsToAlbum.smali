...
# direct methods
.method constructor <init>(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;ZLn/e/b/h;)V
    .locals 0
    ...
    .line 5
    iput-object p5, p0, Lexpo/modules/medialibrary/AddAssetsToAlbum;->mPromise:Ln/e/b/h;
...
.method private synthetic a(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/String;Landroid/net/Uri;)V
    .locals 0
    ...
    .line 2
    iget-object p1, p0, Lexpo/modules/medialibrary/AddAssetsToAlbum;->mPromise:Ln/e/b/h;
...
.method private getAlbum()Ljava/io/File;
    ...
    .line 4
    :try_start_0
    iget-object v0, p0, Lexpo/modules/medialibrary/AddAssetsToAlbum;->mPromise:Ln/e/b/h;

    const-string v3, "E_UNABLE_TO_LOAD"

    const-string v4, "Could not get album. Query returns null."

    invoke-interface {v0, v3, v4}, Ln/e/b/h;->reject(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
# virtual methods
.method public synthetic b(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/String;Landroid/net/Uri;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lexpo/modules/medialibrary/AddAssetsToAlbum;->a(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/String;Landroid/net/Uri;)V
...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Void;
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lexpo/modules/medialibrary/AddAssetsToAlbum;->mContext:Landroid/content/Context;

    iget-object v1, p0, Lexpo/modules/medialibrary/AddAssetsToAlbum;->mPromise:Ln/e/b/h;

    iget-object v2, p0, Lexpo/modules/medialibrary/AddAssetsToAlbum;->mAssetsId:[Ljava/lang/String;

    invoke-static {v0, v1, v2}, Lexpo/modules/medialibrary/MediaLibraryUtils;->getAssetsById(Landroid/content/Context;Ln/e/b/h;[Ljava/lang/String;)Ljava/util/List;
    ...
    const-string v1, "E_NO_PERMISSIONS"

    const-string v2, "The application doesn\'t have permission to write to the album\'s directory. For more information, check out https://expo.fyi/android-r."
    ...
    check-cast v3, Lexpo/modules/medialibrary/MediaLibraryUtils$AssetFile;
    ...
    invoke-interface {v4, v3, v1, v5}, Lexpo/modules/medialibrary/MediaLibraryUtils$FileStrategy;->apply(Ljava/io/File;Ljava/io/File;Landroid/content/Context;)Ljava/io/File;
    ...
    new-instance v3, Lexpo/modules/medialibrary/a;

    invoke-direct {v3, p0, v0}, Lexpo/modules/medialibrary/a;-><init>(Lexpo/modules/medialibrary/AddAssetsToAlbum;Ljava/util/concurrent/atomic/AtomicInteger;)V
