...
.method private applyBadgeFromNotification(Landroid/app/Notification;)Z
    ...
    :try_end_0
    .catch Ln/e/b/k/b; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 3
    invoke-virtual {p1}, Ln/e/b/k/b;->getCode()Ljava/lang/String;
...
.method public onCreate(Ln/e/b/e;)V
    ...
    .line 1
    invoke-super {p0, p1}, Lexpo/modules/notifications/notifications/presentation/effects/BaseNotificationEffect;->onCreate(Ln/e/b/e;)V
