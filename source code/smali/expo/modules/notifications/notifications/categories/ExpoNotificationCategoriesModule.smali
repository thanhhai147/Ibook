...
.method public deleteNotificationCategoryAsync(Ljava/lang/String;Ln/e/b/h;)V
    ...
    invoke-direct {v2, p0, v3, p2}, Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule$3;-><init>(Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule;Landroid/os/Handler;Ln/e/b/h;)V
...
.method public getNotificationCategoriesAsync(Ln/e/b/h;)V
    ...
    invoke-direct {v2, p0, v3, p1}, Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule$1;-><init>(Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule;Landroid/os/Handler;Ln/e/b/h;)V
...
.method public setNotificationCategoryAsync(Ljava/lang/String;Ljava/util/List;Ljava/util/HashMap;Ln/e/b/h;)V
    ...
    invoke-direct {v2, v0}, Ln/e/b/j/a;-><init>(Ljava/util/Map;)V
    ...
    invoke-virtual {v2, v4, v3}, Ln/e/b/j/a;->h(Ljava/lang/String;Ljava/util/Map;)Ljava/util/Map;

    move-result-object v3

    invoke-direct {v0, v3}, Ln/e/b/j/a;-><init>(Ljava/util/Map;)V

    const-string v3, "textInput"

    .line 5
    invoke-virtual {v2, v3}, Ln/e/b/j/a;->j(Ljava/lang/String;)Z

    move-result v4

    if-eqz v4, :cond_0

    new-instance v4, Ln/e/b/j/a;

    invoke-interface {v2, v3}, Ln/e/b/j/c;->getMap(Ljava/lang/String;)Ljava/util/Map;

    move-result-object v3

    invoke-direct {v4, v3}, Ln/e/b/j/a;-><init>(Ljava/util/Map;)V
    ...
    invoke-virtual {v2, v7, v1}, Ln/e/b/j/a;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v2, v6, v1}, Ln/e/b/j/a;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    .line 7
    invoke-virtual {v0, v5, v3}, Ln/e/b/j/a;->a(Ljava/lang/String;Z)Z

    move-result v0

    const-string v3, "placeholder"

    invoke-virtual {v4, v3, v1}, Ln/e/b/j/a;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p1, p0, v1, p4}, Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule$2;-><init>(Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule;Landroid/os/Handler;Ln/e/b/h;)V
    ...
    invoke-direct {p1, p2}, Ln/e/b/k/d;-><init>(Ljava/lang/String;)V
