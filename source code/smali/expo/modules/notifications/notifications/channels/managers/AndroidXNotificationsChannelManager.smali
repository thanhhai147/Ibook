...
# instance fields
.field private final mNotificationManager:Landroidx/core/app/n;
...
.method public constructor <init>(Landroid/content/Context;Lexpo/modules/notifications/notifications/channels/managers/NotificationsChannelGroupManager;)V
    ...
    .line 2
    invoke-static {p1}, Landroidx/core/app/n;->i(Landroid/content/Context;)Landroidx/core/app/n;

    move-result-object v0

    iput-object v0, p0, Lexpo/modules/notifications/notifications/channels/managers/AndroidXNotificationsChannelManager;->mNotificationManager:Landroidx/core/app/n;
...
# virtual methods
.method protected configureChannelWithOptions(Ljava/lang/Object;Ln/e/b/j/c;)V
    .locals 3
    ...
    .line 3
    invoke-interface {p2, v0}, Ln/e/b/j/c;->j(Ljava/lang/String;)Z
    ...
    .line 4
    invoke-interface {p2, v0}, Ln/e/b/j/c;->getBoolean(Ljava/lang/String;)Z
    ...
    .line 6
    invoke-interface {p2, v0}, Ln/e/b/j/c;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v2, Ln/e/b/j/a;

    invoke-direct {v2}, Ln/e/b/j/a;-><init>()V

    invoke-interface {v1, v0, v0, v2}, Lexpo/modules/notifications/notifications/channels/managers/NotificationsChannelGroupManager;->createNotificationChannelGroup(Ljava/lang/String;Ljava/lang/CharSequence;Ln/e/b/j/c;)Landroid/app/NotificationChannelGroup;
    ...
    .line 15
    invoke-interface {p2, v0}, Ln/e/b/j/c;->getInt(Ljava/lang/String;)I
    ...
    invoke-interface {p2, v1}, Ln/e/b/j/c;->j(Ljava/lang/String;)Z
    ...
    .line 20
    :cond_8
    invoke-virtual {p0, p2}, Lexpo/modules/notifications/notifications/channels/managers/AndroidXNotificationsChannelManager;->createSoundUriFromArguments(Ln/e/b/j/c;)Landroid/net/Uri;

    move-result-object v0

    .line 21
    invoke-interface {p2, v1}, Ln/e/b/j/c;->e(Ljava/lang/String;)Ln/e/b/j/c;

    move-result-object v1

    invoke-virtual {p0, v1}, Lexpo/modules/notifications/notifications/channels/managers/AndroidXNotificationsChannelManager;->createAttributesFromArguments(Ln/e/b/j/c;)Landroid/media/AudioAttributes;
    ...
    .line 24
    invoke-interface {p2, v0}, Ln/e/b/j/c;->f(Ljava/lang/String;)Ljava/util/List;
...
.method protected createAttributesFromArguments(Ln/e/b/j/c;)Landroid/media/AudioAttributes;
    .locals 3
    ...
    .line 2
    invoke-interface {p1, v1}, Ln/e/b/j/c;->j(Ljava/lang/String;)Z
    ...
    .line 7
    invoke-interface {p1, v1}, Ln/e/b/j/c;->e(Ljava/lang/String;)Ln/e/b/j/c;
    ...
    .line 8
    invoke-interface {p1, v1}, Ln/e/b/j/c;->getBoolean(Ljava/lang/String;)Z
...
.method public createNotificationChannel(Ljava/lang/String;Ljava/lang/CharSequence;ILn/e/b/j/c;)Landroid/app/NotificationChannel;
    .locals 1
    ...
    .line 2
    invoke-virtual {p0, v0, p4}, Lexpo/modules/notifications/notifications/channels/managers/AndroidXNotificationsChannelManager;->configureChannelWithOptions(Ljava/lang/Object;Ln/e/b/j/c;)V

    .line 3
    iget-object p1, p0, Lexpo/modules/notifications/notifications/channels/managers/AndroidXNotificationsChannelManager;->mNotificationManager:Landroidx/core/app/n;

    invoke-virtual {p1, v0}, Landroidx/core/app/n;->e(Landroid/app/NotificationChannel;)V

    return-object v0
.end method

.method protected createSoundUriFromArguments(Ln/e/b/j/c;)Landroid/net/Uri;
    .locals 2
...
.method public deleteNotificationChannel(Ljava/lang/String;)V
    ...
    .line 1
    iget-object v0, p0, Lexpo/modules/notifications/notifications/channels/managers/AndroidXNotificationsChannelManager;->mNotificationManager:Landroidx/core/app/n;

    invoke-virtual {v0, p1}, Landroidx/core/app/n;->g(Ljava/lang/String;)V
...
.method public getNotificationChannel(Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/app/n;->l(Ljava/lang/String;)Landroid/app/NotificationChannel;
...
.method public getNotificationChannels()Ljava/util/List;
    ...
    invoke-virtual {v0}, Landroidx/core/app/n;->o()Ljava/util/List;
