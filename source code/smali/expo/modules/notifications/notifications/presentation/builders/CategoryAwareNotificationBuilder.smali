...
# virtual methods
.method protected addActionsToBuilder(Landroidx/core/app/k$e;Ljava/lang/String;)V
    .locals 4
    ...
    invoke-virtual {p0, v0}, Lexpo/modules/notifications/notifications/presentation/builders/CategoryAwareNotificationBuilder;->buildTextInputAction(Lexpo/modules/notifications/notifications/model/TextInputNotificationAction;)Landroidx/core/app/k$a;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroidx/core/app/k$e;->b(Landroidx/core/app/k$a;)Landroidx/core/app/k$e;

    goto :goto_2

    .line 9
    :cond_1
    invoke-virtual {p0, v0}, Lexpo/modules/notifications/notifications/presentation/builders/CategoryAwareNotificationBuilder;->buildButtonAction(Lexpo/modules/notifications/notifications/model/NotificationAction;)Landroidx/core/app/k$a;
...
.method protected buildButtonAction(Lexpo/modules/notifications/notifications/model/NotificationAction;)Landroidx/core/app/k$a;
    .locals 3
    ...
    invoke-direct {v1, v2, p1, v0}, Landroidx/core/app/k$a$a;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V

    invoke-virtual {v1}, Landroidx/core/app/k$a$a;->b()Landroidx/core/app/k$a;
...
.method protected buildTextInputAction(Lexpo/modules/notifications/notifications/model/TextInputNotificationAction;)Landroidx/core/app/k$a;
    .locals 4
    ...
    invoke-direct {v1, v2}, Landroidx/core/app/o$a;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Landroidx/core/app/o$a;->b(Ljava/lang/CharSequence;)Landroidx/core/app/o$a;
    ...
    invoke-direct {v2, v3, p1, v0}, Landroidx/core/app/k$a$a;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V

    invoke-virtual {v2, v1}, Landroidx/core/app/k$a$a;->a(Landroidx/core/app/o;)Landroidx/core/app/k$a$a;

    invoke-virtual {v2}, Landroidx/core/app/k$a$a;->b()Landroidx/core/app/k$a;
...
.method protected createBuilder()Landroidx/core/app/k$e;
    .locals 2

    .line 1
    invoke-super {p0}, Lexpo/modules/notifications/notifications/presentation/builders/ExpoNotificationBuilder;->createBuilder()Landroidx/core/app/k$e;
    ...
    .line 4
    invoke-virtual {p0, v0, v1}, Lexpo/modules/notifications/notifications/presentation/builders/CategoryAwareNotificationBuilder;->addActionsToBuilder(Landroidx/core/app/k$e;Ljava/lang/String;)V
