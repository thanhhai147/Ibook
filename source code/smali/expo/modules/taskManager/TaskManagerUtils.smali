...
.method private createExtrasForTask(Ln/e/c/j/d;Ljava/util/List;)Landroid/os/PersistableBundle;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private createJobInfo(Landroid/content/Context;Ln/e/c/j/d;ILjava/util/List;)Landroid/app/job/JobInfo;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, p4}, Lexpo/modules/taskManager/TaskManagerUtils;->createExtrasForTask(Ln/e/c/j/d;Ljava/util/List;)Landroid/os/PersistableBundle;
...
.method private createTaskIntent(Landroid/content/Context;Ln/e/c/j/d;I)Landroid/app/PendingIntent;
    .locals 1

    .line 9
    invoke-interface {p2}, Ln/e/c/j/d;->getAppId()Ljava/lang/String;

    move-result-object v0

    .line 10
    invoke-interface {p2}, Ln/e/c/j/d;->getName()Ljava/lang/String;
...
.method private isJobInfoRelatedToTask(Landroid/app/job/JobInfo;Ln/e/c/j/d;)Z
    .locals 4
...
.method static notifyTaskJobCancelled(Ln/e/c/j/d;)Z
    .locals 2
...
.method private updateOrScheduleJob(Landroid/content/Context;Ln/e/c/j/d;Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-direct {p0, v3, p2}, Lexpo/modules/taskManager/TaskManagerUtils;->isJobInfoRelatedToTask(Landroid/app/job/JobInfo;Ln/e/c/j/d;)Z
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, p1, p2, v2, p3}, Lexpo/modules/taskManager/TaskManagerUtils;->createJobInfo(Landroid/content/Context;Ln/e/c/j/d;ILjava/util/List;)Landroid/app/job/JobInfo;
...
.method public createTaskIntent(Landroid/content/Context;Ln/e/c/j/d;)Landroid/app/PendingIntent;
    .locals 1

    const/high16 v0, 0x8000000

    .line 1
    invoke-direct {p0, p1, p2, v0}, Lexpo/modules/taskManager/TaskManagerUtils;->createTaskIntent(Landroid/content/Context;Ln/e/c/j/d;I)Landroid/app/PendingIntent;
...
.method public scheduleJob(Landroid/content/Context;Ln/e/c/j/d;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lexpo/modules/taskManager/TaskManagerUtils;->updateOrScheduleJob(Landroid/content/Context;Ln/e/c/j/d;Ljava/util/List;)V
