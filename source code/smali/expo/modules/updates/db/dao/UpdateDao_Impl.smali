...
.method public _keepUpdate(Ljava/util/UUID;)V
    ...
    invoke-virtual {v0}, Landroidx/room/n;->acquire()Ld/v/a/f;
    ...
    .line 4
    invoke-interface {v0, v1}, Ld/v/a/d;->y(I)V

    goto :goto_0

    .line 5
    :cond_0
    invoke-interface {v0, v1, p1}, Ld/v/a/d;->S0(I[B)V
    ...
    .line 7
    :try_start_0
    invoke-interface {v0}, Ld/v/a/f;->l()I
    ...
    invoke-virtual {p1, v0}, Landroidx/room/n;->release(Ld/v/a/f;)V
    ...
    invoke-virtual {v1, v0}, Landroidx/room/n;->release(Ld/v/a/f;)V
...
.method public _loadLaunchAsset(Ljava/util/UUID;)Lexpo/modules/updates/db/entity/AssetEntity;
    ...
    .line 3
    invoke-virtual {v3, v2}, Landroidx/room/m;->y(I)V

    goto :goto_0

    .line 4
    :cond_0
    invoke-virtual {v3, v2, v0}, Landroidx/room/m;->S0(I[B)V
    ...
    invoke-static {v0, v3, v4}, Landroidx/room/q/b;->b(Landroidx/room/j;Ld/v/a/e;Z)Landroid/database/Cursor;
    ...
    .line 39
    invoke-virtual {v3}, Landroidx/room/m;->h()V
...
.method public _loadUpdatesForProjectWithStatuses(Ljava/lang/String;Ljava/util/List;)Ljava/util/List;
    ...
    .line 10
    invoke-virtual {v2, v4}, Landroidx/room/m;->y(I)V

    goto :goto_0

    .line 11
    :cond_0
    invoke-virtual {v2, v4, v0}, Landroidx/room/m;->u(ILjava/lang/String;)V
    ...
    .line 14
    invoke-virtual {v2, v0, v5, v6}, Landroidx/room/m;->x(IJ)V
    ...
    invoke-static {v0, v2, v3}, Landroidx/room/q/b;->b(Landroidx/room/j;Ld/v/a/e;Z)Landroid/database/Cursor;
    ...
    .line 46
    invoke-virtual {v2}, Landroidx/room/m;->h()V
...
.method public _markUpdateWithStatus(Lexpo/modules/updates/db/enums/UpdateStatus;Ljava/util/UUID;)V
    ...
    .line 4
    invoke-interface {v0, p1, v1, v2}, Ld/v/a/d;->x(IJ)V
    ...
    .line 6
    invoke-interface {v0, p2}, Ld/v/a/d;->y(I)V

    goto :goto_0

    .line 7
    :cond_0
    invoke-interface {v0, p2, p1}, Ld/v/a/d;->S0(I[B)V
    ...
    invoke-virtual {p2, v0}, Landroidx/room/n;->release(Ld/v/a/f;)V
...
.method public loadAllUpdatesForScope(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 2
    invoke-virtual {v2, v3}, Landroidx/room/m;->y(I)V
    ...
    invoke-static {v0, v2, v4}, Landroidx/room/q/b;->b(Landroidx/room/j;Ld/v/a/e;Z)Landroid/database/Cursor;
