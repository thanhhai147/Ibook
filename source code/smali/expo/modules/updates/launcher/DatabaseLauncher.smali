...
.method public constructor <init>(Lexpo/modules/updates/UpdatesConfiguration;Ljava/io/File;Lexpo/modules/updates/loader/FileDownloader;Lexpo/modules/updates/launcher/SelectionPolicy;)V
    .locals 2
    ...
    .line 12
    iput-object p3, p0, Lexpo/modules/updates/launcher/DatabaseLauncher;->mFileDownloader:Lexpo/modules/updates/loader/FileDownloader;

    .line 13
    iput-object p4, p0, Lexpo/modules/updates/launcher/DatabaseLauncher;->mSelectionPolicy:Lexpo/modules/updates/launcher/SelectionPolicy;
...
.method private ensureAssetExists(Lexpo/modules/updates/db/entity/AssetEntity;Lexpo/modules/updates/db/UpdatesDatabase;Landroid/content/Context;)Ljava/io/File;
    ...
    .line 11
    iget-object p3, p0, Lexpo/modules/updates/launcher/DatabaseLauncher;->mFileDownloader:Lexpo/modules/updates/loader/FileDownloader;

    iget-object v0, p0, Lexpo/modules/updates/launcher/DatabaseLauncher;->mUpdatesDirectory:Ljava/io/File;

    iget-object v1, p0, Lexpo/modules/updates/launcher/DatabaseLauncher;->mConfiguration:Lexpo/modules/updates/UpdatesConfiguration;

    new-instance v3, Lexpo/modules/updates/launcher/DatabaseLauncher$1;

    invoke-direct {v3, p0, p2}, Lexpo/modules/updates/launcher/DatabaseLauncher$1;-><init>(Lexpo/modules/updates/launcher/DatabaseLauncher;Lexpo/modules/updates/db/UpdatesDatabase;)V

    invoke-virtual {p3, p1, v0, v1, v3}, Lexpo/modules/updates/loader/FileDownloader;->downloadAsset(Lexpo/modules/updates/db/entity/AssetEntity;Ljava/io/File;Lexpo/modules/updates/UpdatesConfiguration;Lexpo/modules/updates/loader/FileDownloader$AssetDownloadCallback;)V
...
.method public getLaunchableUpdate(Lexpo/modules/updates/db/UpdatesDatabase;Landroid/content/Context;)Lexpo/modules/updates/db/entity/UpdateEntity;
    ...
    invoke-static {p2, v1}, Lexpo/modules/updates/loader/EmbeddedLoader;->readEmbeddedManifest(Landroid/content/Context;Lexpo/modules/updates/UpdatesConfiguration;)Lexpo/modules/updates/manifest/Manifest;
    ...
    .line 5
    iget-object v3, v2, Lexpo/modules/updates/db/entity/UpdateEntity;->status:Lexpo/modules/updates/db/enums/UpdateStatus;
    ...
    iget-object v3, v3, Lexpo/modules/updates/db/entity/UpdateEntity;->id:Ljava/util/UUID;

    iget-object v4, v2, Lexpo/modules/updates/db/entity/UpdateEntity;->id:Ljava/util/UUID;
    ...
    .line 8
    :cond_1
    iget-object p2, p0, Lexpo/modules/updates/launcher/DatabaseLauncher;->mConfiguration:Lexpo/modules/updates/UpdatesConfiguration;

    invoke-static {p1, p2}, Lexpo/modules/updates/manifest/ManifestMetadata;->getManifestFilters(Lexpo/modules/updates/db/UpdatesDatabase;Lexpo/modules/updates/UpdatesConfiguration;)Lorg/json/JSONObject;

    move-result-object p1

    .line 9
    iget-object p2, p0, Lexpo/modules/updates/launcher/DatabaseLauncher;->mSelectionPolicy:Lexpo/modules/updates/launcher/SelectionPolicy;

    invoke-interface {p2, v1, p1}, Lexpo/modules/updates/launcher/SelectionPolicy;->selectUpdateToLaunch(Ljava/util/List;Lorg/json/JSONObject;)Lexpo/modules/updates/db/entity/UpdateEntity;
