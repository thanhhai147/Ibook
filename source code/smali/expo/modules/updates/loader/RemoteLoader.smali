...
.field private mFileDownloader:Lexpo/modules/updates/loader/FileDownloader;
...
.field private mManifest:Lexpo/modules/updates/manifest/Manifest;
...
.method public constructor <init>(Landroid/content/Context;Lexpo/modules/updates/UpdatesConfiguration;Lexpo/modules/updates/db/UpdatesDatabase;Lexpo/modules/updates/loader/FileDownloader;Ljava/io/File;)V
    .locals 1
    ...
    .line 10
    iput-object p5, p0, Lexpo/modules/updates/loader/RemoteLoader;->mUpdatesDirectory:Ljava/io/File;
...
.method static synthetic access$102(Lexpo/modules/updates/loader/RemoteLoader;Lexpo/modules/updates/manifest/Manifest;)Lexpo/modules/updates/manifest/Manifest;
    .locals 0

    .line 1
    iput-object p1, p0, Lexpo/modules/updates/loader/RemoteLoader;->mManifest:Lexpo/modules/updates/manifest/Manifest;

    return-object p1
.end method

.method static synthetic access$200(Lexpo/modules/updates/loader/RemoteLoader;)Lexpo/modules/updates/loader/RemoteLoader$LoaderCallback;
    .locals 0
...
.method static synthetic access$300(Lexpo/modules/updates/loader/RemoteLoader;Lexpo/modules/updates/manifest/Manifest;)V
    .locals 0
...
.method static synthetic access$402(Lexpo/modules/updates/loader/RemoteLoader;Lexpo/modules/updates/db/entity/UpdateEntity;)Lexpo/modules/updates/db/entity/UpdateEntity;
    .locals 0

    .line 1
    iput-object p1, p0, Lexpo/modules/updates/loader/RemoteLoader;->mUpdateEntity:Lexpo/modules/updates/db/entity/UpdateEntity;

    return-object p1
.end method

.method static synthetic access$500(Lexpo/modules/updates/loader/RemoteLoader;)V
    .locals 0
...
.method static synthetic access$700(Lexpo/modules/updates/loader/RemoteLoader;Lexpo/modules/updates/db/entity/AssetEntity;ZZ)V
    .locals 0
...
.method private downloadAllAssets(Ljava/util/ArrayList;)V
    ...
    iget-object v2, p0, Lexpo/modules/updates/loader/RemoteLoader;->mUpdatesDirectory:Ljava/io/File;

    iget-object v3, p0, Lexpo/modules/updates/loader/RemoteLoader;->mConfiguration:Lexpo/modules/updates/UpdatesConfiguration;

    new-instance v4, Lexpo/modules/updates/loader/RemoteLoader$2;

    invoke-direct {v4, p0}, Lexpo/modules/updates/loader/RemoteLoader$2;-><init>(Lexpo/modules/updates/loader/RemoteLoader;)V

    invoke-virtual {v1, v0, v2, v3, v4}, Lexpo/modules/updates/loader/FileDownloader;->downloadAsset(Lexpo/modules/updates/db/entity/AssetEntity;Ljava/io/File;Lexpo/modules/updates/UpdatesConfiguration;Lexpo/modules/updates/loader/FileDownloader$AssetDownloadCallback;)V
...
.method private finishWithSuccess()V
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lexpo/modules/updates/loader/RemoteLoader;->mManifest:Lexpo/modules/updates/manifest/Manifest;

    iget-object v1, p0, Lexpo/modules/updates/loader/RemoteLoader;->mDatabase:Lexpo/modules/updates/db/UpdatesDatabase;

    iget-object v2, p0, Lexpo/modules/updates/loader/RemoteLoader;->mConfiguration:Lexpo/modules/updates/UpdatesConfiguration;

    invoke-static {v0, v1, v2}, Lexpo/modules/updates/manifest/ManifestMetadata;->saveMetadata(Lexpo/modules/updates/manifest/Manifest;Lexpo/modules/updates/db/UpdatesDatabase;Lexpo/modules/updates/UpdatesConfiguration;)V
...
# virtual methods
.method public start(Lexpo/modules/updates/loader/RemoteLoader$LoaderCallback;)V
    .locals 4
    ...
    invoke-interface {p1, v0}, Lexpo/modules/updates/loader/RemoteLoader$LoaderCallback;->onFailure(Ljava/lang/Exception;)V

    return-void

    .line 3
    :cond_0
    iput-object p1, p0, Lexpo/modules/updates/loader/RemoteLoader;->mCallback:Lexpo/modules/updates/loader/RemoteLoader$LoaderCallback;

    .line 4
    iget-object p1, p0, Lexpo/modules/updates/loader/RemoteLoader;->mDatabase:Lexpo/modules/updates/db/UpdatesDatabase;

    iget-object v0, p0, Lexpo/modules/updates/loader/RemoteLoader;->mConfiguration:Lexpo/modules/updates/UpdatesConfiguration;

    invoke-static {p1, v0}, Lexpo/modules/updates/manifest/ManifestMetadata;->getServerDefinedHeaders(Lexpo/modules/updates/db/UpdatesDatabase;Lexpo/modules/updates/UpdatesConfiguration;)Lorg/json/JSONObject;
    ...
    iget-object v1, p0, Lexpo/modules/updates/loader/RemoteLoader;->mConfiguration:Lexpo/modules/updates/UpdatesConfiguration;

    iget-object v2, p0, Lexpo/modules/updates/loader/RemoteLoader;->mContext:Landroid/content/Context;

    new-instance v3, Lexpo/modules/updates/loader/RemoteLoader$1;

    invoke-direct {v3, p0}, Lexpo/modules/updates/loader/RemoteLoader$1;-><init>(Lexpo/modules/updates/loader/RemoteLoader;)V

    invoke-virtual {v0, v1, p1, v2, v3}, Lexpo/modules/updates/loader/FileDownloader;->downloadManifest(Lexpo/modules/updates/UpdatesConfiguration;Lorg/json/JSONObject;Landroid/content/Context;Lexpo/modules/updates/loader/FileDownloader$ManifestDownloadCallback;)V
