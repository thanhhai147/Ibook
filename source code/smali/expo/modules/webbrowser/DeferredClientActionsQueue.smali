...
.method private addActionToQueue(Ln/e/b/l/e;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private executeQueuedActions()V
    ...
    invoke-interface {v0, v1}, Ln/e/b/l/e;->apply(Ljava/lang/Object;)V
...
.method public executeOrQueueAction(Ln/e/b/l/e;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-interface {p1, v0}, Ln/e/b/l/e;->apply(Ljava/lang/Object;)V

    goto :goto_0

    .line 3
    :cond_0
    invoke-direct {p0, p1}, Lexpo/modules/webbrowser/DeferredClientActionsQueue;->addActionToQueue(Ln/e/b/l/e;)V
