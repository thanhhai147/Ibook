...
.method private synthetic a(Ld/c/b/c;)V
    .locals 2
    ...
    invoke-virtual {p1, v1}, Ld/c/b/c;->f(Ld/c/b/b;)Ld/c/b/f;
...
.method static synthetic c(Landroid/net/Uri;Ld/c/b/f;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-virtual {p1, p0, v0, v0}, Ld/c/b/f;->f(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method static synthetic d(Ld/c/b/c;)V
    .locals 2

    const-wide/16 v0, 0x0

    .line 1
    invoke-virtual {p0, v0, v1}, Ld/c/b/c;->h(J)Z
...
.method private ensureConnection(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1, p0}, Ld/c/b/c;->a(Landroid/content/Context;Ljava/lang/String;Ld/c/b/e;)Z
...
.method private ensureSession()V
    ...
    invoke-virtual {v0, v1}, Lexpo/modules/webbrowser/DeferredClientActionsQueue;->executeOrQueueAction(Ln/e/b/l/e;)V
...
# virtual methods
.method public synthetic b(Ld/c/b/c;)V
    .locals 0

    invoke-direct {p0, p1}, Lexpo/modules/webbrowser/InternalCustomTabsConnectionHelper;->a(Ld/c/b/c;)V
...
.method public mayInitWithUrl(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    new-instance v1, Lexpo/modules/webbrowser/e;

    invoke-direct {v1, p2}, Lexpo/modules/webbrowser/e;-><init>(Landroid/net/Uri;)V
...
.method public warmUp(Ljava/lang/String;)V
    ...
    sget-object v1, Lexpo/modules/webbrowser/c;->a:Lexpo/modules/webbrowser/c;
