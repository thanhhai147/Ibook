...
.method constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;)V
    ...
    iput-object p1, p0, Lf/f/b/a/n;->d:Landroid/view/SurfaceView;
    ...
    .line 6
    new-instance p2, Lf/f/b/a/n$a;

    invoke-direct {p2, p0}, Lf/f/b/a/n$a;-><init>(Lf/f/b/a/n;)V
...
.method e()Landroid/view/Surface;
    ...
    .line 1
    invoke-virtual {p0}, Lf/f/b/a/n;->f()Landroid/view/SurfaceHolder;
...
.method f()Landroid/view/SurfaceHolder;
    ...
    .line 1
    iget-object v0, p0, Lf/f/b/a/n;->d:Landroid/view/SurfaceView;
...
.method j()Z
    ...
    .line 1
    invoke-virtual {p0}, Lf/f/b/a/i;->i()I

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lf/f/b/a/i;->c()I
