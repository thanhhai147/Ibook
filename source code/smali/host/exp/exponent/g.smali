...
.field d:Lhost/exp/exponent/p/r;
    .annotation runtime Ljavax/inject/a;
    .end annotation
.end field
...
.field private j:Lexpo/modules/updates/loader/FileDownloader;

.field private k:Lexpo/modules/updates/launcher/SelectionPolicy;

.field private l:Lexpo/modules/updates/launcher/Launcher;

.field private m:Z

.field private n:Z

.field private o:Lhost/exp/exponent/g$c;
...
.method public constructor <init>(Ljava/lang/String;Lhost/exp/exponent/g$b;Z)V
    ...
    .line 2
    iput-boolean v0, p0, Lhost/exp/exponent/g;->m:Z

    const/4 v1, 0x1

    .line 3
    iput-boolean v1, p0, Lhost/exp/exponent/g;->n:Z

    .line 4
    iput-boolean v1, p0, Lhost/exp/exponent/g;->p:Z

    .line 5
    iput-boolean v0, p0, Lhost/exp/exponent/g;->q:Z
...
.method private B(Landroid/content/Context;Ljava/lang/Exception;)V
    .locals 2
    ...
    iput-object v0, p0, Lhost/exp/exponent/g;->l:Lexpo/modules/updates/launcher/Launcher;
    ...
    .line 3
    :try_start_0
    invoke-direct {p0, p1}, Lhost/exp/exponent/g;->C(Lorg/json/JSONObject;)Lorg/json/JSONObject;
    :try_end_0
    ...
    .line 4
    :catch_0
    sget-object v0, Lhost/exp/exponent/g;->r:Ljava/lang/String;
    ...
    invoke-interface {p2, p1}, Lhost/exp/exponent/g$b;->a(Lorg/json/JSONObject;)V

    .line 6
    iget-object p1, p0, Lhost/exp/exponent/g;->l:Lexpo/modules/updates/launcher/Launcher;
    ...
    iget-object p2, p0, Lhost/exp/exponent/g;->l:Lexpo/modules/updates/launcher/Launcher;
    ...
    invoke-interface {p2, p1}, Lhost/exp/exponent/g$b;->e(Ljava/lang/String;)V
...
.method private C(Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    .line 3
    invoke-direct {p0, v0}, Lhost/exp/exponent/g;->x(Landroid/net/Uri;)Z
...
.method private D(Lorg/json/JSONObject;)V
    ...
    .line 2
    iput-boolean v3, p0, Lhost/exp/exponent/g;->p:Z
    ...
    .line 11
    :catch_0
    iput-boolean v2, p0, Lhost/exp/exponent/g;->p:Z
...
.method private G(Lexpo/modules/updates/UpdatesConfiguration;Ljava/io/File;Lexpo/modules/updates/launcher/SelectionPolicy;Landroid/content/Context;)V
    .locals 8
    ...
    .line 3
    iput-object p3, p0, Lhost/exp/exponent/g;->k:Lexpo/modules/updates/launcher/SelectionPolicy;
    ...
    .line 5
    invoke-direct {p0, p4, p1}, Lhost/exp/exponent/g;->B(Landroid/content/Context;Ljava/lang/Exception;)V

    return-void

    .line 6
    :cond_0
    new-instance v7, Lexpo/modules/updates/loader/LoaderTask;

    iget-object v2, p0, Lhost/exp/exponent/g;->c:Lexpo/modules/updates/db/DatabaseHolder;

    iget-object v4, p0, Lhost/exp/exponent/g;->j:Lexpo/modules/updates/loader/FileDownloader;

    new-instance v6, Lhost/exp/exponent/g$a;

    invoke-direct {v6, p0, p4}, Lhost/exp/exponent/g$a;-><init>(Lhost/exp/exponent/g;Landroid/content/Context;)V
    ...
    invoke-direct/range {v0 .. v6}, Lexpo/modules/updates/loader/LoaderTask;-><init>(Lexpo/modules/updates/UpdatesConfiguration;Lexpo/modules/updates/db/DatabaseHolder;Ljava/io/File;Lexpo/modules/updates/loader/FileDownloader;Lexpo/modules/updates/launcher/SelectionPolicy;Lexpo/modules/updates/loader/LoaderTask$LoaderTaskCallback;)V

    .line 7
    invoke-virtual {v7, p4}, Lexpo/modules/updates/loader/LoaderTask;->start(Landroid/content/Context;)V

    return-void
.end method

.method private H(Lhost/exp/exponent/g$c;)V
    .locals 1

    .line 1
    iput-object p1, p0, Lhost/exp/exponent/g;->o:Lhost/exp/exponent/g$c;

    .line 2
    iget-object v0, p0, Lhost/exp/exponent/g;->f:Lhost/exp/exponent/g$b;

    invoke-interface {v0, p1}, Lhost/exp/exponent/g$b;->b(Lhost/exp/exponent/g$c;)V
...
.method static synthetic b(Lhost/exp/exponent/g;Landroid/content/Context;Ljava/lang/Exception;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lhost/exp/exponent/g;->B(Landroid/content/Context;Ljava/lang/Exception;)V
...
.method static synthetic c(Lhost/exp/exponent/g;Z)Z
    ...
    .line 1
    iput-boolean p1, p0, Lhost/exp/exponent/g;->n:Z
...
.method static synthetic h(Lhost/exp/exponent/g;Lorg/json/JSONObject;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lhost/exp/exponent/g;->D(Lorg/json/JSONObject;)V
...
.method static synthetic i(Lhost/exp/exponent/g;Lorg/json/JSONObject;)Z
    ...
    .line 1
    invoke-direct {p0, p1}, Lhost/exp/exponent/g;->z(Lorg/json/JSONObject;)Z
...
.method static synthetic j(Lhost/exp/exponent/g;Ljava/lang/String;)Z
    ...
    .line 1
    invoke-direct {p0, p1}, Lhost/exp/exponent/g;->A(Ljava/lang/String;)Z
...
.method static synthetic l(Lhost/exp/exponent/g;Lhost/exp/exponent/g$c;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lhost/exp/exponent/g;->H(Lhost/exp/exponent/g$c;)V
...
.method static synthetic m(Lhost/exp/exponent/g;Lexpo/modules/updates/launcher/Launcher;)Lexpo/modules/updates/launcher/Launcher;
    ...
    .line 1
    iput-object p1, p0, Lhost/exp/exponent/g;->l:Lexpo/modules/updates/launcher/Launcher;
...
.method private n(Ljava/lang/String;)Lhost/exp/exponent/n/c;
    ...
    .line 9
    sget-object v1, Lhost/exp/exponent/g;->r:Ljava/lang/String;
...
.method private r()Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lhost/exp/exponent/p/k;->j()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lhost/exp/exponent/r/e;->g()Ljava/lang/String;
    ...
    .line 10
    sget-boolean v1, Lhost/exp/exponent/p/s;->c:Z
...
.method private x(Landroid/net/Uri;)Z
    .locals 1
...
.method private z(Lorg/json/JSONObject;)Z
    .locals 3
...
.method public F(Landroid/content/Context;)V
    ...
    .line 1
    iget-boolean v0, p0, Lhost/exp/exponent/g;->q:Z
    ...
    iput-object v0, p0, Lhost/exp/exponent/g;->o:Lhost/exp/exponent/g$c;

    .line 4
    new-instance v0, Lexpo/modules/updates/loader/FileDownloader;

    invoke-direct {v0, p1}, Lexpo/modules/updates/loader/FileDownloader;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lhost/exp/exponent/g;->j:Lexpo/modules/updates/loader/FileDownloader;

    .line 5
    iget-object v0, p0, Lhost/exp/exponent/g;->d:Lhost/exp/exponent/p/r;

    iget-object v1, p0, Lhost/exp/exponent/g;->e:Ljava/lang/String;

    invoke-virtual {v0, v1, p0}, Lhost/exp/exponent/p/r;->v(Ljava/lang/String;Lhost/exp/exponent/g;)V
    ...
    .line 22
    :goto_0
    invoke-direct {p0}, Lhost/exp/exponent/g;->r()Ljava/util/Map;
    ...
    .line 28
    new-instance v2, Lexpo/modules/updates/launcher/SelectionPolicyFilterAware;

    invoke-direct {v2, v1}, Lexpo/modules/updates/launcher/SelectionPolicyFilterAware;-><init>(Ljava/util/List;)V
    ...
    .line 30
    invoke-direct {p0, v0, v1, v2, p1}, Lhost/exp/exponent/g;->G(Lexpo/modules/updates/UpdatesConfiguration;Ljava/io/File;Lexpo/modules/updates/launcher/SelectionPolicy;Landroid/content/Context;)V
...
.method public p()Lexpo/modules/updates/loader/FileDownloader;
    .locals 2

    .line 1
    iget-object v0, p0, Lhost/exp/exponent/g;->j:Lexpo/modules/updates/loader/FileDownloader;
    ...
    const-string v1, "Tried to access FileDownloader before it was set"
...
.method public q()Lexpo/modules/updates/launcher/Launcher;
    .locals 2

    .line 1
    iget-object v0, p0, Lhost/exp/exponent/g;->l:Lexpo/modules/updates/launcher/Launcher;
...
.method public s()Lexpo/modules/updates/launcher/SelectionPolicy;
    .locals 2

    .line 1
    iget-object v0, p0, Lhost/exp/exponent/g;->k:Lexpo/modules/updates/launcher/SelectionPolicy;
...
.method public t()Lhost/exp/exponent/g$c;
    .locals 1

    .line 1
    iget-object v0, p0, Lhost/exp/exponent/g;->o:Lhost/exp/exponent/g$c;

    return-object v0
.end method

.method public u()Lexpo/modules/updates/UpdatesConfiguration;
    .locals 2
...
.method public y()Z
    ...
    .line 1
    iget-boolean v0, p0, Lhost/exp/exponent/g;->n:Z
