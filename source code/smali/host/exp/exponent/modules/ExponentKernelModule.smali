...
# interfaces
.implements Lhost/exp/exponent/p/o;
...
# instance fields
.field mDevMenuManager:Lhost/exp/exponent/p/h;
...
.field mKernel:Lhost/exp/exponent/p/r;
    .annotation runtime Ljavax/inject/a;
    .end annotation
.end field
...
.method public static queueEvent(Lhost/exp/exponent/p/p$c;)V
    .locals 1
...
.method public static queueEvent(Ljava/lang/String;Lcom/facebook/react/bridge/WritableMap;Lhost/exp/exponent/p/p$d;)V
    .locals 1
    ...
    invoke-static {v0}, Lhost/exp/exponent/modules/ExponentKernelModule;->queueEvent(Lhost/exp/exponent/p/p$c;)V
...
.method public closeDevMenuAsync(Lcom/facebook/react/bridge/Promise;)V
    ...
    .line 1
    iget-object v0, p0, Lhost/exp/exponent/modules/ExponentKernelModule;->mDevMenuManager:Lhost/exp/exponent/p/h;

    invoke-virtual {v0}, Lhost/exp/exponent/p/h;->n()V
...
.method public consumeEventQueue()V
    ...
    check-cast v0, Lhost/exp/exponent/p/p$c;
    ...
    .line 4
    iget-object v2, v0, Lhost/exp/exponent/p/p$c;->b:Lcom/facebook/react/bridge/WritableMap;
    ...
    .line 5
    iget-object v2, v0, Lhost/exp/exponent/p/p$c;->c:Lhost/exp/exponent/p/p$d;
    ...
    iget-object v3, v0, Lhost/exp/exponent/p/p$c;->a:Ljava/lang/String;

    iget-object v0, v0, Lhost/exp/exponent/p/p$c;->b:Lcom/facebook/react/bridge/WritableMap;
...
.method public doesCurrentTaskEnableDevtoolsAsync(Lcom/facebook/react/bridge/Promise;)V
    ...
    invoke-virtual {v0}, Lhost/exp/exponent/p/h;->p()Z
...
.method public getDevMenuItemsToShowAsync(Lcom/facebook/react/bridge/Promise;)V
    ...
    invoke-virtual {v0}, Lhost/exp/exponent/p/h;->l()Lcom/facebook/react/bridge/WritableMap;
...
.method public getIsOnboardingFinishedAsync(Lcom/facebook/react/bridge/Promise;)V
    ...
    invoke-virtual {v0}, Lhost/exp/exponent/p/h;->q()Z
...
.method public getSessionAsync(Lcom/facebook/react/bridge/Promise;)V
    ...
    invoke-virtual {v0, v1}, Lhost/exp/exponent/r/e;->h(Ljava/lang/String;)Ljava/lang/String;
...
.method public goToHomeAsync(Lcom/facebook/react/bridge/Promise;)V
    ...
    .line 1
    iget-object v0, p0, Lhost/exp/exponent/modules/ExponentKernelModule;->mKernel:Lhost/exp/exponent/p/r;

    invoke-virtual {v0}, Lhost/exp/exponent/p/r;->T()V

    .line 2
    iget-object v0, p0, Lhost/exp/exponent/modules/ExponentKernelModule;->mDevMenuManager:Lhost/exp/exponent/p/h;

    invoke-virtual {v0}, Lhost/exp/exponent/p/h;->A()V
...
.method public onEventFailure(Ljava/lang/String;Ljava/lang/String;)V
    ...
    check-cast p1, Lhost/exp/exponent/p/p$d;

    .line 3
    invoke-interface {p1, p2}, Lhost/exp/exponent/p/p$d;->onEventFailure(Ljava/lang/String;)V
...
.method public onEventSuccess(Ljava/lang/String;Lcom/facebook/react/bridge/ReadableMap;)V
    ...
    .line 3
    invoke-interface {p1, p2}, Lhost/exp/exponent/p/p$d;->onEventSuccess(Lcom/facebook/react/bridge/ReadableMap;)V
...
.method public reloadAppAsync(Lcom/facebook/react/bridge/Promise;)V
    ...
    invoke-virtual {v0}, Lhost/exp/exponent/p/h;->z()V
...
.method public removeSessionAsync(Lcom/facebook/react/bridge/Promise;)V
    ...
    invoke-virtual {v0}, Lhost/exp/exponent/r/e;->k()V
...
.method public selectDevMenuItemWithKeyAsync(Ljava/lang/String;Lcom/facebook/react/bridge/Promise;)V
    ...
    invoke-virtual {v0, p1}, Lhost/exp/exponent/p/h;->C(Ljava/lang/String;)V

    .line 2
    iget-object p1, p0, Lhost/exp/exponent/modules/ExponentKernelModule;->mDevMenuManager:Lhost/exp/exponent/p/h;

    invoke-virtual {p1}, Lhost/exp/exponent/p/h;->A()V
...
.method public setIsOnboardingFinishedAsync(ZLcom/facebook/react/bridge/Promise;)V
    ...
    invoke-virtual {v0, p1}, Lhost/exp/exponent/p/h;->D(Z)V
...
.method public setSessionAsync(Lcom/facebook/react/bridge/ReadableMap;Lcom/facebook/react/bridge/Promise;)V
    ...
    invoke-virtual {p1, v0}, Lhost/exp/exponent/r/e;->r(Lorg/json/JSONObject;)V
