...
.field c:Lhost/exp/exponent/p/j;
...
.method protected getIcon()I
    ...
    sget v0, Li/a/a/e;->b:I

    goto :goto_0

    :cond_0
    sget v0, Li/a/a/e;->a:I
...
.method protected getNotificationsChannelManager()Lexpo/modules/notifications/notifications/channels/managers/NotificationsChannelManager;
    ...
    .line 1
    iget-object v0, p0, Lhost/exp/exponent/notifications/n;->c:Lhost/exp/exponent/p/j;
    ...
    iget-object v2, p0, Lhost/exp/exponent/notifications/n;->c:Lhost/exp/exponent/p/j;
    ...
    iget-object v5, p0, Lhost/exp/exponent/notifications/n;->c:Lhost/exp/exponent/p/j;

    invoke-direct {v3, v4, v5}, Lversioned/host/exp/exponent/modules/api/notifications/channels/ScopedNotificationsGroupManager;-><init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V

    invoke-direct {v0, v1, v2, v3}, Lversioned/host/exp/exponent/modules/api/notifications/channels/ScopedNotificationsChannelManager;-><init>(Landroid/content/Context;Lhost/exp/exponent/p/j;Lexpo/modules/notifications/notifications/channels/managers/NotificationsChannelGroupManager;)V
...
.method public setNotification(Lexpo/modules/notifications/notifications/model/Notification;)Lexpo/modules/notifications/notifications/interfaces/NotificationBuilder;
    ...
    iput-object p1, p0, Lhost/exp/exponent/notifications/n;->c:Lhost/exp/exponent/p/j;

    .line 5
    invoke-virtual {p1}, Lhost/exp/exponent/p/j;->b()Ljava/lang/String;
