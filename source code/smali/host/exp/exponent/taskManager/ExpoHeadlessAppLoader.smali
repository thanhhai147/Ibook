...
# virtual methods
.method public a(Landroid/content/Context;Ln/e/a/c$b;Ljava/lang/Runnable;Ln/e/b/l/e;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-virtual {p2}, Ln/e/a/c$b;->b()Ljava/lang/String;
    ...
    invoke-direct {v1, p0, p2, p4}, Lhost/exp/exponent/taskManager/ExpoHeadlessAppLoader$a;-><init>(Lhost/exp/exponent/taskManager/ExpoHeadlessAppLoader;Ln/e/a/c$b;Ln/e/b/l/e;)V

    invoke-interface {p1, v0, p3, v1}, Lhost/exp/exponent/taskManager/a;->b(Ljava/lang/String;Ljava/util/Map;Ln/e/a/b$a;)Lhost/exp/exponent/taskManager/b;
    ...
    .line 9
    :cond_1
    new-instance p1, Ln/e/a/c$a;

    const-string p2, "Cannot execute background task because application URL is invalid"

    invoke-direct {p1, p2}, Ln/e/a/c$a;-><init>(Ljava/lang/String;)V
