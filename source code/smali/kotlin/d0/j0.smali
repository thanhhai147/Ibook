...
.method public static h()Ljava/util/Map;
    ...
    .line 1
    sget-object v0, Lkotlin/d0/z;->c:Lkotlin/d0/z;
...
.method public static i(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p0, p1}, Lkotlin/d0/h0;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs j([Lkotlin/r;)Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {p0, v0}, Lkotlin/d0/j0;->t([Lkotlin/r;Ljava/util/Map;)Ljava/util/Map;
...
.method public static varargs k([Lkotlin/r;)Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {v0, p0}, Lkotlin/d0/j0;->p(Ljava/util/Map;[Lkotlin/r;)V
...
.method public static final l(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lkotlin/d0/i0;->f(Ljava/util/Map;)Ljava/util/Map;
...
.method public static n(Ljava/util/Map;Lkotlin/r;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static final p(Ljava/util/Map;[Lkotlin/r;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static q(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/d0/j0;->r(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lkotlin/d0/g0;->e(Lkotlin/r;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/d0/j0;->r(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    invoke-static {v0}, Lkotlin/d0/j0;->l(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final r(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p1, p0}, Lkotlin/d0/j0;->o(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static s(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    invoke-static {p0}, Lkotlin/d0/g0;->u(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final t([Lkotlin/r;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    .line 1
    invoke-static {p1, p0}, Lkotlin/d0/j0;->p(Ljava/util/Map;[Lkotlin/r;)V
