...
.method private declared-synchronized d(Lf/f/d/h/a;)Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lf/f/d/h/a;->b()Ljava/lang/Class;
...
.method static synthetic e(Ljava/util/Map$Entry;Lf/f/d/h/a;)V
    .locals 0
    ...
    check-cast p0, Lf/f/d/h/b;

    invoke-interface {p0, p1}, Lf/f/d/h/b;->a(Lf/f/d/h/a;)V
...
# virtual methods
.method public a(Ljava/lang/Class;Lf/f/d/h/b;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p0, p1, v0, p2}, Lcom/google/firebase/components/r;->b(Ljava/lang/Class;Ljava/util/concurrent/Executor;Lf/f/d/h/b;)V

    return-void
.end method

.method public declared-synchronized b(Ljava/lang/Class;Ljava/util/concurrent/Executor;Lf/f/d/h/b;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method c()V
    ...
    check-cast v1, Lf/f/d/h/a;

    .line 6
    invoke-virtual {p0, v1}, Lcom/google/firebase/components/r;->f(Lf/f/d/h/a;)V
...
.method public f(Lf/f/d/h/a;)V
    ...
    .line 7
    invoke-direct {p0, p1}, Lcom/google/firebase/components/r;->d(Lf/f/d/h/a;)Ljava/util/Set;
    ...
    invoke-static {v1, p1}, Lcom/google/firebase/components/q;->a(Ljava/util/Map$Entry;Lf/f/d/h/a;)Ljava/lang/Runnable;
