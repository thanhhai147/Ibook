...
.method private static final synthetic $values()[Lcom/stripe/android/model/PaymentIntent$CancellationReason;
    ...
    sget-object v1, Lcom/stripe/android/model/PaymentIntent$CancellationReason;->Duplicate:Lcom/stripe/android/model/PaymentIntent$CancellationReason;
    ...
    sget-object v1, Lcom/stripe/android/model/PaymentIntent$CancellationReason;->RequestedByCustomer:Lcom/stripe/android/model/PaymentIntent$CancellationReason;

    const/4 v2, 0x2

    aput-object v1, v0, v2

    sget-object v1, Lcom/stripe/android/model/PaymentIntent$CancellationReason;->Abandoned:Lcom/stripe/android/model/PaymentIntent$CancellationReason;

    const/4 v2, 0x3

    aput-object v1, v0, v2

    sget-object v1, Lcom/stripe/android/model/PaymentIntent$CancellationReason;->FailedInvoice:Lcom/stripe/android/model/PaymentIntent$CancellationReason;

    const/4 v2, 0x4

    aput-object v1, v0, v2

    sget-object v1, Lcom/stripe/android/model/PaymentIntent$CancellationReason;->VoidInvoice:Lcom/stripe/android/model/PaymentIntent$CancellationReason;

    const/4 v2, 0x5

    aput-object v1, v0, v2

    sget-object v1, Lcom/stripe/android/model/PaymentIntent$CancellationReason;->Automatic:Lcom/stripe/android/model/PaymentIntent$CancellationReason;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/stripe/android/model/PaymentIntent$CancellationReason;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v1, "FailedInvoice"

    const/4 v2, 0x4

    const-string v3, "failed_invoice"
    ...
    const-string v1, "VoidInvoice"

    const/4 v2, 0x5

    const-string v3, "void_invoice"
    ...
    invoke-direct {v0, v1}, Lcom/stripe/android/model/PaymentIntent$CancellationReason$Companion;-><init>(Lkotlin/j0/d/g;)V
