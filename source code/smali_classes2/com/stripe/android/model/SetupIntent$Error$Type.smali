...
.method private static final synthetic $values()[Lcom/stripe/android/model/SetupIntent$Error$Type;
    ...
    sget-object v1, Lcom/stripe/android/model/SetupIntent$Error$Type;->ApiConnectionError:Lcom/stripe/android/model/SetupIntent$Error$Type;
    ...
    sget-object v1, Lcom/stripe/android/model/SetupIntent$Error$Type;->AuthenticationError:Lcom/stripe/android/model/SetupIntent$Error$Type;

    const/4 v2, 0x2

    aput-object v1, v0, v2

    sget-object v1, Lcom/stripe/android/model/SetupIntent$Error$Type;->CardError:Lcom/stripe/android/model/SetupIntent$Error$Type;

    const/4 v2, 0x3

    aput-object v1, v0, v2

    sget-object v1, Lcom/stripe/android/model/SetupIntent$Error$Type;->IdempotencyError:Lcom/stripe/android/model/SetupIntent$Error$Type;

    const/4 v2, 0x4

    aput-object v1, v0, v2

    sget-object v1, Lcom/stripe/android/model/SetupIntent$Error$Type;->InvalidRequestError:Lcom/stripe/android/model/SetupIntent$Error$Type;

    const/4 v2, 0x5

    aput-object v1, v0, v2

    sget-object v1, Lcom/stripe/android/model/SetupIntent$Error$Type;->RateLimitError:Lcom/stripe/android/model/SetupIntent$Error$Type;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/stripe/android/model/SetupIntent$Error$Type;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {v0, v1}, Lcom/stripe/android/model/SetupIntent$Error$Type$Companion;-><init>(Lkotlin/j0/d/g;)V
