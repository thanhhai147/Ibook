...
# direct methods
.method private static final synthetic $values()[Lcom/stripe/android/model/SourceOrderParams$Item$Type;
    .locals 3
    ...
    sget-object v1, Lcom/stripe/android/model/SourceOrderParams$Item$Type;->Sku:Lcom/stripe/android/model/SourceOrderParams$Item$Type;

    const/4 v2, 0x0

    aput-object v1, v0, v2

    sget-object v1, Lcom/stripe/android/model/SourceOrderParams$Item$Type;->Tax:Lcom/stripe/android/model/SourceOrderParams$Item$Type;

    const/4 v2, 0x1

    aput-object v1, v0, v2

    sget-object v1, Lcom/stripe/android/model/SourceOrderParams$Item$Type;->Shipping:Lcom/stripe/android/model/SourceOrderParams$Item$Type;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lcom/stripe/android/model/SourceOrderParams$Item$Type;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/stripe/android/model/SourceOrderParams$Item$Type;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v0, Lcom/stripe/android/model/SourceOrderParams$Item$Type;->Sku:Lcom/stripe/android/model/SourceOrderParams$Item$Type;
    ...
    sput-object v0, Lcom/stripe/android/model/SourceOrderParams$Item$Type;->Tax:Lcom/stripe/android/model/SourceOrderParams$Item$Type;
    ...
    sput-object v0, Lcom/stripe/android/model/SourceOrderParams$Item$Type;->Shipping:Lcom/stripe/android/model/SourceOrderParams$Item$Type;

    invoke-static {}, Lcom/stripe/android/model/SourceOrderParams$Item$Type;->$values()[Lcom/stripe/android/model/SourceOrderParams$Item$Type;
