...
# direct methods
.method private static final synthetic $values()[Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;
    .locals 3
    ...
    sget-object v1, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;->AddFragmentTopGooglePay:Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;
    ...
    sget-object v1, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;->None:Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;

    const-string v1, "AddFragmentTopGooglePay"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;->AddFragmentTopGooglePay:Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;

    .line 2
    new-instance v0, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;

    const-string v1, "SheetBottomGooglePay"

    const/4 v2, 0x1

    invoke-direct {v0, v1, v2}, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;->SheetBottomGooglePay:Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;

    .line 3
    new-instance v0, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;

    const-string v1, "SheetBottomBuy"

    const/4 v2, 0x2

    invoke-direct {v0, v1, v2}, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;->SheetBottomBuy:Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;
    ...
    sput-object v0, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;->None:Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;

    invoke-static {}, Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;->$values()[Lcom/stripe/android/paymentsheet/PaymentSheetViewModel$CheckoutIdentifier;
