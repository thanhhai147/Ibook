...
.field private mSimpleExoPlayer:Lf/f/b/c/g0;
...
.method constructor <init>(Lexpo/modules/av/AVManagerInterface;Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 2
    iput-object p1, p0, Lexpo/modules/av/player/SimpleExoPlayerData;->mSimpleExoPlayer:Lf/f/b/c/g0;
...
.method private buildMediaSource(Landroid/net/Uri;Ljava/lang/String;Landroid/os/Handler;Lf/f/b/c/t0/k$a;)Lf/f/b/c/q0/w;
    .locals 9
    ...
    .line 3
    new-instance v1, Lf/f/b/c/t0/n;

    invoke-static {v0}, Lf/f/b/c/t0/a0;->e(I)Landroid/net/Uri;

    move-result-object v0

    invoke-direct {v1, v0}, Lf/f/b/c/t0/n;-><init>(Landroid/net/Uri;)V

    .line 4
    new-instance v0, Lf/f/b/c/t0/a0;

    iget-object v2, p0, Lexpo/modules/av/player/SimpleExoPlayerData;->mReactContext:Landroid/content/Context;

    invoke-direct {v0, v2}, Lf/f/b/c/t0/a0;-><init>(Landroid/content/Context;)V

    .line 5
    invoke-virtual {v0, v1}, Lf/f/b/c/t0/a0;->n0(Lf/f/b/c/t0/n;)J

    .line 6
    invoke-virtual {v0}, Lf/f/b/c/t0/a0;->k0()Landroid/net/Uri;
    ...
    :goto_1
    invoke-static {p1}, Lf/f/b/c/u0/f0;->K(Ljava/lang/String;)I
    ...
    .line 9
    new-instance p1, Lf/f/b/c/q0/u;

    new-instance v6, Lf/f/b/c/n0/e;

    invoke-direct {v6}, Lf/f/b/c/n0/e;-><init>()V
    ...
    invoke-direct/range {v3 .. v8}, Lf/f/b/c/q0/u;-><init>(Landroid/net/Uri;Lf/f/b/c/t0/k$a;Lf/f/b/c/n0/j;Landroid/os/Handler;Lf/f/b/c/q0/u$a;)V
    ...
    .line 11
    :cond_3
    new-instance p1, Lf/f/b/c/q0/j0/l;

    invoke-direct {p1, v4, p4, p3, p0}, Lf/f/b/c/q0/j0/l;-><init>(Landroid/net/Uri;Lf/f/b/c/t0/k$a;Landroid/os/Handler;Lf/f/b/c/q0/x;)V

    return-object p1

    .line 12
    :cond_4
    new-instance p1, Lf/f/b/c/q0/k0/e;

    new-instance v6, Lf/f/b/c/q0/k0/b$a;

    invoke-direct {v6, p4}, Lf/f/b/c/q0/k0/b$a;-><init>(Lf/f/b/c/t0/k$a;)V
    ...
    invoke-direct/range {v3 .. v8}, Lf/f/b/c/q0/k0/e;-><init>(Landroid/net/Uri;Lf/f/b/c/t0/k$a;Lf/f/b/c/q0/k0/c$a;Landroid/os/Handler;Lf/f/b/c/q0/x;)V

    return-object p1

    .line 13
    :cond_5
    new-instance p1, Lf/f/b/c/q0/i0/f;

    new-instance v6, Lf/f/b/c/q0/i0/i$a;

    invoke-direct {v6, p4}, Lf/f/b/c/q0/i0/i$a;-><init>(Lf/f/b/c/t0/k$a;)V
    ...
    invoke-direct/range {v3 .. v8}, Lf/f/b/c/q0/i0/f;-><init>(Landroid/net/Uri;Lf/f/b/c/t0/k$a;Lf/f/b/c/q0/i0/c$a;Landroid/os/Handler;Lf/f/b/c/q0/x;)V
...
.method applyNewStatus(Ljava/lang/Integer;Ljava/lang/Boolean;)V
    ...
    .line 1
    iget-object v0, p0, Lexpo/modules/av/player/SimpleExoPlayerData;->mSimpleExoPlayer:Lf/f/b/c/g0;
    ...
    .line 3
    iget-object p2, p0, Lexpo/modules/av/player/SimpleExoPlayerData;->mSimpleExoPlayer:Lf/f/b/c/g0;

    const/4 v1, 0x2

    invoke-virtual {p2, v1}, Lf/f/b/c/g0;->S(I)V
    ...
    invoke-virtual {p2, v0}, Lf/f/b/c/g0;->S(I)V
    ...
    invoke-virtual {p2, v0}, Lf/f/b/c/g0;->Q(Z)V
    ...
    invoke-virtual {p2, v0, v1}, Lf/f/b/c/b;->i(J)V
...
.method public getAudioSessionId()I
    ...
    invoke-virtual {v0}, Lf/f/b/c/g0;->F()I
...
.method getExtraStatusFields(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Lf/f/b/c/g0;->H()J
    ...
    .line 4
    invoke-virtual {v0}, Lf/f/b/c/g0;->getCurrentPosition()J
    ...
    .line 7
    invoke-virtual {v0}, Lf/f/b/c/g0;->G()J
    ...
    invoke-virtual {v0}, Lf/f/b/c/g0;->J()I
...
.method public load(Landroid/os/Bundle;Lexpo/modules/av/player/PlayerData$LoadCompletionListener;)V
    ...
    .line 3
    new-instance v6, Lf/f/b/c/t0/p;

    invoke-direct {v6}, Lf/f/b/c/t0/p;-><init>()V

    .line 4
    new-instance v0, Lf/f/b/c/s0/a$a;

    invoke-direct {v0}, Lf/f/b/c/s0/a$a;-><init>()V

    .line 5
    new-instance v2, Lf/f/b/c/s0/c;

    invoke-direct {v2, v0}, Lf/f/b/c/s0/c;-><init>(Lf/f/b/c/s0/g$a;)V
    ...
    invoke-direct {v1, v3}, Lf/f/b/c/g;-><init>(Landroid/content/Context;)V

    new-instance v3, Lf/f/b/c/e;

    invoke-direct {v3}, Lf/f/b/c/e;-><init>()V
    ...
    .line 9
    invoke-static/range {v0 .. v5}, Lf/f/b/c/j;->a(Landroid/content/Context;Lf/f/b/c/e0;Lf/f/b/c/s0/i;Lf/f/b/c/q;Lf/f/b/c/l0/l;Lf/f/b/c/t0/f;)Lf/f/b/c/g0;

    move-result-object v0

    iput-object v0, p0, Lexpo/modules/av/player/SimpleExoPlayerData;->mSimpleExoPlayer:Lf/f/b/c/g0;

    .line 10
    invoke-virtual {v0, p0}, Lf/f/b/c/g0;->B(Lf/f/b/c/y$a;)V

    .line 11
    iget-object v0, p0, Lexpo/modules/av/player/SimpleExoPlayerData;->mSimpleExoPlayer:Lf/f/b/c/g0;

    invoke-virtual {v0, p0}, Lf/f/b/c/g0;->D(Lf/f/b/c/v0/p;)V

    .line 12
    iget-object v0, p0, Lexpo/modules/av/player/PlayerData;->mAVModule:Lexpo/modules/av/AVManagerInterface;

    invoke-interface {v0}, Lexpo/modules/av/AVManagerInterface;->getModuleRegistry()Ln/e/b/e;
    ...
    invoke-static {v0, v1}, Lf/f/b/c/u0/f0;->I(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    iget-object v11, p0, Lexpo/modules/av/player/PlayerData;->mRequestHeaders:Ljava/util/Map;

    invoke-interface {v6}, Lf/f/b/c/t0/f;->b()Lf/f/b/c/t0/c0;

    move-result-object v12

    invoke-interface/range {v7 .. v12}, Lexpo/modules/av/player/datasource/DataSourceFactoryProvider;->createFactory(Landroid/content/Context;Ln/e/b/e;Ljava/lang/String;Ljava/util/Map;Lf/f/b/c/t0/c0;)Lf/f/b/c/t0/k$a;
    ...
    invoke-direct {p0, v1, v2, p2, v0}, Lexpo/modules/av/player/SimpleExoPlayerData;->buildMediaSource(Landroid/net/Uri;Ljava/lang/String;Landroid/os/Handler;Lf/f/b/c/t0/k$a;)Lf/f/b/c/q0/w;
    ...
    invoke-virtual {v0, p2}, Lf/f/b/c/g0;->L(Lf/f/b/c/q0/w;)V

    const/4 p2, 0x0

    .line 15
    invoke-virtual {p0, p1, p2}, Lexpo/modules/av/player/PlayerData;->setStatus(Landroid/os/Bundle;Ln/e/b/h;)V
    :try_end_0
...
.method public onDownstreamFormatChanged(ILf/f/b/c/q0/w$a;Lf/f/b/c/q0/x$c;)V
    .locals 0

    return-void
.end method

.method public onLoadCanceled(ILf/f/b/c/q0/w$a;Lf/f/b/c/q0/x$b;Lf/f/b/c/q0/x$c;)V
    .locals 0

    return-void
.end method

.method public onLoadCompleted(ILf/f/b/c/q0/w$a;Lf/f/b/c/q0/x$b;Lf/f/b/c/q0/x$c;)V
    .locals 0
...
.method public onLoadStarted(ILf/f/b/c/q0/w$a;Lf/f/b/c/q0/x$b;Lf/f/b/c/q0/x$c;)V
    .locals 0
...
.method public onMediaPeriodCreated(ILf/f/b/c/q0/w$a;)V
    .locals 0

    return-void
.end method

.method public onMediaPeriodReleased(ILf/f/b/c/q0/w$a;)V
    .locals 0
...
.method public onPlayerError(Lf/f/b/c/h;)V
    .locals 0
...
.method public onReadingStarted(ILf/f/b/c/q0/w$a;)V
    .locals 0
...
.method public bridge synthetic onSurfaceSizeChanged(II)V
    ...
    invoke-static {p0, p1, p2}, Lf/f/b/c/v0/o;->a(Lf/f/b/c/v0/p;II)V

    return-void
.end method

.method public bridge synthetic onTimelineChanged(Lf/f/b/c/h0;Ljava/lang/Object;I)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lf/f/b/c/x;->a(Lf/f/b/c/y$a;Lf/f/b/c/h0;Ljava/lang/Object;I)V

    return-void
.end method

.method public onTracksChanged(Lf/f/b/c/q0/e0;Lf/f/b/c/s0/h;)V
    .locals 0

    return-void
.end method

.method public onUpstreamDiscarded(ILf/f/b/c/q0/w$a;Lf/f/b/c/q0/x$c;)V
    .locals 0
...
.method public pauseImmediately()V
    ...
    .line 2
    invoke-virtual {v0, v1}, Lf/f/b/c/g0;->Q(Z)V
...
.method playPlayerWithRateAndMuteIfNecessary()V
    ...
    :goto_0
    invoke-direct {v1, v2, v3}, Lf/f/b/c/w;-><init>(FF)V

    invoke-virtual {v0, v1}, Lf/f/b/c/g0;->R(Lf/f/b/c/w;)V
...
.method public declared-synchronized release()V
    ...
    .line 2
    invoke-virtual {v0}, Lf/f/b/c/g0;->N()V
...
.method public tryUpdateVideoSurface(Landroid/view/Surface;)V
    ...
    .line 2
    invoke-virtual {v0, p1}, Lf/f/b/c/g0;->T(Landroid/view/Surface;)V
...
.method public updateVolumeMuteAndDuck()V
    ...
    invoke-virtual {v0, v1}, Lf/f/b/c/g0;->V(F)V
