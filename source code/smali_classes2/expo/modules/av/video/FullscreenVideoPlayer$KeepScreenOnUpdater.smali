...
.method public run()V
    ...
    .line 5
    :goto_0
    invoke-static {v0}, Lexpo/modules/av/video/FullscreenVideoPlayer;->access$100(Lexpo/modules/av/video/FullscreenVideoPlayer;)Ln/e/b/e;
    ...
    .line 6
    const-class v6, Ln/e/b/l/r/b;

    invoke-virtual {v3, v6}, Ln/e/b/e;->f(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Ln/e/b/l/r/b;

    if-eqz v3, :cond_1

    .line 7
    invoke-interface {v3}, Ln/e/b/l/r/b;->isActivated()Z
