...
.method static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;

    const-string v3, "FULLSCREEN_PLAYER_DID_PRESENT"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4, v4}, Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;->FULLSCREEN_PLAYER_DID_PRESENT:Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;

    .line 3
    new-instance v3, Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;

    const-string v5, "FULLSCREEN_PLAYER_WILL_DISMISS"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6, v6}, Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;->FULLSCREEN_PLAYER_WILL_DISMISS:Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;

    .line 4
    new-instance v5, Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;

    const-string v7, "FULLSCREEN_PLAYER_DID_DISMISS"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8, v8}, Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;->FULLSCREEN_PLAYER_DID_DISMISS:Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;

    const/4 v7, 0x4

    new-array v7, v7, [Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;
    ...
    .line 5
    sput-object v7, Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;->$VALUES:[Lexpo/modules/av/video/VideoViewManager$FullscreenPlayerUpdate;
