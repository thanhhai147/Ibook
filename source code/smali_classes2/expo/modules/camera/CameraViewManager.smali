...
.method public createViewInstance(Landroid/content/Context;)Lexpo/modules/camera/ExpoCameraView;
    ...
    iget-object v1, p0, Lexpo/modules/camera/CameraViewManager;->mModuleRegistry:Ln/e/b/e;

    invoke-direct {v0, p1, v1}, Lexpo/modules/camera/ExpoCameraView;-><init>(Landroid/content/Context;Ln/e/b/e;)V
...
.method public onCreate(Ln/e/b/e;)V
    ...
    .line 1
    iput-object p1, p0, Lexpo/modules/camera/CameraViewManager;->mModuleRegistry:Ln/e/b/e;
...
.method public onDropViewInstance(Lexpo/modules/camera/ExpoCameraView;)V
    ...
    .line 2
    iget-object v0, p0, Lexpo/modules/camera/CameraViewManager;->mModuleRegistry:Ln/e/b/e;
    ...
    invoke-interface {v0, p1}, Ln/e/b/l/r/c;->unregisterLifecycleEventListener(Ln/e/b/l/k;)V

    .line 3
    invoke-virtual {p1}, Lf/f/b/a/e;->stop()V
...
.method public setAutoFocus(Lexpo/modules/camera/ExpoCameraView;Z)V
    ...
    .line 1
    invoke-virtual {p1, p2}, Lf/f/b/a/e;->setAutoFocus(Z)V
...
.method public setBarCodeScannerSettings(Lexpo/modules/camera/ExpoCameraView;Ljava/util/Map;)V
    ...
    .line 1
    new-instance v0, Ln/e/c/a/d;

    invoke-direct {v0, p2}, Ln/e/c/a/d;-><init>(Ljava/util/Map;)V

    invoke-virtual {p1, v0}, Lexpo/modules/camera/ExpoCameraView;->setBarCodeScannerSettings(Ln/e/c/a/d;)V
...
.method public setFlashMode(Lexpo/modules/camera/ExpoCameraView;I)V
    ...
    .line 1
    invoke-virtual {p1, p2}, Lf/f/b/a/e;->setFlash(I)V
...
.method public setFocusDepth(Lexpo/modules/camera/ExpoCameraView;F)V
    ...
    .line 1
    invoke-virtual {p1, p2}, Lf/f/b/a/e;->setFocusDepth(F)V
...
.method public setPictureSize(Lexpo/modules/camera/ExpoCameraView;Ljava/lang/String;)V
    ...
    .line 1
    invoke-static {p2}, Lf/f/b/a/l;->v(Ljava/lang/String;)Lf/f/b/a/l;

    move-result-object p2

    invoke-virtual {p1, p2}, Lf/f/b/a/e;->setPictureSize(Lf/f/b/a/l;)V
...
.method public setRatio(Lexpo/modules/camera/ExpoCameraView;Ljava/lang/String;)V
    ...
    .line 1
    invoke-static {p2}, Lf/f/b/a/a;->b0(Ljava/lang/String;)Lf/f/b/a/a;

    move-result-object p2

    invoke-virtual {p1, p2}, Lf/f/b/a/e;->setAspectRatio(Lf/f/b/a/a;)V
...
.method public setType(Lexpo/modules/camera/ExpoCameraView;I)V
    ...
    .line 1
    invoke-virtual {p1, p2}, Lf/f/b/a/e;->setFacing(I)V
...
.method public setUseCamera2Api(Lexpo/modules/camera/ExpoCameraView;Z)V
    ...
    .line 1
    invoke-virtual {p1, p2}, Lf/f/b/a/e;->setUsingCamera2Api(Z)V
...
.method public setWhiteBalance(Lexpo/modules/camera/ExpoCameraView;I)V
    ...
    .line 1
    invoke-virtual {p1, p2}, Lf/f/b/a/e;->setWhiteBalance(I)V
...
.method public setZoom(Lexpo/modules/camera/ExpoCameraView;F)V
    ...
    .line 1
    invoke-virtual {p1, p2}, Lf/f/b/a/e;->setZoom(F)V
