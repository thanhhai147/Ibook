...
.method static synthetic access$100(Lexpo/modules/contacts/ContactsModule;Ljava/lang/String;Ljava/util/Set;Ln/e/b/h;)Lexpo/modules/contacts/Contact;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lexpo/modules/contacts/ContactsModule;->getContactById(Ljava/lang/String;Ljava/util/Set;Ln/e/b/h;)Lexpo/modules/contacts/Contact;
...
.method static synthetic access$200(Lexpo/modules/contacts/ContactsModule;Ljava/util/Collection;Ljava/util/Set;Ln/e/b/h;)Ljava/util/ArrayList;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lexpo/modules/contacts/ContactsModule;->serializeContacts(Ljava/util/Collection;Ljava/util/Set;Ln/e/b/h;)Ljava/util/ArrayList;
...
.method static synthetic access$300(Lexpo/modules/contacts/ContactsModule;Ljava/lang/String;Ljava/util/Set;Ljava/lang/String;Ln/e/b/h;)Ljava/util/HashMap;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lexpo/modules/contacts/ContactsModule;->getContactByName(Ljava/lang/String;Ljava/util/Set;Ljava/lang/String;Ln/e/b/h;)Ljava/util/HashMap;
...
.method static synthetic access$400(Lexpo/modules/contacts/ContactsModule;Ljava/util/Map;Ljava/util/Set;Ljava/lang/String;Ln/e/b/h;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lexpo/modules/contacts/ContactsModule;->getAllContactsAsync(Ljava/util/Map;Ljava/util/Set;Ljava/lang/String;Ln/e/b/h;)V
...
.method private fetchContacts(II[Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;Ljava/lang/String;Ln/e/b/h;)Ljava/util/HashMap;
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(II[",
    ...
    .line 27
    :try_start_1
    invoke-interface {v3, v0}, Ln/e/b/h;->reject(Ljava/lang/Throwable;)V
    :try_end_1
...
.method private getAllContactsAsync(Ljava/util/Map;Ljava/util/Set;Ljava/lang/String;Ln/e/b/h;)V
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    invoke-direct/range {v0 .. v7}, Lexpo/modules/contacts/ContactsModule;->fetchContacts(II[Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;Ljava/lang/String;Ln/e/b/h;)Ljava/util/HashMap;
    ...
    .line 15
    invoke-interface {v8, v2}, Ln/e/b/h;->resolve(Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 16
    invoke-interface {v8, v0}, Ln/e/b/h;->reject(Ljava/lang/Throwable;)V
...
.method private getContactById(Ljava/lang/String;Ljava/util/Set;Ln/e/b/h;)Lexpo/modules/contacts/Contact;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 12
    :try_start_1
    invoke-interface {p3, p2}, Ln/e/b/h;->reject(Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private getContactByName(Ljava/lang/String;Ljava/util/Set;Ljava/lang/String;Ln/e/b/h;)Ljava/util/HashMap;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct/range {v1 .. v8}, Lexpo/modules/contacts/ContactsModule;->fetchContacts(II[Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;Ljava/lang/String;Ln/e/b/h;)Ljava/util/HashMap;
...
.method private isMissingReadPermission(Ln/e/b/h;)Z
    .locals 3

    .line 1
    iget-object v0, p0, Lexpo/modules/contacts/ContactsModule;->mModuleRegistry:Ln/e/b/e;
...
.method private isMissingWritePermission(Ln/e/b/h;)Z
    .locals 3
...
.method private presentEditForm(Lexpo/modules/contacts/Contact;)V
    ...
    .line 4
    iget-object p1, p0, Lexpo/modules/contacts/ContactsModule;->mModuleRegistry:Ln/e/b/e;

    const-class v1, Ln/e/b/l/b;

    invoke-virtual {p1, v1}, Ln/e/b/e;->f(Ljava/lang/Class;)Ljava/lang/Object;
...
.method private serializeContacts(Ljava/util/Collection;Ljava/util/Set;Ln/e/b/h;)Ljava/util/ArrayList;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public addContactAsync(Ljava/util/Map;Ljava/lang/String;Ln/e/b/h;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p3}, Lexpo/modules/contacts/ContactsModule;->isMissingReadPermission(Ln/e/b/h;)Z

    move-result p2

    if-nez p2, :cond_5

    invoke-direct {p0, p3}, Lexpo/modules/contacts/ContactsModule;->isMissingWritePermission(Ln/e/b/h;)Z
    ...
    .line 7
    invoke-interface {p3, v0, p2}, Ln/e/b/h;->reject(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    ...
    .line 14
    invoke-interface {p3, v0, p1}, Ln/e/b/h;->reject(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_8
...
.method public getContactByPhoneNumber(Ljava/lang/String;Ln/e/b/h;)V
    .locals 1
    .annotation runtime Ln/e/b/l/f;
    .end annotation

    .line 1
    invoke-direct {p0, p2}, Lexpo/modules/contacts/ContactsModule;->isMissingReadPermission(Ln/e/b/h;)Z
    ...
    invoke-direct {v0, p0, p1, p2}, Lexpo/modules/contacts/ContactsModule$3;-><init>(Lexpo/modules/contacts/ContactsModule;Ljava/lang/String;Ln/e/b/h;)V
...
.method public getContactsAsync(Ljava/util/Map;Ln/e/b/h;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1, p2}, Lexpo/modules/contacts/ContactsModule$2;-><init>(Lexpo/modules/contacts/ContactsModule;Ljava/util/Map;Ln/e/b/h;)V
...
.method public onCreate(Ln/e/b/e;)V
    ...
    .line 1
    iput-object p1, p0, Lexpo/modules/contacts/ContactsModule;->mModuleRegistry:Ln/e/b/e;
...
.method public presentFormAsync(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Ln/e/b/h;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p4}, Lexpo/modules/contacts/ContactsModule;->isMissingReadPermission(Ln/e/b/h;)Z
    ...
    .line 3
    invoke-direct {p0, p1, p2, p4}, Lexpo/modules/contacts/ContactsModule;->getContactById(Ljava/lang/String;Ljava/util/Set;Ln/e/b/h;)Lexpo/modules/contacts/Contact;
...
.method public removeContactAsync(Ljava/lang/String;Ln/e/b/h;)V
    .locals 2
    .annotation runtime Ln/e/b/l/f;
    .end annotation
    ...
    invoke-direct {p0, p2}, Lexpo/modules/contacts/ContactsModule;->isMissingWritePermission(Ln/e/b/h;)Z
...
.method public shareContactAsync(Ljava/lang/String;Ljava/lang/String;Ln/e/b/h;)V
    .locals 2
    .annotation runtime Ln/e/b/l/f;
    .end annotation
    ...
    .line 2
    invoke-interface {p3, v0, v1}, Ln/e/b/h;->reject(Ljava/lang/String;Ljava/lang/String;)V
...
.method public updateContactAsync(Ljava/util/Map;Ln/e/b/h;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    invoke-direct {p0, v0, v1, p2}, Lexpo/modules/contacts/ContactsModule;->getContactById(Ljava/lang/String;Ljava/util/Set;Ln/e/b/h;)Lexpo/modules/contacts/Contact;
...
.method public writeContactToFileAsync(Ljava/util/Map;Ln/e/b/h;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
