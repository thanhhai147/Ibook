...
.method static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lexpo/modules/filesystem/FileSystemModule$UploadType;

    const-string v3, "BINARY_CONTENT"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4, v2}, Lexpo/modules/filesystem/FileSystemModule$UploadType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lexpo/modules/filesystem/FileSystemModule$UploadType;->BINARY_CONTENT:Lexpo/modules/filesystem/FileSystemModule$UploadType;

    .line 3
    new-instance v3, Lexpo/modules/filesystem/FileSystemModule$UploadType;

    const-string v5, "MULTIPART"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6, v4}, Lexpo/modules/filesystem/FileSystemModule$UploadType;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lexpo/modules/filesystem/FileSystemModule$UploadType;->MULTIPART:Lexpo/modules/filesystem/FileSystemModule$UploadType;

    const/4 v5, 0x3

    new-array v5, v5, [Lexpo/modules/filesystem/FileSystemModule$UploadType;
    ...
    .line 4
    sput-object v5, Lexpo/modules/filesystem/FileSystemModule$UploadType;->$VALUES:[Lexpo/modules/filesystem/FileSystemModule$UploadType;
