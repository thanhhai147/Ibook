...
.method static synthetic access$000(Lexpo/modules/firebase/analytics/FirebaseAnalyticsModule;Ln/e/b/h;)Lcom/google/firebase/analytics/FirebaseAnalytics;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lexpo/modules/firebase/analytics/FirebaseAnalyticsModule;->getFirebaseAnalyticsOrReject(Ln/e/b/h;)Lcom/google/firebase/analytics/FirebaseAnalytics;
...
.method private getFirebaseAnalyticsOrReject(Ln/e/b/h;)Lcom/google/firebase/analytics/FirebaseAnalytics;
    .locals 5

    .line 1
    iget-object v0, p0, Lexpo/modules/firebase/analytics/FirebaseAnalyticsModule;->mModuleRegistry:Ln/e/b/e;
    ...
    .line 2
    iget-object v1, p0, Lexpo/modules/firebase/analytics/FirebaseAnalyticsModule;->mActivityProvider:Ln/e/b/l/b;
    ...
    .line 3
    invoke-interface {p1, v2, v0}, Ln/e/b/h;->reject(Ljava/lang/String;Ljava/lang/String;)V

    return-object v3

    .line 4
    :cond_0
    invoke-interface {v0}, Lexpo/modules/firebase/core/FirebaseCoreInterface;->getDefaultApp()Lf/f/d/c;
    ...
    invoke-virtual {v4}, Lf/f/d/c;->m()Ljava/lang/String;
...
.method public logEvent(Ljava/lang/String;Ljava/util/Map;Ln/e/b/h;)V
    .locals 3
    ...
    .line 1
    :try_start_0
    invoke-direct {p0, p3}, Lexpo/modules/firebase/analytics/FirebaseAnalyticsModule;->getFirebaseAnalyticsOrReject(Ln/e/b/h;)Lcom/google/firebase/analytics/FirebaseAnalytics;
    ...
    invoke-direct {v2, p2}, Ln/e/b/j/a;-><init>(Ljava/util/Map;)V
...
.method public onCreate(Ln/e/b/e;)V
    ...
    iput-object v0, p0, Lexpo/modules/firebase/analytics/FirebaseAnalyticsModule;->mActivityProvider:Ln/e/b/l/b;

    .line 2
    iput-object p1, p0, Lexpo/modules/firebase/analytics/FirebaseAnalyticsModule;->mModuleRegistry:Ln/e/b/e;
...
.method public resetAnalyticsData(Ln/e/b/h;)V
    .locals 1
    .annotation runtime Ln/e/b/l/f;
    .end annotation
...
.method public setAnalyticsCollectionEnabled(Ljava/lang/Boolean;Ln/e/b/h;)V
    .locals 1
    .annotation runtime Ln/e/b/l/f;
    .end annotation
    ...
    .line 1
    :try_start_0
    invoke-direct {p0, p2}, Lexpo/modules/firebase/analytics/FirebaseAnalyticsModule;->getFirebaseAnalyticsOrReject(Ln/e/b/h;)Lcom/google/firebase/analytics/FirebaseAnalytics;
...
.method public setCurrentScreen(Ljava/lang/String;Ljava/lang/String;Ln/e/b/h;)V
    .locals 8
    .annotation runtime Ln/e/b/l/f;
    .end annotation

    .line 1
    iget-object v0, p0, Lexpo/modules/firebase/analytics/FirebaseAnalyticsModule;->mActivityProvider:Ln/e/b/l/b;
    ...
    invoke-direct/range {v1 .. v6}, Lexpo/modules/firebase/analytics/FirebaseAnalyticsModule$1;-><init>(Lexpo/modules/firebase/analytics/FirebaseAnalyticsModule;Ln/e/b/h;Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V
...
.method public setSessionTimeoutDuration(DLn/e/b/h;)V
    .locals 1
    .annotation runtime Ln/e/b/l/f;
    .end annotation
...
.method public setUserId(Ljava/lang/String;Ln/e/b/h;)V
    .locals 1
    .annotation runtime Ln/e/b/l/f;
    .end annotation
...
.method public setUserProperties(Ljava/util/Map;Ln/e/b/h;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
