...
.field public static final x:Lkotlinx/coroutines/u;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/u;->x:Lkotlinx/coroutines/u;
    ...
    .line 3
    invoke-static {v0}, Lkotlin/q0/k;->k(Ljava/lang/String;)Ljava/lang/Integer;
...
.method private final W()Ljava/util/concurrent/ExecutorService;
    ...
    .line 2
    invoke-direct {p0}, Lkotlinx/coroutines/u;->a0()I

    move-result v1

    new-instance v2, Lkotlinx/coroutines/u$a;

    invoke-direct {v2, v0}, Lkotlinx/coroutines/u$a;-><init>(Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method private final Y()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/u;->W()Ljava/util/concurrent/ExecutorService;
    ...
    .line 3
    sget-boolean v2, Lkotlinx/coroutines/u;->q:Z
    ...
    .line 5
    sget-object v4, Lkotlinx/coroutines/u;->x:Lkotlinx/coroutines/u;

    invoke-virtual {v4, v1, v2}, Lkotlinx/coroutines/u;->b0(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    invoke-direct {v4}, Lkotlinx/coroutines/u;->a0()I
...
.method private final declared-synchronized Z()Ljava/util/concurrent/Executor;
    .locals 1
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/u;->Y()Ljava/util/concurrent/ExecutorService;
...
.method private final a0()I
    ...
    .line 1
    sget v0, Lkotlinx/coroutines/u;->d:I
    ...
    invoke-static {v0, v2}, Lkotlin/n0/d;->b(II)I
...
.method public N(Lkotlin/g0/g;Ljava/lang/Runnable;)V
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/u;->Z()Ljava/util/concurrent/Executor;
    ...
    invoke-interface {v0, p2}, Lkotlinx/coroutines/r2;->g(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    .line 3
    :cond_2
    sget-object p1, Lkotlinx/coroutines/q0;->V1:Lkotlinx/coroutines/q0;

    invoke-virtual {p1, p2}, Lkotlinx/coroutines/e1;->C0(Ljava/lang/Runnable;)V

    :goto_2
    return-void
.end method

.method public final b0(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    .locals 4
    ...
    .line 1
    sget-object v0, Lkotlinx/coroutines/u$b;->c:Lkotlinx/coroutines/u$b;
