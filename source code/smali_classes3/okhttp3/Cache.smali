...
.method public static key(Lokhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lm/f;->R(Ljava/lang/String;)Lm/f;

    move-result-object p0

    invoke-virtual {p0}, Lm/f;->c0()Lm/f;
...
.method static readInt(Lm/e;)I
    .locals 5

    .line 1
    :try_start_0
    invoke-interface {p0}, Lm/e;->O0()J

    move-result-wide v0

    .line 2
    invoke-interface {p0}, Lm/e;->n0()Ljava/lang/String;
...
.method get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v0, v3}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lm/u;

    move-result-object v3

    invoke-direct {v2, v3}, Lokhttp3/Cache$Entry;-><init>(Lm/u;)V
    :try_end_1
