...
.method snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lm/u;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Lm/u;[J)V
    :try_end_0
...
.method writeLengths(Lm/d;)V
    ...
    .line 2
    invoke-interface {p1, v5}, Lm/d;->N0(I)Lm/d;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lm/d;->B0(J)Lm/d;
