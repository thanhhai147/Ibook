...
.field private sink:Lm/d;

.field private socket:Ljava/net/Socket;

.field private source:Lm/e;
...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lm/e;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lm/d;
    :try_end_1
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 31
    invoke-static {v1}, Lm/l;->m(Ljava/net/Socket;)Lm/u;
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 7
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lm/d;

    .line 8
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lm/e;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lm/e;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lm/d;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lm/e;Lm/d;)V

    .line 3
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lm/e;

    invoke-interface {v1}, Lm/u;->timeout()Lm/v;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lm/v;->timeout(JLjava/util/concurrent/TimeUnit;)Lm/v;

    .line 4
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lm/d;

    invoke-interface {v1}, Lm/t;->timeout()Lm/v;
    ...
    .line 17
    :cond_3
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lm/e;

    invoke-interface {p1}, Lm/e;->K()Lm/c;

    move-result-object p1

    invoke-virtual {p1}, Lm/c;->M0()Z

    move-result p1

    if-eqz p1, :cond_4

    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lm/d;

    invoke-interface {p1}, Lm/d;->f()Lm/c;
...
.method private startHttp2(I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lm/e;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lm/d;

    invoke-virtual {v0, v1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lm/e;Lm/d;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 28
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:Lm/e;

    .line 29
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lm/d;
...
.method public isHealthy(Z)Z
    ...
    .line 6
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lm/e;

    invoke-interface {v2}, Lm/e;->M0()Z
...
.method newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    .line 4
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lm/e;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lm/v;->timeout(JLjava/util/concurrent/TimeUnit;)Lm/v;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lm/d;
    ...
    invoke-direct {p2, p1, p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lm/e;Lm/d;)V
...
.method newWebSocketStreams(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    iget-object v5, p0, Lokhttp3/internal/connection/RealConnection;->source:Lm/e;

    iget-object v6, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lm/d;
    ...
    invoke-direct/range {v2 .. v7}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLm/e;Lm/d;Lokhttp3/internal/connection/Exchange;)V
