...
.field private final timeout:Lm/a;
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/Call;)V
    ...
    iput-object v0, p0, Lokhttp3/internal/connection/Transmitter;->timeout:Lm/a;
    ...
    invoke-virtual {v0, p1, p2, v1}, Lm/v;->timeout(JLjava/util/concurrent/TimeUnit;)Lm/v;
...
.method private timeoutExit(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lokhttp3/internal/connection/Transmitter;->timeout:Lm/a;

    invoke-virtual {v0}, Lm/a;->exit()Z
