...
# static fields
.field private static final QUOTED_STRING_DELIMITERS:Lm/f;

.field private static final TOKEN_DELIMITERS:Lm/f;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:Lm/f;
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lm/f;
...
.method private static parseChallengeHeader(Ljava/util/List;Lm/c;)V
    .locals 8
    ...
    .line 1
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->skipWhitespaceAndCommas(Lm/c;)Z

    .line 2
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->readToken(Lm/c;)Ljava/lang/String;
    ...
    .line 7
    invoke-static {p1, v4}, Lokhttp3/internal/http/HttpHeaders;->skipAll(Lm/c;B)I
    ...
    invoke-virtual {p1, v6, v7}, Lm/c;->o(J)B
    ...
    .line 21
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->readQuotedString(Lm/c;)Ljava/lang/String;
...
.method public static parseChallenges(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v2, v3}, Lm/c;->R0(Ljava/lang/String;)Lm/c;

    .line 5
    invoke-static {v0, v2}, Lokhttp3/internal/http/HttpHeaders;->parseChallengeHeader(Ljava/util/List;Lm/c;)V
...
.method private static readQuotedString(Lm/c;)Ljava/lang/String;
    .locals 12
    ...
    .line 3
    :goto_0
    sget-object v2, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:Lm/f;

    invoke-virtual {p0, v2}, Lm/c;->S(Lm/f;)J
    ...
    .line 5
    invoke-virtual {v0, p0, v2, v3}, Lm/c;->write(Lm/c;J)V
    ...
    .line 11
    invoke-virtual {v0, p0, v7, v8}, Lm/c;->write(Lm/c;J)V
...
.method private static readToken(Lm/c;)Ljava/lang/String;
    .locals 5

    .line 1
    :try_start_0
    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lm/f;

    invoke-virtual {p0, v0}, Lm/c;->S(Lm/f;)J
    ...
    .line 3
    invoke-virtual {p0, v0, v1}, Lm/c;->O(J)Ljava/lang/String;
...
.method private static skipAll(Lm/c;B)I
    .locals 3
    ...
    invoke-virtual {p0, v1, v2}, Lm/c;->o(J)B
...
.method private static skipWhitespaceAndCommas(Lm/c;)Z
    .locals 3
