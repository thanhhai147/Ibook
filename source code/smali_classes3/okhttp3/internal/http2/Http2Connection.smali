...
.method constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iget-object v4, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lm/d;

    invoke-direct {v2, v4, v3}, Lokhttp3/internal/http2/Http2Writer;-><init>(Lm/d;Z)V
    ...
    iget-object v1, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lm/e;

    invoke-direct {v4, v1, v3}, Lokhttp3/internal/http2/Http2Reader;-><init>(Lm/e;Z)V
...
.method pushDataLater(ILm/e;IZ)V
    .locals 8
    ...
    .line 2
    invoke-interface {p2, v0, v1}, Lm/e;->z0(J)V

    .line 3
    invoke-interface {p2, v5, v0, v1}, Lm/u;->read(Lm/c;J)J

    .line 4
    invoke-virtual {v5}, Lm/c;->size()J
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/http2/Http2Connection$6;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILm/c;IZ)V
...
.method public writeData(IZLm/c;J)V
    .locals 8
    ...
    invoke-virtual {p4, p2, p1, p3, v0}, Lokhttp3/internal/http2/Http2Writer;->data(ZILm/c;I)V
    ...
    :goto_2
    invoke-virtual {v4, v5, p1, p3, v3}, Lokhttp3/internal/http2/Http2Writer;->data(ZILm/c;I)V
