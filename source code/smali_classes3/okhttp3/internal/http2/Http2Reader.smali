...
.method constructor <init>(Lm/e;Z)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lm/e;
    ...
    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lm/e;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILm/u;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lm/e;
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lm/e;

    invoke-interface {p1, v1, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILm/e;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lm/e;
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lm/e;
    ...
    .line 2
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lm/e;

    invoke-interface {v2}, Lm/e;->readInt()I
    ...
    invoke-interface {p3, v1, v2}, Lm/e;->H0(J)Lm/f;

    move-result-object p3

    .line 6
    :cond_0
    invoke-interface {p1, p4, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lm/f;)V
...
.method static readMedium(Lm/e;)I
    .locals 2
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lm/e;
...
.method private readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lm/e;
...
.method private readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 2
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lm/e;
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v2}, Lm/e;->readShort()S
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v1, v2, v3}, Lm/e;->z0(J)V
    :try_end_0
    ...
    invoke-static {v1}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Lm/e;)I
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lm/f;
    ...
    invoke-interface {p1, v3, v4}, Lm/e;->H0(J)Lm/f;
    ...
    .line 7
    invoke-virtual {p1}, Lm/f;->p0()Ljava/lang/String;
