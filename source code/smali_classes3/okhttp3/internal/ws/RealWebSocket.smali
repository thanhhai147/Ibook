...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    invoke-virtual {p1}, Lm/f;->d()Ljava/lang/String;
...
.method private declared-synchronized send(Lm/f;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILm/f;)V
...
.method public synthetic b()V
    ...
    invoke-direct {p0}, Lokhttp3/internal/ws/RealWebSocket;->a()V
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILm/f;J)V
...
.method public initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Lm/d;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLm/d;Ljava/util/Random;)V
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Lm/e;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLm/e;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(Lm/f;)V
    .locals 1

    .line 2
    iget-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->listener:Lokhttp3/WebSocketListener;

    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lm/f;)V

    return-void
.end method

.method public declared-synchronized onReadPing(Lm/f;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Lm/f;)V
    .locals 0
...
.method declared-synchronized pong(Lm/f;)Z
    .locals 1
...
.method public send(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lm/f;I)Z
...
.method writeOneFrame()Z
    ...
    .line 16
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lm/f;)V
    ...
    iget-object v2, v2, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Lm/f;
    ...
    .line 21
    invoke-virtual {v0, v3, v4, v5}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lm/t;
    ...
    .line 22
    invoke-interface {v0, v2}, Lm/d;->t1(Lm/f;)Lm/d;
    ...
    iget-object v4, v4, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Lm/f;

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILm/f;)V
...
.method writePingFrame()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lm/f;)V
    :try_end_1
