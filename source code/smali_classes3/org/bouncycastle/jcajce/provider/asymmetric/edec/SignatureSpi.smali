...
.field private signer:Ln/b/b/f0;
...
.method private getSigner(Ljava/lang/String;)Ln/b/b/f0;
    .locals 2
    ...
    new-instance p1, Ln/b/b/x0/j;

    sget-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/SignatureSpi;->EMPTY_CONTEXT:[B

    invoke-direct {p1, v0}, Ln/b/b/x0/j;-><init>([B)V

    return-object p1

    :cond_2
    new-instance p1, Ln/b/b/x0/i;

    invoke-direct {p1}, Ln/b/b/x0/i;-><init>()V
...
.method protected engineInitSign(Ljava/security/PrivateKey;)V
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPrivateKey;->engineGetKeyParameters()Ln/b/b/u0/b;

    move-result-object p1

    instance-of v0, p1, Ln/b/b/u0/j0;
    ...
    :goto_0
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/SignatureSpi;->getSigner(Ljava/lang/String;)Ln/b/b/f0;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/SignatureSpi;->signer:Ln/b/b/f0;

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/SignatureSpi;->signer:Ln/b/b/f0;

    const/4 v1, 0x1

    invoke-interface {v0, v1, p1}, Ln/b/b/f0;->init(ZLn/b/b/i;)V
...
.method protected engineInitVerify(Ljava/security/PublicKey;)V
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPublicKey;->engineGetKeyParameters()Ln/b/b/u0/b;

    move-result-object p1

    instance-of v0, p1, Ln/b/b/u0/k0;
...
.method protected engineSign()[B
    ...
    invoke-interface {v0}, Ln/b/b/f0;->b()[B
...
.method protected engineUpdate(B)V
    ...
    invoke-interface {v0, p1}, Ln/b/b/f0;->update(B)V
...
.method protected engineUpdate([BII)V
    ...
    invoke-interface {v0, p1, p2, p3}, Ln/b/b/f0;->update([BII)V
...
.method protected engineVerify([B)Z
    ...
    invoke-interface {v0, p1}, Ln/b/b/f0;->a([B)Z
