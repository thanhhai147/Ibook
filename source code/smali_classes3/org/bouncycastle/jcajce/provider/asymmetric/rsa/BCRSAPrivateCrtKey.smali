...
.method constructor <init>(Ljava/security/interfaces/RSAPrivateCrtKey;)V
    ...
    invoke-direct {p0, v9}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Ln/b/b/u0/m1;)V
...
.method constructor <init>(Ln/b/a/f3/b;Ln/b/a/y2/s;)V
    ...
    invoke-virtual {p2}, Ln/b/a/y2/s;->B()Ljava/math/BigInteger;
    ...
    invoke-virtual {p2}, Ln/b/a/y2/s;->x()Ljava/math/BigInteger;

    move-result-object v4

    invoke-virtual {p2}, Ln/b/a/y2/s;->y()Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {p2}, Ln/b/a/y2/s;->r()Ljava/math/BigInteger;

    move-result-object v6

    invoke-virtual {p2}, Ln/b/a/y2/s;->t()Ljava/math/BigInteger;

    move-result-object v7

    invoke-virtual {p2}, Ln/b/a/y2/s;->p()Ljava/math/BigInteger;
    ...
    invoke-direct {p0, p1, v9}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Ln/b/a/f3/b;Ln/b/b/u0/m1;)V
...
.method constructor <init>(Ln/b/a/f3/b;Ln/b/b/u0/n1;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Ln/b/a/f3/b;Ln/b/b/u0/m1;)V
    ...
    invoke-virtual {p2}, Ln/b/b/u0/n1;->g()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeP:Ljava/math/BigInteger;

    invoke-virtual {p2}, Ln/b/b/u0/n1;->i()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeQ:Ljava/math/BigInteger;

    invoke-virtual {p2}, Ln/b/b/u0/n1;->e()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeExponentP:Ljava/math/BigInteger;

    invoke-virtual {p2}, Ln/b/b/u0/n1;->f()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeExponentQ:Ljava/math/BigInteger;

    invoke-virtual {p2}, Ln/b/b/u0/n1;->j()Ljava/math/BigInteger;
...
.method constructor <init>(Ln/b/a/y2/p;)V
    ...
    invoke-direct {p0, v0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;-><init>(Ln/b/a/f3/b;Ln/b/a/y2/s;)V

    return-void
.end method

.method constructor <init>(Ln/b/a/y2/s;)V
    .locals 1
...
.method constructor <init>(Ln/b/b/u0/n1;)V
    .locals 1

    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Ln/b/b/u0/m1;)V

    invoke-virtual {p1}, Ln/b/b/u0/n1;->h()Ljava/math/BigInteger;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->publicExponent:Ljava/math/BigInteger;

    invoke-virtual {p1}, Ln/b/b/u0/n1;->g()Ljava/math/BigInteger;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeP:Ljava/math/BigInteger;

    invoke-virtual {p1}, Ln/b/b/u0/n1;->i()Ljava/math/BigInteger;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeQ:Ljava/math/BigInteger;

    invoke-virtual {p1}, Ln/b/b/u0/n1;->e()Ljava/math/BigInteger;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeExponentP:Ljava/math/BigInteger;

    invoke-virtual {p1}, Ln/b/b/u0/n1;->f()Ljava/math/BigInteger;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeExponentQ:Ljava/math/BigInteger;

    invoke-virtual {p1}, Ln/b/b/u0/n1;->j()Ljava/math/BigInteger;
