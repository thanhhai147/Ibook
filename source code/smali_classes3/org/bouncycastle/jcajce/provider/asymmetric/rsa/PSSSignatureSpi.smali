...
# instance fields
.field private contentDigest:Ln/b/b/r;
...
.field private key:Ln/b/b/u0/m1;

.field private mgfDigest:Ln/b/b/r;
...
.field private pss:Ln/b/b/x0/o;

.field private random:Ljava/security/SecureRandom;

.field private saltLength:I

.field private signer:Ln/b/b/a;

.field private trailer:B


# direct methods
.method protected constructor <init>(Ln/b/b/a;Ljava/security/spec/PSSParameterSpec;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, p2, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;-><init>(Ln/b/b/a;Ljava/security/spec/PSSParameterSpec;Z)V

    return-void
.end method

.method protected constructor <init>(Ln/b/b/a;Ljava/security/spec/PSSParameterSpec;Z)V
    .locals 1
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->helper:Ln/b/c/w/c;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->isInitState:Z

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->signer:Ln/b/b/a;
    ...
    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/util/DigestFactory;->getDigest(Ljava/lang/String;)Ln/b/b/r;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:Ln/b/b/r;
...
.method private setupContentDigest()V
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:Ln/b/b/r;

    invoke-direct {v0, p0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi$NullPssDigest;-><init>(Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;Ln/b/b/r;)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:Ln/b/b/r;

    :goto_0
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->contentDigest:Ln/b/b/r;
...
.method protected engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->helper:Ln/b/c/w/c;
...
.method protected engineInitSign(Ljava/security/PrivateKey;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:Ln/b/b/u0/m1;

    new-instance p1, Ln/b/b/x0/o;

    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->signer:Ln/b/b/a;

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->contentDigest:Ln/b/b/r;

    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:Ln/b/b/r;
    ...
    invoke-direct/range {v0 .. v5}, Ln/b/b/x0/o;-><init>(Ln/b/b/a;Ln/b/b/r;Ln/b/b/r;IB)V

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->pss:Ln/b/b/x0/o;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:Ln/b/b/u0/m1;

    invoke-direct {v2, v3, v0}, Ln/b/b/u0/f1;-><init>(Ln/b/b/i;Ljava/security/SecureRandom;)V

    invoke-virtual {p1, v1, v2}, Ln/b/b/x0/o;->init(ZLn/b/b/i;)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:Ln/b/b/u0/m1;

    invoke-virtual {p1, v1, v0}, Ln/b/b/x0/o;->init(ZLn/b/b/i;)V
...
.method protected engineInitVerify(Ljava/security/PublicKey;)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:Ln/b/b/u0/m1;

    invoke-virtual {p1, v0, v1}, Ln/b/b/x0/o;->init(ZLn/b/b/i;)V
...
.method protected engineSetParameter(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    sget-object v1, Ln/b/a/y2/n;->o:Ln/b/a/o;
    ...
    invoke-static {v1}, Lorg/bouncycastle/jcajce/provider/util/DigestFactory;->getDigest(Ljava/lang/String;)Ln/b/b/r;
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:Ln/b/b/r;
    ...
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:Ln/b/b/u0/m1;
    ...
    invoke-virtual {p1}, Ln/b/b/u0/b;->a()Z

    move-result p1

    if-eqz p1, :cond_6

    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->pss:Ln/b/b/x0/o;
...
.method protected engineSign()[B
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->pss:Ln/b/b/x0/o;

    invoke-virtual {v0}, Ln/b/b/x0/o;->b()[B
...
.method protected engineUpdate(B)V
    ...
    invoke-virtual {v0, p1}, Ln/b/b/x0/o;->update(B)V
...
.method protected engineUpdate([BII)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Ln/b/b/x0/o;->update([BII)V
...
.method protected engineVerify([B)Z
    ...
    invoke-virtual {v0, p1}, Ln/b/b/x0/o;->a([B)Z
