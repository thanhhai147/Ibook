...
.method public readObject(Ljava/io/ObjectInputStream;)V
    ...
    :cond_0
    new-instance p1, Ln/b/a/k;

    check-cast v0, [B

    invoke-direct {p1, v0}, Ln/b/a/k;-><init>([B)V
    ...
    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/PKCS12BagAttributeCarrierImpl;->setBagAttribute(Ln/b/a/o;Ln/b/a/e;)V
...
.method public writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    invoke-static {v0}, Ln/b/a/r;->a(Ljava/io/OutputStream;)Ln/b/a/r;
    ...
    invoke-virtual {v1, v3}, Ln/b/a/r;->t(Ln/b/a/t;)V
    ...
    invoke-virtual {v1, v3}, Ln/b/a/r;->s(Ln/b/a/e;)V
