...
.method private static createBaseRandom(Z)Ljava/security/SecureRandom;
    ...
    invoke-static {}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG;->createEntropySource()Ln/b/b/w0/d;

    move-result-object v0

    const/16 v1, 0x80

    invoke-interface {v0, v1}, Ln/b/b/w0/d;->get(I)Ln/b/b/w0/c;

    move-result-object v1

    invoke-interface {v1}, Ln/b/b/w0/c;->getEntropy()[B
    ...
    :goto_0
    new-instance v3, Ln/b/b/w0/g;

    invoke-direct {v3, v0}, Ln/b/b/w0/g;-><init>(Ln/b/b/w0/d;)V

    invoke-virtual {v3, v2}, Ln/b/b/w0/g;->e([B)Ln/b/b/w0/g;

    new-instance v0, Ln/b/b/l0/a0;

    invoke-direct {v0}, Ln/b/b/l0/a0;-><init>()V
    ...
    invoke-static {v2, v1}, Ln/b/g/a;->o([B[B)[B

    move-result-object v1

    invoke-virtual {v3, v0, v1, p0}, Ln/b/b/w0/g;->c(Ln/b/b/r;[BZ)Ln/b/b/w0/f;
    ...
    invoke-direct {v2, v0, v3}, Ln/b/b/w0/g;-><init>(Ljava/security/SecureRandom;Z)V

    invoke-virtual {v2, v1}, Ln/b/b/w0/g;->e([B)Ln/b/b/w0/g;
    ...
    invoke-virtual {v2, v1, v0, p0}, Ln/b/b/w0/g;->c(Ln/b/b/r;[BZ)Ln/b/b/w0/f;
...
.method private static createEntropySource()Ln/b/b/w0/d;
    .locals 2
...
.method private static generateDefaultPersonalizationString([B)[B
    ...
    invoke-static {v1, v2}, Ln/b/g/k;->t(J)[B
    ...
    invoke-static {v2, v3}, Ln/b/g/k;->t(J)[B

    move-result-object v2

    invoke-static {v0, p0, v1, v2}, Ln/b/g/a;->q([B[B[B[B)[B
...
.method private static generateNonceIVPersonalizationString([B)[B
    ...
    invoke-static {v1, v2}, Ln/b/g/k;->x(J)[B
    ...
    invoke-static {v2, v3}, Ln/b/g/k;->x(J)[B
