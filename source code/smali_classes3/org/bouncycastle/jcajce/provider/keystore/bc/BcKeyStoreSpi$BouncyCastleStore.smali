...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    new-instance p2, Ln/b/c/u/a;

    invoke-direct {p2, v0, p1}, Ln/b/c/u/a;-><init>(Ljava/io/InputStream;Ljavax/crypto/Cipher;)V

    new-instance p1, Ln/b/b/l0/v;

    invoke-direct {p1}, Ln/b/b/l0/v;-><init>()V

    new-instance v0, Ln/b/b/q0/b;

    invoke-direct {v0, p2, p1}, Ln/b/b/q0/b;-><init>(Ljava/io/InputStream;Ln/b/b/r;)V
    ...
    invoke-static {p2, p1}, Ln/b/g/r/b;->e(Ljava/io/InputStream;[B)I
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    new-instance p2, Ln/b/c/u/b;

    invoke-direct {p2, v0, p1}, Ln/b/c/u/b;-><init>(Ljava/io/OutputStream;Ljavax/crypto/Cipher;)V

    new-instance p1, Ln/b/b/q0/c;

    new-instance v0, Ln/b/b/l0/v;

    invoke-direct {v0}, Ln/b/b/l0/v;-><init>()V

    invoke-direct {p1, v0}, Ln/b/b/q0/c;-><init>(Ln/b/b/r;)V

    new-instance v0, Ln/b/g/r/c;

    invoke-direct {v0, p2, p1}, Ln/b/g/r/c;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V

    invoke-virtual {p0, v0}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->saveStore(Ljava/io/OutputStream;)V

    invoke-virtual {p1}, Ln/b/b/q0/c;->a()[B

    move-result-object p1

    invoke-virtual {p2, p1}, Ljava/io/FilterOutputStream;->write([B)V

    invoke-virtual {p2}, Ln/b/c/u/b;->close()V
