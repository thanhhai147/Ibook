...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Ln/b/c/w/c;
...
.method private decodeCertificate(Ljava/io/DataInputStream;)Ljava/security/cert/Certificate;
    ...
    :try_start_0
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Ln/b/c/w/c;

    invoke-interface {p1, v0}, Ln/b/c/w/c;->c(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method private decodeKey(Ljava/io/DataInputStream;)Ljava/security/Key;
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Ln/b/c/w/c;

    invoke-interface {v0, v2}, Ln/b/c/w/c;->d(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    :cond_7
    invoke-static {v3}, Ln/b/a/y2/p;->r(Ljava/lang/Object;)Ln/b/a/y2/p;

    move-result-object p1

    invoke-static {p1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->getPrivateKey(Ln/b/a/y2/p;)Ljava/security/PrivateKey;
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    new-instance v4, Ln/b/b/r0/g;

    new-instance v5, Ln/b/b/l0/v;

    invoke-direct {v5}, Ln/b/b/l0/v;-><init>()V

    invoke-direct {v4, v5}, Ln/b/b/r0/g;-><init>(Ln/b/b/r;)V
    ...
    new-instance v5, Ln/b/b/p0/v;

    new-instance v6, Ln/b/b/l0/v;

    invoke-direct {v6}, Ln/b/b/l0/v;-><init>()V

    invoke-direct {v5, v6}, Ln/b/b/p0/v;-><init>(Ln/b/b/r;)V

    invoke-virtual {v5, p2, v2, v3}, Ln/b/b/b0;->init([B[BI)V

    if-eq p1, v1, :cond_3

    invoke-virtual {v4}, Ln/b/b/r0/g;->getMacSize()I
    ...
    :goto_1
    invoke-virtual {v5, p1}, Ln/b/b/b0;->generateDerivedMacParameters(I)Ln/b/b/i;

    move-result-object p1

    const/4 v1, 0x0

    invoke-static {p2, v1}, Ln/b/g/a;->w([BB)V

    invoke-virtual {v4, p1}, Ln/b/b/r0/g;->init(Ln/b/b/i;)V

    new-instance p1, Ln/b/b/q0/e;

    invoke-direct {p1, v0, v4}, Ln/b/b/q0/e;-><init>(Ljava/io/InputStream;Ln/b/b/y;)V
    ...
    invoke-virtual {v4, p1, v1}, Ln/b/b/r0/g;->doFinal([BI)I
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    new-instance p1, Ln/b/b/r0/g;

    new-instance v3, Ln/b/b/l0/v;

    invoke-direct {v3}, Ln/b/b/l0/v;-><init>()V

    invoke-direct {p1, v3}, Ln/b/b/r0/g;-><init>(Ln/b/b/r;)V

    new-instance v3, Ln/b/b/q0/f;

    invoke-direct {v3, p1}, Ln/b/b/q0/f;-><init>(Ln/b/b/y;)V

    new-instance v4, Ln/b/b/p0/v;

    new-instance v5, Ln/b/b/l0/v;

    invoke-direct {v5}, Ln/b/b/l0/v;-><init>()V

    invoke-direct {v4, v5}, Ln/b/b/p0/v;-><init>(Ln/b/b/r;)V

    invoke-static {p2}, Ln/b/b/b0;->PKCS12PasswordToBytes([C)[B

    move-result-object p2

    invoke-virtual {v4, p2, v1, v2}, Ln/b/b/b0;->init([B[BI)V
    ...
    invoke-virtual {p1}, Ln/b/b/r0/g;->getMacSize()I
    ...
    :goto_0
    invoke-virtual {v4, v1}, Ln/b/b/b0;->generateDerivedMacParameters(I)Ln/b/b/i;

    move-result-object v1

    invoke-virtual {p1, v1}, Ln/b/b/r0/g;->init(Ln/b/b/i;)V
    ...
    :cond_1
    new-instance p2, Ln/b/g/r/c;

    invoke-direct {p2, v0, v3}, Ln/b/g/r/c;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V
    ...
    invoke-virtual {p1, p2, v1}, Ln/b/b/r0/g;->doFinal([BI)I
...
.method protected makePBECipher(Ljava/lang/String;I[C[BI)Ljavax/crypto/Cipher;
    ...
    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Ln/b/c/w/c;

    invoke-interface {p3, p1}, Ln/b/c/w/c;->d(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    iget-object p4, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Ln/b/c/w/c;

    invoke-interface {p4, p1}, Ln/b/c/w/c;->b(Ljava/lang/String;)Ljavax/crypto/Cipher;
