...
# instance fields
.field private certAlgorithm:Ln/b/a/o;
...
.field private keyAlgorithm:Ln/b/a/o;
...
.field private macAlgorithm:Ln/b/a/f3/b;
...
.method public constructor <init>(Ln/b/c/w/c;Ln/b/a/o;Ln/b/a/o;)V
    .locals 3
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ln/b/c/w/c;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->macAlgorithm:Ln/b/a/f3/b;
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->keyAlgorithm:Ln/b/a/o;

    iput-object p3, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->certAlgorithm:Ln/b/a/o;

    :try_start_0
    const-string p2, "X.509"

    invoke-interface {p1, p2}, Ln/b/c/w/c;->c(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method static synthetic access$100(Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;Ljava/security/PublicKey;)Ln/b/a/f3/m0;
    .locals 0

    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSubjectKeyId(Ljava/security/PublicKey;)Ln/b/a/f3/m0;
...
.method private calculatePbeMac(Ln/b/a/o;[BI[CZ[B)[B
    .locals 1
    ...
    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ln/b/c/w/c;

    invoke-virtual {p1}, Ln/b/a/o;->I()Ljava/lang/String;

    move-result-object p1

    invoke-interface {p2, p1}, Ln/b/c/w/c;->g(Ljava/lang/String;)Ljavax/crypto/Mac;

    move-result-object p1

    new-instance p2, Ln/b/c/i;

    invoke-direct {p2, p4, p5}, Ln/b/c/i;-><init>([CZ)V
...
.method private createCipher(I[CLn/b/a/f3/b;)Ljavax/crypto/Cipher;
    .locals 10

    invoke-virtual {p3}, Ln/b/a/f3/b;->u()Ln/b/a/e;

    move-result-object p3

    invoke-static {p3}, Ln/b/a/y2/k;->r(Ljava/lang/Object;)Ln/b/a/y2/k;

    move-result-object p3

    invoke-virtual {p3}, Ln/b/a/y2/k;->t()Ln/b/a/y2/h;

    move-result-object v0

    invoke-virtual {v0}, Ln/b/a/y2/h;->t()Ln/b/a/e;
    ...
    invoke-virtual {p3}, Ln/b/a/y2/k;->p()Ln/b/a/y2/g;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ln/b/c/w/c;

    invoke-virtual {p3}, Ln/b/a/y2/k;->t()Ln/b/a/y2/h;

    move-result-object v3

    invoke-virtual {v3}, Ln/b/a/y2/h;->p()Ln/b/a/o;
    ...
    invoke-interface {v2, v3}, Ln/b/c/w/c;->d(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;

    move-result-object v2

    invoke-virtual {v0}, Ln/b/a/y2/l;->x()Z
    ...
    invoke-virtual {v0}, Ln/b/a/y2/l;->v()[B

    move-result-object v4

    invoke-virtual {v0}, Ln/b/a/y2/l;->r()Ljava/math/BigInteger;
    ...
    invoke-virtual {v5, v1}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$DefaultSecretKeyProvider;->getKeySize(Ln/b/a/f3/b;)I
    ...
    invoke-virtual {v3, v1}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$DefaultSecretKeyProvider;->getKeySize(Ln/b/a/f3/b;)I

    move-result v7

    invoke-virtual {v0}, Ln/b/a/y2/l;->u()Ln/b/a/f3/b;
    ...
    invoke-direct/range {v3 .. v8}, Ln/b/c/v/n;-><init>([C[BIILn/b/a/f3/b;)V
    ...
    invoke-virtual {p3}, Ln/b/a/y2/g;->t()Ln/b/a/e;

    move-result-object p3

    instance-of v1, p3, Ln/b/a/p;

    if-eqz v1, :cond_1

    new-instance v1, Ljavax/crypto/spec/IvParameterSpec;

    invoke-static {p3}, Ln/b/a/p;->C(Ljava/lang/Object;)Ln/b/a/p;

    move-result-object p3

    invoke-virtual {p3}, Ln/b/a/p;->E()[B
    ...
    :cond_1
    invoke-static {p3}, Ln/b/a/i2/c;->t(Ljava/lang/Object;)Ln/b/a/i2/c;

    move-result-object p3

    new-instance v1, Ln/b/c/v/h;

    invoke-virtual {p3}, Ln/b/a/i2/c;->p()Ln/b/a/o;

    move-result-object v2

    invoke-virtual {p3}, Ln/b/a/i2/c;->r()[B

    move-result-object p3

    invoke-direct {v1, v2, p3}, Ln/b/c/v/h;-><init>(Ln/b/a/o;[B)V
...
.method private createSafeBag(Ljava/lang/String;Ljava/security/cert/Certificate;)Ln/b/a/y2/v;
    .locals 6

    new-instance v0, Ln/b/a/y2/b;

    sget-object v1, Ln/b/a/y2/n;->k0:Ln/b/a/o;
    ...
    invoke-direct {v0, v1, v2}, Ln/b/a/y2/b;-><init>(Ln/b/a/o;Ln/b/a/e;)V

    new-instance v1, Ln/b/a/f;

    invoke-direct {v1}, Ln/b/a/f;-><init>()V

    instance-of v2, p2, Ln/b/d/g/n;

    const/4 v3, 0x0

    if-eqz v2, :cond_3

    check-cast p2, Ln/b/d/g/n;

    sget-object v2, Ln/b/a/y2/n;->h0:Ln/b/a/o;

    invoke-interface {p2, v2}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;

    move-result-object v4

    check-cast v4, Ln/b/a/o0;

    if-eqz v4, :cond_0

    invoke-virtual {v4}, Ln/b/a/o0;->j()Ljava/lang/String;
    ...
    new-instance v4, Ln/b/a/o0;

    invoke-direct {v4, p1}, Ln/b/a/o0;-><init>(Ljava/lang/String;)V

    invoke-interface {p2, v2, v4}, Ln/b/d/g/n;->setBagAttribute(Ln/b/a/o;Ln/b/a/e;)V

    :cond_1
    invoke-interface {p2}, Ln/b/d/g/n;->getBagAttributeKeys()Ljava/util/Enumeration;
    ...
    sget-object v5, Ln/b/a/y2/n;->i0:Ln/b/a/o;
    ...
    invoke-virtual {v3, v4}, Ln/b/a/f;->a(Ln/b/a/e;)V

    new-instance v5, Ln/b/a/d1;

    invoke-interface {p2, v4}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;

    move-result-object v4

    invoke-direct {v5, v4}, Ln/b/a/d1;-><init>(Ln/b/a/e;)V

    invoke-virtual {v3, v5}, Ln/b/a/f;->a(Ln/b/a/e;)V

    new-instance v4, Ln/b/a/c1;

    invoke-direct {v4, v3}, Ln/b/a/c1;-><init>(Ln/b/a/f;)V
    ...
    invoke-direct {p2}, Ln/b/a/f;-><init>()V

    sget-object v2, Ln/b/a/y2/n;->h0:Ln/b/a/o;

    invoke-virtual {p2, v2}, Ln/b/a/f;->a(Ln/b/a/e;)V

    new-instance v2, Ln/b/a/d1;

    new-instance v3, Ln/b/a/o0;

    invoke-direct {v3, p1}, Ln/b/a/o0;-><init>(Ljava/lang/String;)V

    invoke-direct {v2, v3}, Ln/b/a/d1;-><init>(Ln/b/a/e;)V
    ...
    invoke-virtual {v1, p1}, Ln/b/a/f;->a(Ln/b/a/e;)V

    :cond_4
    new-instance p1, Ln/b/a/y2/v;

    sget-object p2, Ln/b/a/y2/n;->A0:Ln/b/a/o;

    invoke-virtual {v0}, Ln/b/a/y2/b;->g()Ln/b/a/t;

    move-result-object v0

    new-instance v2, Ln/b/a/d1;

    invoke-direct {v2, v1}, Ln/b/a/d1;-><init>(Ln/b/a/f;)V

    invoke-direct {p1, p2, v0, v2}, Ln/b/a/y2/v;-><init>(Ln/b/a/o;Ln/b/a/e;Ln/b/a/w;)V

    return-object p1
.end method

.method private createSubjectKeyId(Ljava/security/PublicKey;)Ln/b/a/f3/m0;
    .locals 1
    ...
    new-instance v0, Ln/b/a/f3/m0;

    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->getDigest(Ln/b/a/f3/n0;)[B

    move-result-object p1

    invoke-direct {v0, p1}, Ln/b/a/f3/m0;-><init>([B)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private doStore(Ljava/io/OutputStream;[CZ)V
    ...
    invoke-direct {v8, v4, v5}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSafeBag(Ljava/lang/String;Ljava/security/cert/Certificate;)Ln/b/a/y2/v;
    ...
    new-instance v2, Ln/b/a/y2/c;

    sget-object v4, Ln/b/a/y2/n;->Z:Ln/b/a/o;
    ...
    invoke-direct {v6, v3}, Ln/b/a/c1;-><init>(Ln/b/a/f;)V

    invoke-virtual {v6}, Ln/b/a/n;->getEncoded()[B

    move-result-object v3

    invoke-direct {v5, v3}, Ln/b/a/y0;-><init>([B)V

    invoke-direct {v2, v4, v5}, Ln/b/a/y2/c;-><init>(Ln/b/a/o;Ln/b/a/e;)V

    new-instance v3, Ln/b/a/y2/o;

    new-instance v5, Ln/b/a/y2/c;

    new-instance v6, Ln/b/a/y0;

    new-instance v7, Ln/b/a/c1;

    invoke-direct {v7, v2}, Ln/b/a/c1;-><init>(Ln/b/a/e;)V

    invoke-virtual {v7}, Ln/b/a/n;->getEncoded()[B

    move-result-object v2

    invoke-direct {v6, v2}, Ln/b/a/y0;-><init>([B)V

    invoke-direct {v5, v4, v6}, Ln/b/a/y2/c;-><init>(Ln/b/a/o;Ln/b/a/e;)V

    invoke-direct {v3, v5, v1}, Ln/b/a/y2/o;-><init>(Ln/b/a/y2/c;Ln/b/a/y2/i;)V

    invoke-virtual {v3, v0, v10}, Ln/b/a/n;->l(Ljava/io/OutputStream;Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    new-instance v5, Ln/b/a/f0;

    new-instance v6, Ln/b/a/h0;

    invoke-direct {v6, v3}, Ln/b/a/h0;-><init>(Ln/b/a/f;)V

    invoke-virtual {v6}, Ln/b/a/n;->getEncoded()[B

    move-result-object v3

    invoke-direct {v5, v3}, Ln/b/a/f0;-><init>([B)V
    ...
    new-instance v6, Ln/b/a/f0;

    new-instance v7, Ln/b/a/h0;

    invoke-direct {v7, v2}, Ln/b/a/h0;-><init>(Ln/b/a/e;)V

    invoke-virtual {v7}, Ln/b/a/n;->getEncoded()[B

    move-result-object v2

    invoke-direct {v6, v2}, Ln/b/a/f0;-><init>([B)V

    invoke-direct {v5, v4, v6}, Ln/b/a/y2/c;-><init>(Ln/b/a/o;Ln/b/a/e;)V

    invoke-direct {v3, v5, v1}, Ln/b/a/y2/o;-><init>(Ln/b/a/y2/c;Ln/b/a/y2/i;)V

    invoke-virtual {v3, v0, v9}, Ln/b/a/n;->l(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    new-instance v14, Ln/b/a/y2/m;

    invoke-direct {v14, v4, v5}, Ln/b/a/y2/m;-><init>([BI)V

    iget-object v4, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->keyAlgorithm:Ln/b/a/o;

    invoke-virtual {v4}, Ln/b/a/o;->I()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v8, v4, v13, v14, v7}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->wrapKey(Ljava/lang/String;Ljava/security/Key;Ln/b/a/y2/m;[C)[B

    move-result-object v4

    new-instance v5, Ln/b/a/f3/b;

    iget-object v15, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->keyAlgorithm:Ln/b/a/o;

    invoke-virtual {v14}, Ln/b/a/y2/m;->g()Ln/b/a/t;

    move-result-object v14

    invoke-direct {v5, v15, v14}, Ln/b/a/f3/b;-><init>(Ln/b/a/o;Ln/b/a/e;)V

    new-instance v14, Ln/b/a/y2/f;

    invoke-direct {v14, v5, v4}, Ln/b/a/y2/f;-><init>(Ln/b/a/f3/b;[B)V

    new-instance v4, Ln/b/a/f;

    invoke-direct {v4}, Ln/b/a/f;-><init>()V

    instance-of v5, v13, Ln/b/d/g/n;

    if-eqz v5, :cond_7

    check-cast v13, Ln/b/d/g/n;

    sget-object v5, Ln/b/a/y2/n;->h0:Ln/b/a/o;

    invoke-interface {v13, v5}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;

    move-result-object v15

    check-cast v15, Ln/b/a/o0;

    if-eqz v15, :cond_4

    invoke-virtual {v15}, Ln/b/a/o0;->j()Ljava/lang/String;
    ...
    :cond_4
    new-instance v15, Ln/b/a/o0;

    invoke-direct {v15, v6}, Ln/b/a/o0;-><init>(Ljava/lang/String;)V

    invoke-interface {v13, v5, v15}, Ln/b/d/g/n;->setBagAttribute(Ln/b/a/o;Ln/b/a/e;)V
    ...
    invoke-direct {v8, v15}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSubjectKeyId(Ljava/security/PublicKey;)Ln/b/a/f3/m0;
    ...
    :cond_6
    invoke-interface {v13}, Ln/b/d/g/n;->getBagAttributeKeys()Ljava/util/Enumeration;
    ...
    check-cast v12, Ln/b/a/o;

    new-instance v15, Ln/b/a/f;

    invoke-direct {v15}, Ln/b/a/f;-><init>()V

    invoke-virtual {v15, v12}, Ln/b/a/f;->a(Ln/b/a/e;)V

    new-instance v11, Ln/b/a/d1;

    invoke-interface {v13, v12}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;

    move-result-object v12

    invoke-direct {v11, v12}, Ln/b/a/d1;-><init>(Ln/b/a/e;)V

    invoke-virtual {v15, v11}, Ln/b/a/f;->a(Ln/b/a/e;)V

    new-instance v11, Ln/b/a/c1;

    invoke-direct {v11, v15}, Ln/b/a/c1;-><init>(Ln/b/a/f;)V

    invoke-virtual {v4, v11}, Ln/b/a/f;->a(Ln/b/a/e;)V
    ...
    new-instance v5, Ln/b/a/f;

    invoke-direct {v5}, Ln/b/a/f;-><init>()V

    invoke-virtual {v8, v6}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->engineGetCertificate(Ljava/lang/String;)Ljava/security/cert/Certificate;

    move-result-object v11

    sget-object v12, Ln/b/a/y2/n;->i0:Ln/b/a/o;

    invoke-virtual {v5, v12}, Ln/b/a/f;->a(Ln/b/a/e;)V

    new-instance v12, Ln/b/a/d1;

    invoke-virtual {v11}, Ljava/security/cert/Certificate;->getPublicKey()Ljava/security/PublicKey;

    move-result-object v11

    invoke-direct {v8, v11}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSubjectKeyId(Ljava/security/PublicKey;)Ln/b/a/f3/m0;

    move-result-object v11

    invoke-direct {v12, v11}, Ln/b/a/d1;-><init>(Ln/b/a/e;)V

    invoke-virtual {v5, v12}, Ln/b/a/f;->a(Ln/b/a/e;)V

    new-instance v11, Ln/b/a/c1;

    invoke-direct {v11, v5}, Ln/b/a/c1;-><init>(Ln/b/a/f;)V
    ...
    sget-object v11, Ln/b/a/y2/n;->h0:Ln/b/a/o;

    invoke-virtual {v5, v11}, Ln/b/a/f;->a(Ln/b/a/e;)V

    new-instance v11, Ln/b/a/d1;

    new-instance v12, Ln/b/a/o0;

    invoke-direct {v12, v6}, Ln/b/a/o0;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v6, v5}, Ln/b/a/c1;-><init>(Ln/b/a/f;)V

    invoke-virtual {v4, v6}, Ln/b/a/f;->a(Ln/b/a/e;)V

    :cond_9
    new-instance v5, Ln/b/a/y2/v;

    sget-object v6, Ln/b/a/y2/n;->z0:Ln/b/a/o;

    invoke-virtual {v14}, Ln/b/a/y2/f;->g()Ln/b/a/t;

    move-result-object v11

    new-instance v12, Ln/b/a/d1;

    invoke-direct {v12, v4}, Ln/b/a/d1;-><init>(Ln/b/a/f;)V

    invoke-direct {v5, v6, v11, v12}, Ln/b/a/y2/v;-><init>(Ln/b/a/o;Ln/b/a/e;Ln/b/a/w;)V
    ...
    invoke-virtual {v3, v10}, Ln/b/a/n;->n(Ljava/lang/String;)[B

    move-result-object v1

    new-instance v11, Ln/b/a/f0;

    invoke-direct {v11, v1}, Ln/b/a/f0;-><init>([B)V
    ...
    new-instance v4, Ln/b/a/y2/m;

    invoke-direct {v4, v1, v5}, Ln/b/a/y2/m;-><init>([BI)V

    new-instance v13, Ln/b/a/f3/b;

    iget-object v1, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->certAlgorithm:Ln/b/a/o;

    invoke-virtual {v4}, Ln/b/a/y2/m;->g()Ln/b/a/t;

    move-result-object v4

    invoke-direct {v13, v1, v4}, Ln/b/a/f3/b;-><init>(Ln/b/a/o;Ln/b/a/e;)V
    ...
    new-instance v14, Ln/b/a/y2/b;

    sget-object v15, Ln/b/a/y2/n;->k0:Ln/b/a/o;

    new-instance v12, Ln/b/a/y0;
    ...
    invoke-direct {v12, v4}, Ln/b/a/y0;-><init>([B)V

    invoke-direct {v14, v15, v12}, Ln/b/a/y2/b;-><init>(Ln/b/a/o;Ln/b/a/e;)V

    new-instance v4, Ln/b/a/f;

    invoke-direct {v4}, Ln/b/a/f;-><init>()V

    instance-of v12, v6, Ln/b/d/g/n;

    if-eqz v12, :cond_f

    move-object v12, v6

    check-cast v12, Ln/b/d/g/n;

    sget-object v15, Ln/b/a/y2/n;->h0:Ln/b/a/o;

    invoke-interface {v12, v15}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;

    move-result-object v17

    check-cast v17, Ln/b/a/o0;

    if-eqz v17, :cond_b

    invoke-virtual/range {v17 .. v17}, Ln/b/a/o0;->j()Ljava/lang/String;
    ...
    :cond_b
    new-instance v7, Ln/b/a/o0;

    invoke-direct {v7, v5}, Ln/b/a/o0;-><init>(Ljava/lang/String;)V

    invoke-interface {v12, v15, v7}, Ln/b/d/g/n;->setBagAttribute(Ln/b/a/o;Ln/b/a/e;)V

    :cond_c
    sget-object v7, Ln/b/a/y2/n;->i0:Ln/b/a/o;

    invoke-interface {v12, v7}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;
    ...
    invoke-interface {v12, v7, v15}, Ln/b/d/g/n;->setBagAttribute(Ln/b/a/o;Ln/b/a/e;)V

    :cond_d
    invoke-interface {v12}, Ln/b/d/g/n;->getBagAttributeKeys()Ljava/util/Enumeration;
    ...
    invoke-virtual {v7, v15}, Ln/b/a/f;->a(Ln/b/a/e;)V

    move-object/from16 v18, v9

    new-instance v9, Ln/b/a/d1;

    invoke-interface {v12, v15}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;

    move-result-object v15

    invoke-direct {v9, v15}, Ln/b/a/d1;-><init>(Ln/b/a/e;)V

    invoke-virtual {v7, v9}, Ln/b/a/f;->a(Ln/b/a/e;)V

    new-instance v9, Ln/b/a/c1;

    invoke-direct {v9, v7}, Ln/b/a/c1;-><init>(Ln/b/a/f;)V

    invoke-virtual {v4, v9}, Ln/b/a/f;->a(Ln/b/a/e;)V
    ...
    sget-object v9, Ln/b/a/y2/n;->i0:Ln/b/a/o;
    ...
    invoke-direct {v8, v12}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSubjectKeyId(Ljava/security/PublicKey;)Ln/b/a/f3/m0;

    move-result-object v12

    invoke-direct {v9, v12}, Ln/b/a/d1;-><init>(Ln/b/a/e;)V
    ...
    sget-object v9, Ln/b/a/y2/n;->h0:Ln/b/a/o;
    ...
    invoke-direct {v12, v5}, Ln/b/a/o0;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v5, v7}, Ln/b/a/c1;-><init>(Ln/b/a/f;)V
    ...
    sget-object v7, Ln/b/a/y2/n;->A0:Ln/b/a/o;

    invoke-virtual {v14}, Ln/b/a/y2/b;->g()Ln/b/a/t;
    ...
    invoke-direct {v5, v7, v9, v12}, Ln/b/a/y2/v;-><init>(Ln/b/a/o;Ln/b/a/e;Ln/b/a/w;)V
    ...
    :cond_12
    invoke-direct {v8, v5, v6}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSafeBag(Ljava/lang/String;Ljava/security/cert/Certificate;)Ln/b/a/y2/v;
    ...
    :cond_15
    new-instance v7, Ln/b/a/y2/b;

    sget-object v9, Ln/b/a/y2/n;->k0:Ln/b/a/o;
    ...
    invoke-direct {v12, v14}, Ln/b/a/y0;-><init>([B)V

    invoke-direct {v7, v9, v12}, Ln/b/a/y2/b;-><init>(Ln/b/a/o;Ln/b/a/e;)V

    new-instance v9, Ln/b/a/f;

    invoke-direct {v9}, Ln/b/a/f;-><init>()V

    instance-of v12, v6, Ln/b/d/g/n;

    if-eqz v12, :cond_17

    check-cast v6, Ln/b/d/g/n;

    invoke-interface {v6}, Ln/b/d/g/n;->getBagAttributeKeys()Ljava/util/Enumeration;
    ...
    check-cast v14, Ln/b/a/o;

    sget-object v15, Ln/b/a/y2/n;->i0:Ln/b/a/o;

    invoke-virtual {v14, v15}, Ln/b/a/t;->v(Ln/b/a/t;)Z
    ...
    invoke-virtual {v15, v14}, Ln/b/a/f;->a(Ln/b/a/e;)V

    move-object/from16 v16, v1

    new-instance v1, Ln/b/a/d1;

    invoke-interface {v6, v14}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;

    move-result-object v14

    invoke-direct {v1, v14}, Ln/b/a/d1;-><init>(Ln/b/a/e;)V

    invoke-virtual {v15, v1}, Ln/b/a/f;->a(Ln/b/a/e;)V

    new-instance v1, Ln/b/a/c1;

    invoke-direct {v1, v15}, Ln/b/a/c1;-><init>(Ln/b/a/f;)V

    invoke-virtual {v9, v1}, Ln/b/a/f;->a(Ln/b/a/e;)V
    ...
    new-instance v1, Ln/b/a/y2/v;

    sget-object v6, Ln/b/a/y2/n;->A0:Ln/b/a/o;

    invoke-virtual {v7}, Ln/b/a/y2/b;->g()Ln/b/a/t;

    move-result-object v7

    new-instance v12, Ln/b/a/d1;

    invoke-direct {v12, v9}, Ln/b/a/d1;-><init>(Ln/b/a/f;)V

    invoke-direct {v1, v6, v7, v12}, Ln/b/a/y2/v;-><init>(Ln/b/a/o;Ln/b/a/e;Ln/b/a/w;)V

    invoke-virtual {v3, v1}, Ln/b/a/f;->a(Ln/b/a/e;)V
    :try_end_3
    ...
    invoke-virtual {v1, v10}, Ln/b/a/n;->n(Ljava/lang/String;)[B
    ...
    invoke-virtual/range {v1 .. v6}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->cryptData(ZLn/b/a/f3/b;[CZ[B)[B

    move-result-object v1

    new-instance v2, Ln/b/a/y2/e;

    sget-object v3, Ln/b/a/y2/n;->Z:Ln/b/a/o;

    new-instance v4, Ln/b/a/f0;

    invoke-direct {v4, v1}, Ln/b/a/f0;-><init>([B)V

    invoke-direct {v2, v3, v13, v4}, Ln/b/a/y2/e;-><init>(Ln/b/a/o;Ln/b/a/f3/b;Ln/b/a/e;)V

    const/4 v1, 0x2

    new-array v1, v1, [Ln/b/a/y2/c;

    new-instance v4, Ln/b/a/y2/c;

    invoke-direct {v4, v3, v11}, Ln/b/a/y2/c;-><init>(Ln/b/a/o;Ln/b/a/e;)V
    ...
    sget-object v5, Ln/b/a/y2/n;->b0:Ln/b/a/o;

    invoke-virtual {v2}, Ln/b/a/y2/e;->g()Ln/b/a/t;

    move-result-object v2

    invoke-direct {v4, v5, v2}, Ln/b/a/y2/c;-><init>(Ln/b/a/o;Ln/b/a/e;)V

    const/4 v2, 0x1

    aput-object v4, v1, v2

    new-instance v2, Ln/b/a/y2/a;

    invoke-direct {v2, v1}, Ln/b/a/y2/a;-><init>([Ln/b/a/y2/c;)V
    ...
    :goto_a
    invoke-virtual {v2, v1}, Ln/b/a/n;->n(Ljava/lang/String;)[B

    move-result-object v1

    new-instance v9, Ln/b/a/y2/c;

    new-instance v2, Ln/b/a/f0;

    invoke-direct {v2, v1}, Ln/b/a/f0;-><init>([B)V

    invoke-direct {v9, v3, v2}, Ln/b/a/y2/c;-><init>(Ln/b/a/o;Ln/b/a/e;)V
    ...
    invoke-virtual {v9}, Ln/b/a/y2/c;->p()Ln/b/a/e;
    ...
    :try_start_4
    iget-object v1, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->macAlgorithm:Ln/b/a/f3/b;
    ...
    invoke-direct/range {v1 .. v7}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->calculatePbeMac(Ln/b/a/o;[BI[CZ[B)[B

    move-result-object v1

    new-instance v2, Ln/b/a/f3/r;

    iget-object v3, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->macAlgorithm:Ln/b/a/f3/b;

    invoke-direct {v2, v3, v1}, Ln/b/a/f3/r;-><init>(Ln/b/a/f3/b;[B)V

    new-instance v1, Ln/b/a/y2/i;

    iget v3, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->itCount:I

    invoke-direct {v1, v2, v11, v3}, Ln/b/a/y2/i;-><init>(Ln/b/a/f3/r;[BI)V
    :try_end_4
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_4} :catch_4

    new-instance v2, Ln/b/a/y2/o;

    invoke-direct {v2, v9, v1}, Ln/b/a/y2/o;-><init>(Ln/b/a/y2/c;Ln/b/a/y2/i;)V
    ...
    :goto_b
    invoke-virtual {v2, v0, v9}, Ln/b/a/n;->l(Ljava/io/OutputStream;Ljava/lang/String;)V
...
.method private static getDigest(Ln/b/a/f3/n0;)[B
    .locals 4
    ...
    invoke-virtual {p0}, Ln/b/a/f3/n0;->u()Ln/b/a/p0;
    ...
    invoke-interface {v0, p0, v3, v2}, Ln/b/b/r;->update([BII)V

    invoke-interface {v0, v1, v3}, Ln/b/b/r;->doFinal([BI)I
...
.method private validateIterationCount(Ljava/math/BigInteger;)I
    ...
    invoke-static {v0}, Ln/b/g/l;->a(Ljava/lang/String;)Ljava/math/BigInteger;
...
# virtual methods
.method protected cryptData(ZLn/b/a/f3/b;[CZ[B)[B
    .locals 4
    ...
    :goto_0
    sget-object v1, Ln/b/a/y2/n;->B0:Ln/b/a/o;
    ...
    invoke-static {p2}, Ln/b/a/y2/m;->r(Ljava/lang/Object;)Ln/b/a/y2/m;
    ...
    invoke-virtual {p2}, Ln/b/a/y2/m;->p()[B

    move-result-object v3

    invoke-virtual {p2}, Ln/b/a/y2/m;->t()Ljava/math/BigInteger;
    ...
    invoke-direct {p2, p3, p4}, Ln/b/c/i;-><init>([CZ)V

    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ln/b/c/w/c;

    invoke-virtual {v0}, Ln/b/a/o;->I()Ljava/lang/String;

    move-result-object p4

    invoke-interface {p3, p4}, Ln/b/c/w/c;->b(Ljava/lang/String;)Ljavax/crypto/Cipher;
    ...
    :cond_1
    sget-object p4, Ln/b/a/y2/n;->J:Ln/b/a/o;

    invoke-virtual {v0, p4}, Ln/b/a/t;->v(Ln/b/a/t;)Z
    ...
    :try_start_1
    invoke-direct {p0, p1, p3, p2}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createCipher(I[CLn/b/a/f3/b;)Ljavax/crypto/Cipher;
...
.method public engineGetCertificateChain(Ljava/lang/String;)[Ljava/security/cert/Certificate;
    ...
    sget-object v3, Ln/b/a/f3/u;->e2:Ln/b/a/o;
    ...
    invoke-virtual {v3}, Ln/b/a/p;->E()[B

    move-result-object v3

    invoke-static {v3}, Ln/b/a/f3/i;->p(Ljava/lang/Object;)Ln/b/a/f3/i;

    move-result-object v3

    invoke-virtual {v3}, Ln/b/a/f3/i;->r()[B
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-direct {v0, v1}, Ln/b/a/k;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-static {v0}, Ln/b/a/y2/o;->r(Ljava/lang/Object;)Ln/b/a/y2/o;

    move-result-object v0
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_3

    invoke-virtual {v0}, Ln/b/a/y2/o;->p()Ln/b/a/y2/c;
    ...
    invoke-virtual {v0}, Ln/b/a/y2/o;->t()Ln/b/a/y2/i;
    ...
    invoke-virtual {v0}, Ln/b/a/y2/i;->t()Ln/b/a/f3/r;

    move-result-object v14

    invoke-virtual {v14}, Ln/b/a/f3/r;->p()Ln/b/a/f3/b;

    move-result-object v1

    iput-object v1, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->macAlgorithm:Ln/b/a/f3/b;

    invoke-virtual {v0}, Ln/b/a/y2/i;->u()[B

    move-result-object v15

    invoke-virtual {v0}, Ln/b/a/y2/i;->r()Ljava/math/BigInteger;
    ...
    invoke-virtual {v10}, Ln/b/a/y2/c;->p()Ln/b/a/e;
    ...
    invoke-virtual {v14}, Ln/b/a/f3/r;->r()[B

    move-result-object v14

    invoke-static {v1, v14}, Ln/b/g/a;->s([B[B)Z
    ...
    invoke-static {v0, v14}, Ln/b/g/a;->s([B[B)Z
    ...
    invoke-virtual {v10}, Ln/b/a/y2/c;->r()Ln/b/a/o;

    move-result-object v1

    sget-object v2, Ln/b/a/y2/n;->Z:Ln/b/a/o;
    ...
    invoke-static {v1}, Ln/b/a/y2/a;->t(Ljava/lang/Object;)Ln/b/a/y2/a;

    move-result-object v1

    invoke-virtual {v1}, Ln/b/a/y2/a;->r()[Ln/b/a/y2/c;
    ...
    invoke-virtual {v1}, Ln/b/a/y2/c;->r()Ln/b/a/o;
    ...
    invoke-virtual {v1}, Ln/b/a/y2/c;->p()Ln/b/a/e;
    ...
    invoke-static {v3}, Ln/b/a/y2/v;->u(Ljava/lang/Object;)Ln/b/a/y2/v;

    move-result-object v3

    invoke-virtual {v3}, Ln/b/a/y2/v;->r()Ln/b/a/o;

    move-result-object v4

    sget-object v5, Ln/b/a/y2/n;->z0:Ln/b/a/o;
    ...
    invoke-virtual {v3}, Ln/b/a/y2/v;->t()Ln/b/a/e;

    move-result-object v4

    invoke-static {v4}, Ln/b/a/y2/f;->t(Ljava/lang/Object;)Ln/b/a/y2/f;

    move-result-object v4

    invoke-virtual {v4}, Ln/b/a/y2/f;->r()Ln/b/a/f3/b;

    move-result-object v5

    invoke-virtual {v4}, Ln/b/a/y2/f;->p()[B

    move-result-object v4

    invoke-virtual {v8, v5, v4, v9, v0}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->unwrapKey(Ln/b/a/f3/b;[B[CZ)Ljava/security/PrivateKey;

    move-result-object v4

    invoke-virtual {v3}, Ln/b/a/y2/v;->p()Ln/b/a/w;
    ...
    invoke-virtual {v3}, Ln/b/a/w;->I()Ljava/util/Enumeration;
    ...
    invoke-virtual {v7, v13}, Ln/b/a/u;->E(I)Ln/b/a/e;

    move-result-object v18

    move-object/from16 v13, v18

    check-cast v13, Ln/b/a/o;

    invoke-virtual {v7, v12}, Ln/b/a/u;->E(I)Ln/b/a/e;

    move-result-object v7

    check-cast v7, Ln/b/a/w;

    invoke-virtual {v7}, Ln/b/a/w;->size()I
    ...
    invoke-virtual {v7, v12}, Ln/b/a/w;->H(I)Ln/b/a/e;

    move-result-object v7

    check-cast v7, Ln/b/a/t;

    instance-of v12, v4, Ln/b/d/g/n;
    ...
    invoke-interface {v12, v13}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;

    move-result-object v20

    if-eqz v20, :cond_7

    invoke-interface/range {v20 .. v20}, Ln/b/a/e;->g()Ln/b/a/t;

    move-result-object v12

    invoke-virtual {v12, v7}, Ln/b/a/t;->v(Ln/b/a/t;)Z
    ...
    :cond_7
    invoke-interface {v12, v13, v7}, Ln/b/d/g/n;->setBagAttribute(Ln/b/a/o;Ln/b/a/e;)V
    ...
    :cond_9
    :goto_5
    sget-object v12, Ln/b/a/y2/n;->h0:Ln/b/a/o;

    invoke-virtual {v13, v12}, Ln/b/a/t;->v(Ln/b/a/t;)Z

    move-result v12

    if-eqz v12, :cond_a

    check-cast v7, Ln/b/a/o0;

    invoke-virtual {v7}, Ln/b/a/o0;->j()Ljava/lang/String;
    ...
    invoke-static {v7}, Ln/b/g/q/f;->d([B)[B
    ...
    sget-object v5, Ln/b/a/y2/n;->A0:Ln/b/a/o;
    ...
    invoke-static {v3}, Ln/b/a/d3/a;->c(Ljava/lang/Object;)Ljava/lang/String;
    ...
    sget-object v2, Ln/b/a/y2/n;->b0:Ln/b/a/o;
    ...
    invoke-static {v1}, Ln/b/a/y2/e;->t(Ljava/lang/Object;)Ln/b/a/y2/e;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {v1}, Ln/b/a/y2/e;->r()Ln/b/a/f3/b;

    move-result-object v3

    invoke-virtual {v1}, Ln/b/a/y2/e;->p()Ln/b/a/p;
    ...
    invoke-virtual {v1, v12}, Ln/b/a/u;->E(I)Ln/b/a/e;

    move-result-object v2

    invoke-static {v2}, Ln/b/a/y2/v;->u(Ljava/lang/Object;)Ln/b/a/y2/v;

    move-result-object v2

    invoke-virtual {v2}, Ln/b/a/y2/v;->r()Ln/b/a/o;

    move-result-object v3

    sget-object v4, Ln/b/a/y2/n;->A0:Ln/b/a/o;
    ...
    sget-object v4, Ln/b/a/y2/n;->z0:Ln/b/a/o;
    ...
    invoke-virtual {v2}, Ln/b/a/y2/v;->t()Ln/b/a/e;

    move-result-object v3

    invoke-static {v3}, Ln/b/a/y2/f;->t(Ljava/lang/Object;)Ln/b/a/y2/f;

    move-result-object v3

    invoke-virtual {v3}, Ln/b/a/y2/f;->r()Ln/b/a/f3/b;

    move-result-object v4

    invoke-virtual {v3}, Ln/b/a/y2/f;->p()[B

    move-result-object v3

    invoke-virtual {v8, v4, v3, v9, v0}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->unwrapKey(Ln/b/a/f3/b;[B[CZ)Ljava/security/PrivateKey;

    move-result-object v3

    move-object v4, v3

    check-cast v4, Ln/b/d/g/n;

    invoke-virtual {v2}, Ln/b/a/y2/v;->p()Ln/b/a/w;

    move-result-object v2

    invoke-virtual {v2}, Ln/b/a/w;->I()Ljava/util/Enumeration;
    ...
    invoke-virtual {v7, v0}, Ln/b/a/u;->E(I)Ln/b/a/e;
    ...
    invoke-virtual {v7, v1}, Ln/b/a/u;->E(I)Ln/b/a/e;
    ...
    invoke-virtual {v7, v1}, Ln/b/a/w;->H(I)Ln/b/a/e;

    move-result-object v7

    check-cast v7, Ln/b/a/t;

    invoke-interface {v4, v0}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;
    ...
    invoke-virtual {v1, v7}, Ln/b/a/t;->v(Ln/b/a/t;)Z
    ...
    :cond_16
    invoke-interface {v4, v0, v7}, Ln/b/d/g/n;->setBagAttribute(Ln/b/a/o;Ln/b/a/e;)V
    ...
    :goto_a
    sget-object v1, Ln/b/a/y2/n;->h0:Ln/b/a/o;
    ...
    :cond_18
    sget-object v1, Ln/b/a/y2/n;->i0:Ln/b/a/o;
    ...
    sget-object v1, Ln/b/a/y2/n;->y0:Ln/b/a/o;
    ...
    invoke-static {v0}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->getPrivateKey(Ln/b/a/y2/p;)Ljava/security/PrivateKey;

    move-result-object v0

    move-object v1, v0

    check-cast v1, Ln/b/d/g/n;
    ...
    invoke-virtual {v5, v6}, Ln/b/a/u;->E(I)Ln/b/a/e;

    move-result-object v7

    invoke-static {v7}, Ln/b/a/o;->J(Ljava/lang/Object;)Ln/b/a/o;
    ...
    invoke-static {v5}, Ln/b/a/w;->D(Ljava/lang/Object;)Ln/b/a/w;

    move-result-object v5

    invoke-virtual {v5}, Ln/b/a/w;->size()I
    ...
    invoke-virtual {v5, v6}, Ln/b/a/w;->H(I)Ln/b/a/e;

    move-result-object v5

    check-cast v5, Ln/b/a/t;

    invoke-interface {v1, v7}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;
    ...
    invoke-virtual {v6, v5}, Ln/b/a/t;->v(Ln/b/a/t;)Z
    ...
    :cond_1f
    invoke-interface {v1, v7, v5}, Ln/b/d/g/n;->setBagAttribute(Ln/b/a/o;Ln/b/a/e;)V

    :goto_d
    sget-object v6, Ln/b/a/y2/n;->h0:Ln/b/a/o;

    invoke-virtual {v7, v6}, Ln/b/a/t;->v(Ln/b/a/t;)Z

    move-result v6

    if-eqz v6, :cond_20

    check-cast v5, Ln/b/a/o0;

    invoke-virtual {v5}, Ln/b/a/o0;->j()Ljava/lang/String;
    ...
    :cond_20
    sget-object v6, Ln/b/a/y2/n;->i0:Ln/b/a/o;
    ...
    invoke-static {v2}, Ln/b/g/q/f;->d([B)[B
    ...
    invoke-static {v2}, Ln/b/a/d3/a;->c(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v3}, Ln/b/a/y2/c;->r()Ln/b/a/o;
    ...
    invoke-virtual {v2}, Ln/b/a/y2/c;->p()Ln/b/a/e;
    ...
    check-cast v0, Ln/b/a/y2/v;

    invoke-virtual {v0}, Ln/b/a/y2/v;->t()Ln/b/a/e;

    move-result-object v2

    invoke-static {v2}, Ln/b/a/y2/b;->t(Ljava/lang/Object;)Ln/b/a/y2/b;

    move-result-object v2

    invoke-virtual {v2}, Ln/b/a/y2/b;->p()Ln/b/a/o;

    move-result-object v3

    sget-object v4, Ln/b/a/y2/n;->k0:Ln/b/a/o;
    ...
    invoke-virtual {v2}, Ln/b/a/y2/b;->r()Ln/b/a/e;
    ...
    invoke-virtual {v0}, Ln/b/a/y2/v;->p()Ln/b/a/w;
    ...
    invoke-virtual {v0}, Ln/b/a/w;->I()Ljava/util/Enumeration;
    ...
    invoke-virtual {v5, v9}, Ln/b/a/u;->E(I)Ln/b/a/e;
    ...
    instance-of v10, v2, Ln/b/d/g/n;

    if-eqz v10, :cond_2b

    move-object v10, v2

    check-cast v10, Ln/b/d/g/n;

    invoke-interface {v10, v7}, Ln/b/d/g/n;->getBagAttribute(Ln/b/a/o;)Ln/b/a/e;

    move-result-object v13

    if-eqz v13, :cond_2a

    invoke-interface {v13}, Ln/b/a/e;->g()Ln/b/a/t;

    move-result-object v10

    invoke-virtual {v10, v5}, Ln/b/a/t;->v(Ln/b/a/t;)Z
    ...
    :cond_2a
    invoke-interface {v10, v7, v5}, Ln/b/d/g/n;->setBagAttribute(Ln/b/a/o;Ln/b/a/e;)V

    :cond_2b
    :goto_12
    sget-object v10, Ln/b/a/y2/n;->h0:Ln/b/a/o;

    invoke-virtual {v7, v10}, Ln/b/a/t;->v(Ln/b/a/t;)Z
    ...
    :cond_2c
    sget-object v10, Ln/b/a/y2/n;->i0:Ln/b/a/o;
    ...
    invoke-direct {v8, v3}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSubjectKeyId(Ljava/security/PublicKey;)Ln/b/a/f3/m0;

    move-result-object v3

    invoke-virtual {v3}, Ln/b/a/f3/m0;->p()[B

    move-result-object v3

    invoke-static {v3}, Ln/b/g/q/f;->d([B)[B
    ...
    invoke-static {v4}, Ln/b/g/q/f;->d([B)[B
...
.method public engineStore(Ljava/security/KeyStore$LoadStoreParameter;)V
    ...
    check-cast v0, Ln/b/c/k;

    goto :goto_1

    :cond_2
    new-instance v0, Ln/b/c/k;
    ...
    invoke-direct {v0, v2, v3, v1}, Ln/b/c/k;-><init>(Ljava/io/OutputStream;Ljava/security/KeyStore$ProtectionParameter;Z)V
    ...
    :goto_2
    invoke-virtual {v0}, Ln/b/c/k;->getOutputStream()Ljava/io/OutputStream;

    move-result-object v1

    invoke-virtual {v0}, Ln/b/c/k;->isForDEREncoding()Z
...
.method protected unwrapKey(Ln/b/a/f3/b;[B[CZ)Ljava/security/PrivateKey;
    .locals 6
    ...
    invoke-static {p1}, Ln/b/a/y2/m;->r(Ljava/lang/Object;)Ln/b/a/y2/m;

    move-result-object p1

    new-instance v1, Ljavax/crypto/spec/PBEParameterSpec;

    invoke-virtual {p1}, Ln/b/a/y2/m;->p()[B

    move-result-object v5

    invoke-virtual {p1}, Ln/b/a/y2/m;->t()Ljava/math/BigInteger;
    ...
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ln/b/c/w/c;

    invoke-virtual {v0}, Ln/b/a/o;->I()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p1, v0}, Ln/b/c/w/c;->b(Ljava/lang/String;)Ljavax/crypto/Cipher;

    move-result-object p1

    new-instance v0, Ln/b/c/i;

    invoke-direct {v0, p3, p4}, Ln/b/c/i;-><init>([CZ)V
    ...
    invoke-direct {p0, v4, p3, p1}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createCipher(I[CLn/b/a/f3/b;)Ljavax/crypto/Cipher;
...
.method protected wrapKey(Ljava/lang/String;Ljava/security/Key;Ln/b/a/y2/m;[C)[B
    .locals 3
    ...
    :try_start_0
    iget-object p4, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ln/b/c/w/c;

    invoke-interface {p4, p1}, Ln/b/c/w/c;->d(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;

    move-result-object p4

    new-instance v1, Ljavax/crypto/spec/PBEParameterSpec;

    invoke-virtual {p3}, Ln/b/a/y2/m;->p()[B

    move-result-object v2

    invoke-virtual {p3}, Ln/b/a/y2/m;->t()Ljava/math/BigInteger;
    ...
    invoke-interface {p3, p1}, Ln/b/c/w/c;->b(Ljava/lang/String;)Ljavax/crypto/Cipher;
