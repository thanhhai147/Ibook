...
.method protected engineGenerateSecret(Ljava/security/spec/KeySpec;)Ljavax/crypto/SecretKey;
    ...
    instance-of v0, p1, Ln/b/c/v/p;

    if-eqz v0, :cond_4

    check-cast p1, Ln/b/c/v/p;

    invoke-virtual {p1}, Ln/b/c/v/p;->f()[B

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-virtual {p1}, Ln/b/c/v/p;->b()I
    ...
    invoke-virtual {p1}, Ln/b/c/v/p;->c()I

    move-result v0

    if-lez v0, :cond_1

    invoke-virtual {p1}, Ln/b/c/v/p;->e()[C
    ...
    invoke-interface {v1, v2}, Ln/b/b/g;->d([C)[B
    ...
    invoke-virtual {p1}, Ln/b/c/v/p;->a()I

    move-result v6

    invoke-virtual {p1}, Ln/b/c/v/p;->d()I
    ...
    invoke-static/range {v3 .. v8}, Ln/b/b/p0/a0;->i([B[BIIII)[B
    ...
    invoke-direct {p1, v1, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;-><init>(Ljava/lang/String;Ln/b/b/i;)V
