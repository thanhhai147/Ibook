...
.field private macEngine:Ln/b/b/y;
...
.method protected constructor <init>(Ln/b/b/y;)V
    .locals 1
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ln/b/b/y;

    return-void
.end method

.method protected constructor <init>(Ln/b/b/y;III)V
    .locals 1
...
.method protected engineDoFinal()[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ln/b/b/y;
...
.method protected engineGetMacLength()I
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ln/b/b/y;
...
.method protected engineInit(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ln/b/b/y;

    invoke-interface {v3}, Ln/b/b/y;->getAlgorithmName()Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ln/b/b/y;

    invoke-interface {v2}, Ln/b/b/y;->getAlgorithmName()Ljava/lang/String;
    ...
    invoke-interface {v0}, Ln/b/b/y;->getAlgorithmName()Ljava/lang/String;
    ...
    :goto_1
    invoke-static {v0, v4, v2, v5, v1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEMacParameters(Ljavax/crypto/SecretKey;IIILjavax/crypto/spec/PBEParameterSpec;)Ln/b/b/i;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->getParam()Ln/b/b/i;
    ...
    invoke-static {v0, p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEMacParameters(Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;Ljava/security/spec/AlgorithmParameterSpec;)Ln/b/b/i;
    ...
    invoke-direct {v0, v1}, Ln/b/b/u0/a1;-><init>([B)V

    :goto_2
    instance-of v1, v0, Ln/b/b/u0/e1;

    if-eqz v1, :cond_c

    move-object v1, v0

    check-cast v1, Ln/b/b/u0/e1;

    invoke-virtual {v1}, Ln/b/b/u0/e1;->b()Ln/b/b/i;
    ...
    :goto_3
    instance-of v2, p2, Ln/b/c/v/a;

    if-eqz v2, :cond_d

    check-cast p2, Ln/b/c/v/a;

    new-instance v0, Ln/b/b/u0/a;

    invoke-virtual {p2}, Ln/b/c/v/a;->b()I

    move-result p1

    invoke-virtual {p2}, Ln/b/c/v/a;->c()[B

    move-result-object v2

    invoke-virtual {p2}, Ln/b/c/v/a;->a()[B

    move-result-object p2

    invoke-direct {v0, v1, p1, v2, p2}, Ln/b/b/u0/a;-><init>(Ln/b/b/u0/a1;I[B[B)V
    ...
    invoke-direct {v0, v1, p1}, Ln/b/b/u0/e1;-><init>(Ln/b/b/i;[B)V
    ...
    new-instance p1, Ln/b/b/u0/i1;

    invoke-virtual {v1}, Ln/b/b/u0/a1;->a()[B
    ...
    invoke-direct {p1, v1, v2}, Ln/b/b/u0/i1;-><init>([BI)V

    invoke-virtual {p2}, Ljavax/crypto/spec/RC2ParameterSpec;->getIV()[B

    move-result-object p2

    invoke-direct {v0, p1, p2}, Ln/b/b/u0/e1;-><init>(Ln/b/b/i;[B)V

    goto :goto_4

    :cond_f
    instance-of v2, p2, Ln/b/c/v/q;

    if-eqz v2, :cond_10

    new-instance p1, Ln/b/b/u0/o1$b;

    check-cast p2, Ln/b/c/v/q;

    invoke-virtual {p2}, Ln/b/c/v/q;->a()Ljava/util/Map;
    ...
    invoke-direct {p1, p2}, Ln/b/b/u0/o1$b;-><init>(Ljava/util/Hashtable;)V

    invoke-virtual {v1}, Ln/b/b/u0/a1;->a()[B

    move-result-object p2

    invoke-virtual {p1, p2}, Ln/b/b/u0/o1$b;->c([B)Ln/b/b/u0/o1$b;

    invoke-virtual {p1}, Ln/b/b/u0/o1$b;->a()Ln/b/b/u0/o1;
    ...
    invoke-static {v1, p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/GcmSpecUtil;->extractAeadParameters(Ln/b/b/u0/a1;Ljava/security/spec/AlgorithmParameterSpec;)Ln/b/b/u0/a;
    ...
    :goto_4
    :try_start_2
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ln/b/b/y;

    invoke-interface {p1, v0}, Ln/b/b/y;->init(Ln/b/b/i;)V
    :try_end_2
