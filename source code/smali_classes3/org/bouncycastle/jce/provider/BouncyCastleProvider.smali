...
.method private static getAsymmetricKeyInfoConverter(Ln/b/a/o;)Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;
    .locals 1
...
.method public static getPrivateKey(Ln/b/a/y2/p;)Ljava/security/PrivateKey;
    .locals 1
    ...
    invoke-static {v0}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->getAsymmetricKeyInfoConverter(Ln/b/a/o;)Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;->generatePrivate(Ln/b/a/y2/p;)Ljava/security/PrivateKey;
...
.method public static getPublicKey(Ln/b/a/f3/n0;)Ljava/security/PublicKey;
    .locals 1
    ...
    :cond_0
    invoke-interface {v0, p0}, Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;->generatePublic(Ln/b/a/f3/n0;)Ljava/security/PublicKey;
...
.method private loadPQCKeys()V
    ...
    new-instance v1, Ln/b/f/c/a/g/c;

    invoke-direct {v1}, Ln/b/f/c/a/g/c;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ln/b/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ln/b/f/a/e;->f:Ln/b/a/o;

    new-instance v1, Ln/b/f/c/a/d/c;

    invoke-direct {v1}, Ln/b/f/c/a/d/c;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ln/b/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ln/b/f/a/e;->g:Ln/b/a/o;

    new-instance v1, Ln/b/f/c/a/i/f;

    invoke-direct {v1}, Ln/b/f/c/a/i/f;-><init>()V
    ...
    sget-object v0, Ln/b/f/a/e;->l:Ln/b/a/o;

    new-instance v1, Ln/b/f/c/a/i/g;

    invoke-direct {v1}, Ln/b/f/c/a/i/g;-><init>()V
    ...
    new-instance v1, Ln/b/f/c/a/c/f;

    invoke-direct {v1}, Ln/b/f/c/a/c/f;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ln/b/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ln/b/f/a/e;->d:Ln/b/a/o;

    new-instance v1, Ln/b/f/c/a/c/e;

    invoke-direct {v1}, Ln/b/f/c/a/c/e;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ln/b/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ln/b/f/a/e;->a:Ln/b/a/o;

    new-instance v1, Ln/b/f/c/a/f/c;

    invoke-direct {v1}, Ln/b/f/c/a/f/c;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ln/b/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ln/b/f/a/e;->q:Ln/b/a/o;

    new-instance v1, Ln/b/f/c/a/e/c;

    invoke-direct {v1}, Ln/b/f/c/a/e/c;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ln/b/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ln/b/f/a/e;->r:Ln/b/a/o;
    ...
    sget-object v0, Ln/b/a/y2/n;->o0:Ln/b/a/o;

    new-instance v1, Ln/b/f/c/a/b/c;

    invoke-direct {v1}, Ln/b/f/c/a/b/c;-><init>()V
...
.method public addAlgorithm(Ljava/lang/String;Ln/b/a/o;Ljava/lang/String;)V
    .locals 2
...
.method public addKeyInfoConverter(Ln/b/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V
    .locals 1
...
.method public getKeyInfoConverter(Ln/b/a/o;)Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;
    .locals 1
