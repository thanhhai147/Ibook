...
.method static checkCRLsNotEmpty(Ln/b/c/o;Ljava/util/Set;Ljava/lang/Object;)V
    .locals 4
    ...
    invoke-interface {p2}, Ln/b/h/h;->c()Ln/b/h/b;

    move-result-object p2

    invoke-virtual {p2}, Ln/b/h/b;->c()[Ljava/security/Principal;
    ...
    invoke-virtual {p0}, Ln/b/c/o;->a()Ljava/security/cert/CertPath;

    move-result-object v1

    invoke-virtual {p0}, Ln/b/c/o;->b()I
    ...
    sget-object v2, Ln/b/a/e3/f/e;->V:Ln/b/a/e3/e;

    invoke-static {p2}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509Certificate;)Ln/b/a/e3/c;

    move-result-object p2

    invoke-interface {v2, p2}, Ln/b/a/e3/e;->f(Ln/b/a/e3/c;)Ljava/lang/String;
...
.method protected static findCertificates(Ljava/util/LinkedHashSet;Ln/b/c/q;Ljava/util/List;)V
    .locals 2
    ...
    instance-of v1, v0, Ln/b/g/n;

    if-eqz v1, :cond_0

    check-cast v0, Ln/b/g/n;

    :try_start_0
    invoke-interface {v0, p1}, Ln/b/g/n;->getMatches(Ln/b/g/m;)Ljava/util/Collection;
    ...
    :try_start_1
    invoke-static {p1, v0}, Ln/b/c/q;->d(Ln/b/c/q;Ljava/security/cert/CertStore;)Ljava/util/Collection;
...
.method static findIssuerCerts(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-static {p0}, Ln/b/a/f3/i;->p(Ljava/lang/Object;)Ln/b/a/f3/i;

    move-result-object p0

    invoke-virtual {p0}, Ln/b/a/f3/i;->r()[B
    ...
    invoke-direct {p0, v0}, Ln/b/c/q$b;-><init>(Ljava/security/cert/CertSelector;)V
    ...
    :try_start_2
    invoke-static {v0, p0, p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ln/b/c/q;Ljava/util/List;)V

    invoke-static {v0, p0, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ln/b/c/q;Ljava/util/List;)V
    :try_end_2
...
.method static findTargets(Ln/b/c/r;)Ljava/util/Collection;
    .locals 3

    invoke-virtual {p0}, Ln/b/c/r;->b()Ln/b/c/s;

    move-result-object p0

    invoke-virtual {p0}, Ln/b/c/s;->w()Ln/b/c/q;
    ...
    :try_start_0
    invoke-virtual {p0}, Ln/b/c/s;->r()Ljava/util/List;

    move-result-object v2

    invoke-static {v1, v0, v2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ln/b/c/q;Ljava/util/List;)V

    invoke-virtual {p0}, Ln/b/c/s;->q()Ljava/util/List;

    move-result-object p0

    invoke-static {v1, v0, p0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ln/b/c/q;Ljava/util/List;)V
    :try_end_0
    ...
    :cond_0
    invoke-virtual {v0}, Ln/b/c/q;->c()Ljava/security/cert/Certificate;
    ...
    invoke-direct {v0, v1, p0}, Ln/b/d/f/a;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected static findTrustAnchor(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
    ...
    invoke-static {v7}, Ln/b/a/e3/c;->p(Ljava/lang/Object;)Ln/b/a/e3/c;

    move-result-object v7

    invoke-virtual {v5, v7}, Ln/b/a/e3/c;->equals(Ljava/lang/Object;)Z
...
.method static getAdditionalStoresFromCRLDistributionPoint(Ln/b/a/f3/k;Ljava/util/Map;Ljava/util/Date;Ln/b/c/w/c;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v3}, Ln/b/a/f3/s;->t()Ln/b/a/f3/t;

    move-result-object v3

    if-eqz v3, :cond_2

    invoke-virtual {v3}, Ln/b/a/f3/t;->v()I

    move-result v4

    if-nez v4, :cond_2

    invoke-virtual {v3}, Ln/b/a/f3/t;->u()Ln/b/a/e;
    ...
    invoke-interface {p3, p1}, Ln/b/c/w/c;->c(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    invoke-virtual {v2}, Ln/b/a/f3/s;->t()Ln/b/a/f3/t;

    move-result-object v2

    if-eqz v2, :cond_5

    invoke-virtual {v2}, Ln/b/a/f3/t;->v()I

    move-result v3

    if-nez v3, :cond_5

    invoke-virtual {v2}, Ln/b/a/f3/t;->u()Ln/b/a/e;
    ...
    invoke-virtual {v4}, Ln/b/a/f3/w;->v()I
    ...
    check-cast v4, Ln/b/a/z;

    invoke-interface {v4}, Ln/b/a/z;->j()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v5, v4}, Ljava/net/URI;-><init>(Ljava/lang/String;)V

    invoke-static {p1, p2, v5}, Lorg/bouncycastle/jce/provider/CrlCache;->getCrl(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Ln/b/c/l;
...
.method protected static getAlgorithmIdentifier(Ljava/security/PublicKey;)Ln/b/a/f3/b;
    .locals 2
    ...
    invoke-virtual {p0}, Ln/b/a/f3/n0;->p()Ln/b/a/f3/b;
    ...
    invoke-direct {v0, v1, p0}, Ln/b/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    throw v0
.end method

.method protected static getCRLIssuersFromDistributionPoint(Ln/b/a/f3/s;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    .locals 3
...
.method protected static getCertStatus(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;)V
    ...
    :cond_1
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getX500Name(Ljavax/security/auth/x500/X500Principal;)Ln/b/a/e3/c;

    move-result-object p1

    :goto_0
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Ln/b/a/e3/c;

    move-result-object p2

    invoke-virtual {p2, p1}, Ln/b/a/e3/c;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v1}, Ln/b/a/e3/c;->equals(Ljava/lang/Object;)Z
    ...
    :try_start_1
    sget-object p1, Ln/b/a/f3/u;->W1:Ln/b/a/o;

    invoke-virtual {p1}, Ln/b/a/o;->I()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ln/b/a/t;

    move-result-object p1

    invoke-static {p1}, Ln/b/a/g;->D(Ljava/lang/Object;)Ln/b/a/g;
    ...
    :cond_7
    invoke-virtual {p1}, Ln/b/a/g;->I()I
...
.method protected static getCompleteCRLs(Ln/b/c/o;Ln/b/a/f3/s;Ljava/lang/Object;Ln/b/c/s;Ljava/util/Date;)Ljava/util/Set;
    .locals 3
    ...
    invoke-static {p1, v1, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getCRLIssuersFromDistributionPoint(Ln/b/a/f3/s;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    :try_end_0
    .catch Lorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_0
    new-instance p1, Ln/b/c/m$b;

    invoke-direct {p1, v0}, Ln/b/c/m$b;-><init>(Ljava/security/cert/CRLSelector;)V

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Ln/b/c/m$b;->h(Z)Ln/b/c/m$b;

    invoke-virtual {p1}, Ln/b/c/m$b;->g()Ln/b/c/m;

    move-result-object p1

    invoke-virtual {p3}, Ln/b/c/s;->q()Ljava/util/List;

    move-result-object v0

    invoke-virtual {p3}, Ln/b/c/s;->o()Ljava/util/List;

    move-result-object p3

    invoke-static {p1, p4, v0, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ln/b/c/m;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;

    move-result-object p1

    invoke-static {p0, p1, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->checkCRLsNotEmpty(Ln/b/c/o;Ljava/util/Set;Ljava/lang/Object;)V
...
.method protected static getDeltaCRLs(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;Ln/b/c/w/c;)Ljava/util/Set;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ln/b/a/t;
    ...
    new-instance v2, Ln/b/c/m$b;

    invoke-direct {v2, v0}, Ln/b/c/m$b;-><init>(Ljava/security/cert/CRLSelector;)V

    invoke-virtual {v2, p1}, Ln/b/c/m$b;->i([B)V

    const/4 v0, 0x1

    invoke-virtual {v2, v0}, Ln/b/c/m$b;->j(Z)V

    invoke-virtual {v2, v1}, Ln/b/c/m$b;->k(Ljava/math/BigInteger;)V

    invoke-virtual {v2}, Ln/b/c/m$b;->g()Ln/b/c/m;

    move-result-object v0

    invoke-static {v0, p0, p2, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ln/b/c/m;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {p3}, Ln/b/g/l;->c(Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Ln/b/a/f3/k;->r(Ljava/lang/Object;)Ln/b/a/f3/k;

    move-result-object p1

    invoke-virtual {p1}, Ln/b/a/f3/k;->p()[Ln/b/a/f3/s;
    ...
    invoke-static {p3, p0, v5}, Lorg/bouncycastle/jce/provider/CrlCache;->getCrl(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Ln/b/c/l;
    ...
    invoke-static {v0, p0, v5, v4}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ln/b/c/m;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
...
.method protected static getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ln/b/a/t;
    .locals 0
    ...
    :cond_0
    invoke-static {p1, p0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getObject(Ljava/lang/String;[B)Ln/b/a/t;
...
.method protected static getNextWorkingKey(Ljava/util/List;ILn/b/c/w/c;)Ljava/security/PublicKey;
    .locals 4
    ...
    invoke-interface {p2, p0}, Ln/b/c/w/c;->e(Ljava/lang/String;)Ljava/security/KeyFactory;
...
.method private static getObject(Ljava/lang/String;[B)Ln/b/a/t;
    .locals 3
...
.method protected static final getQualifierSet(Ln/b/a/u;)Ljava/util/Set;
    .locals 5
    ...
    invoke-static {v1}, Ln/b/a/r;->a(Ljava/io/OutputStream;)Ln/b/a/r;
    ...
    check-cast v3, Ln/b/a/e;

    invoke-virtual {v2, v3}, Ln/b/a/r;->s(Ln/b/a/e;)V
...
.method protected static getValidCertDateFromValidityModel(Ljava/util/Date;ILjava/security/cert/CertPath;I)Ljava/util/Date;
    ...
    sget-object p3, Ln/b/a/p2/a;->d:Ln/b/a/o;
...
.method protected static getValidityDate(Ln/b/c/s;Ljava/util/Date;)Ljava/util/Date;
    .locals 0

    invoke-virtual {p0}, Ln/b/c/s;->y()Ljava/util/Date;
...
.method protected static prepareNextCertB1(I[Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/security/cert/X509Certificate;)V
    ...
    invoke-static {p4, v3}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ln/b/a/t;
    ...
    invoke-virtual {v3}, Ln/b/a/u;->H()Ljava/util/Enumeration;
    ...
    invoke-static {v5}, Ln/b/a/f3/j0;->p(Ljava/lang/Object;)Ln/b/a/f3/j0;

    move-result-object v5
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1

    invoke-virtual {v5}, Ln/b/a/f3/j0;->r()Ln/b/a/o;
    ...
    :try_start_2
    invoke-virtual {v5}, Ln/b/a/f3/j0;->t()Ln/b/a/u;

    move-result-object v0

    invoke-static {v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getQualifierSet(Ln/b/a/u;)Ljava/util/Set;
    ...
    invoke-direct {p1, p2, p0}, Ln/b/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected static processCertD1i(I[Ljava/util/List;Ln/b/a/o;Ljava/util/Set;)Z
    .locals 12
...
.method protected static processCertD1ii(I[Ljava/util/List;Ln/b/a/o;Ljava/util/Set;)V
    .locals 11
