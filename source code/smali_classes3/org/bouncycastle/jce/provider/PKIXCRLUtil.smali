...
.method static findCRLs(Ln/b/c/m;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 3
    ...
    :try_start_0
    invoke-static {v0, p0, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ljava/util/HashSet;Ln/b/c/m;Ljava/util/List;)V

    invoke-static {v0, p0, p2}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ljava/util/HashSet;Ln/b/c/m;Ljava/util/List;)V
    :try_end_0
    ...
    invoke-virtual {p0}, Ln/b/c/m;->d()Ljava/security/cert/X509Certificate;
...
.method private static findCRLs(Ljava/util/HashSet;Ln/b/c/m;Ljava/util/List;)V
    .locals 6
    ...
    check-cast v2, Ln/b/g/n;

    :try_start_0
    invoke-interface {v2, p1}, Ln/b/g/n;->getMatches(Ln/b/g/m;)Ljava/util/Collection;
    ...
    :try_start_1
    invoke-static {p1, v2}, Ln/b/c/m;->c(Ln/b/c/m;Ljava/security/cert/CertStore;)Ljava/util/Collection;
