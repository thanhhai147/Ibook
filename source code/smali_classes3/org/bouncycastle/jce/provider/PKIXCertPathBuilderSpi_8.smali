...
.method constructor <init>(Z)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi_8;->helper:Ln/b/c/w/c;
...
# virtual methods
.method protected build(Ljava/security/cert/X509Certificate;Ln/b/c/r;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    .locals 5
    ...
    :cond_0
    invoke-virtual {p2}, Ln/b/c/r;->c()Ljava/util/Set;
    ...
    :cond_1
    invoke-virtual {p2}, Ln/b/c/r;->d()I
    ...
    :try_start_1
    invoke-virtual {p2}, Ln/b/c/r;->b()Ln/b/c/s;
    ...
    invoke-virtual {v4}, Ln/b/c/s;->v()Ljava/lang/String;
    ...
    :try_start_5
    sget-object v2, Ln/b/a/f3/u;->N:Ln/b/a/o;
    ...
    invoke-virtual {p0, v2, p2, p3}, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi_8;->build(Ljava/security/cert/X509Certificate;Ln/b/c/r;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-direct {v0, v1}, Ln/b/c/s$b;-><init>(Ljava/security/cert/PKIXParameters;)V
    ...
    invoke-virtual {p1}, Ln/b/h/d;->b()Ljava/util/List;
    ...
    invoke-virtual {v0, v2}, Ln/b/c/s$b;->n(Ln/b/c/p;)Ln/b/c/s$b;

    goto :goto_0

    :cond_0
    new-instance v1, Ln/b/c/r$b;

    invoke-virtual {v0}, Ln/b/c/s$b;->o()Ln/b/c/s;

    move-result-object v0

    invoke-direct {v1, v0}, Ln/b/c/r$b;-><init>(Ln/b/c/s;)V

    invoke-virtual {p1}, Ln/b/h/c;->o()Ljava/util/Set;

    move-result-object v0

    invoke-virtual {v1, v0}, Ln/b/c/r$b;->d(Ljava/util/Set;)Ln/b/c/r$b;

    invoke-virtual {p1}, Ln/b/h/c;->p()I

    move-result p1

    invoke-virtual {v1, p1}, Ln/b/c/r$b;->f(I)Ln/b/c/r$b;

    goto :goto_1

    :cond_1
    new-instance p1, Ln/b/c/r$b;

    invoke-direct {p1, v1}, Ln/b/c/r$b;-><init>(Ljava/security/cert/PKIXBuilderParameters;)V

    move-object v1, p1

    :goto_1
    invoke-virtual {v1}, Ln/b/c/r$b;->e()Ln/b/c/r;
    ...
    invoke-static {p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findTargets(Ln/b/c/r;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v2, p1, v0}, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi_8;->build(Ljava/security/cert/X509Certificate;Ln/b/c/r;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
...
.method public engineGetRevocationChecker()Ljava/security/cert/PKIXCertPathChecker;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi_8;->helper:Ln/b/c/w/c;
