...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->sData:Ln/b/a/w;
...
.method private getCertificate()Ln/b/h/h;
    .locals 3

    iget-object v0, p0, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->sData:Ln/b/a/w;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->sData:Ln/b/a/w;
    ...
    invoke-direct {v1, v0}, Ln/b/h/q;-><init>([B)V
...
.method private readDERCertificate(Ljava/io/InputStream;)Ln/b/h/h;
    .locals 3
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->sData:Ln/b/a/w;

    invoke-direct {p0}, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->getCertificate()Ln/b/h/h;
    ...
    :cond_0
    new-instance v0, Ln/b/h/q;

    invoke-virtual {p1}, Ln/b/a/n;->getEncoded()[B

    move-result-object p1

    invoke-direct {v0, p1}, Ln/b/h/q;-><init>([B)V

    return-object v0
.end method

.method private readPEMCertificate(Ljava/io/InputStream;)Ln/b/h/h;
    .locals 1
...
.method public engineRead()Ljava/lang/Object;
    ...
    :cond_0
    iput-object v1, p0, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->sData:Ln/b/a/w;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->readPEMCertificate(Ljava/io/InputStream;)Ln/b/h/h;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->readDERCertificate(Ljava/io/InputStream;)Ln/b/h/h;
