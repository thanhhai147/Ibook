...
.method public constructor <init>(Ljava/util/List;Ljava/util/List;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Ln/e/b/f;-><init>(Ljava/util/List;)V
...
.method private e(Landroid/content/Context;)Ljava/util/Collection;
    ...
    .line 3
    invoke-virtual {p0}, Ln/e/b/f;->b()Ljava/util/List;
    ...
    check-cast v2, Ln/e/b/l/m;

    .line 4
    invoke-interface {v2, p1}, Ln/e/b/l/m;->createSingletonModules(Landroid/content/Context;)Ljava/util/List;
...
# virtual methods
.method public c(Landroid/content/Context;)Ln/e/b/e;
    .locals 6
    ...
    check-cast v4, Ln/e/b/l/m;

    .line 5
    invoke-interface {v4, p1}, Ln/e/b/l/m;->createInternalModules(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 6
    invoke-interface {v4, p1}, Ln/e/b/l/m;->createExportedModules(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-direct {v2, v0, v1, v3, p1}, Ln/e/b/e;-><init>(Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Collection;)V
...
.method f(Landroid/content/Context;)Ljava/util/Collection;
    ...
    .line 3
    invoke-virtual {p0, p1}, Ln/e/b/f;->a(Landroid/content/Context;)Ljava/util/Collection;
