...
.method private createCircleOptions()Lcom/google/android/gms/maps/model/f;
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/gms/maps/model/f;->v0(Lcom/google/android/gms/maps/model/LatLng;)Lcom/google/android/gms/maps/model/f;

    .line 3
    iget-wide v1, p0, Lversioned/host/exp/exponent/modules/api/components/maps/AirMapCircle;->radius:D

    invoke-virtual {v0, v1, v2}, Lcom/google/android/gms/maps/model/f;->q1(D)Lcom/google/android/gms/maps/model/f;

    .line 4
    iget v1, p0, Lversioned/host/exp/exponent/modules/api/components/maps/AirMapCircle;->fillColor:I

    invoke-virtual {v0, v1}, Lcom/google/android/gms/maps/model/f;->y0(I)Lcom/google/android/gms/maps/model/f;

    .line 5
    iget v1, p0, Lversioned/host/exp/exponent/modules/api/components/maps/AirMapCircle;->strokeColor:I

    invoke-virtual {v0, v1}, Lcom/google/android/gms/maps/model/f;->u1(I)Lcom/google/android/gms/maps/model/f;

    .line 6
    iget v1, p0, Lversioned/host/exp/exponent/modules/api/components/maps/AirMapCircle;->strokeWidth:F

    invoke-virtual {v0, v1}, Lcom/google/android/gms/maps/model/f;->y1(F)Lcom/google/android/gms/maps/model/f;

    .line 7
    iget v1, p0, Lversioned/host/exp/exponent/modules/api/components/maps/AirMapCircle;->zIndex:F

    invoke-virtual {v0, v1}, Lcom/google/android/gms/maps/model/f;->z1(F)Lcom/google/android/gms/maps/model/f;
