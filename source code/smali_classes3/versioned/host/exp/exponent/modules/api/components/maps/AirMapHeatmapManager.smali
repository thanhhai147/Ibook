...
.method public setGradient(Lversioned/host/exp/exponent/modules/api/components/maps/AirMapHeatmap;Lcom/facebook/react/bridge/ReadableMap;)V
    ...
    .line 11
    new-instance v0, Lf/f/e/a/g/a;

    invoke-direct {v0, v1, v3, p2}, Lf/f/e/a/g/a;-><init>([I[FI)V

    invoke-virtual {p1, v0}, Lversioned/host/exp/exponent/modules/api/components/maps/AirMapHeatmap;->setGradient(Lf/f/e/a/g/a;)V

    goto :goto_2

    .line 12
    :cond_2
    new-instance p2, Lf/f/e/a/g/a;

    invoke-direct {p2, v1, v3}, Lf/f/e/a/g/a;-><init>([I[F)V

    invoke-virtual {p1, p2}, Lversioned/host/exp/exponent/modules/api/components/maps/AirMapHeatmap;->setGradient(Lf/f/e/a/g/a;)V
...
.method public setPoints(Lversioned/host/exp/exponent/modules/api/components/maps/AirMapHeatmap;Lcom/facebook/react/bridge/ReadableArray;)V
    ...
    .line 6
    new-instance v5, Lf/f/e/a/g/c;

    invoke-interface {v2, v4}, Lcom/facebook/react/bridge/ReadableMap;->getDouble(Ljava/lang/String;)D

    move-result-wide v6

    invoke-direct {v5, v3, v6, v7}, Lf/f/e/a/g/c;-><init>(Lcom/google/android/gms/maps/model/LatLng;D)V
    ...
    invoke-direct {v5, v3}, Lf/f/e/a/g/c;-><init>(Lcom/google/android/gms/maps/model/LatLng;)V
    ...
    .line 9
    :cond_1
    invoke-virtual {p1, v0}, Lversioned/host/exp/exponent/modules/api/components/maps/AirMapHeatmap;->setPoints([Lf/f/e/a/g/c;)V
