...
.method static parse(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    .line 16
    :goto_1
    sget-object v7, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->s:Ljava/lang/String;
    ...
    :cond_5
    :goto_2
    invoke-static {v4}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->is_cmd(C)Z
    ...
    .line 20
    :cond_7
    invoke-static {v4}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->is_number_start(C)Z
    ...
    invoke-static {v1, v5}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->line(FF)V
    ...
    invoke-static {v5, v7}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->smoothQuadraticBezierCurve(FF)V
    ...
    invoke-static {v5, v7, v8, v9}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->smoothCurve(FFFF)V
    ...
    invoke-static {v5, v7, v8, v9}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->quadraticBezierCurve(FFFF)V
    ...
    invoke-static {v5, v7}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->move(FF)V
    ...
    invoke-static {v5, v7}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->line(FF)V
    ...
    invoke-static {v5, v1}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->line(FF)V
    ...
    .line 34
    :sswitch_a
    sget v5, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->mPenX:F

    invoke-static {}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->parse_list_number()F

    move-result v7

    invoke-static {v5, v7}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->lineTo(FF)V
    ...
    invoke-static {v5, v7}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->smoothQuadraticBezierCurveTo(FF)V
    ...
    invoke-static {v5, v7, v8, v9}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->smoothCurveTo(FFFF)V
    ...
    invoke-static {v5, v7, v8, v9}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->quadraticBezierCurveTo(FFFF)V
    ...
    invoke-static {v5, v7}, Lversioned/host/exp/exponent/modules/api/components/svg/PathParser;->moveTo(FF)V
