...
.method private resolveCharacterPositioning(Lversioned/host/exp/exponent/modules/api/components/svg/TextView;)V
    ...
    :goto_5
    iput-boolean v4, v15, Lversioned/host/exp/exponent/modules/api/components/svg/TextLayoutAlgorithm$CharacterInformation;->anchoredChunk:Z

    if-gez v12, :cond_6

    .line 18
    iget-object v4, v0, Lversioned/host/exp/exponent/modules/api/components/svg/TextLayoutAlgorithm$1CharacterPositioningResolver;->resolve_x:[Ljava/lang/String;
    ...
    .line 19
    :cond_6
    iget-boolean v4, v0, Lversioned/host/exp/exponent/modules/api/components/svg/TextLayoutAlgorithm$1CharacterPositioningResolver;->in_text_path:Z

    const-string v15, ""

    if-eqz v4, :cond_7

    iget-boolean v5, v0, Lversioned/host/exp/exponent/modules/api/components/svg/TextLayoutAlgorithm$1CharacterPositioningResolver;->horizontal:Z

    if-nez v5, :cond_7

    .line 20
    iget-object v5, v0, Lversioned/host/exp/exponent/modules/api/components/svg/TextLayoutAlgorithm$1CharacterPositioningResolver;->resolve_x:[Ljava/lang/String;
    ...
    .line 21
    iget-object v5, v0, Lversioned/host/exp/exponent/modules/api/components/svg/TextLayoutAlgorithm$1CharacterPositioningResolver;->resolve_y:[Ljava/lang/String;
    ...
    .line 22
    iget-boolean v4, v0, Lversioned/host/exp/exponent/modules/api/components/svg/TextLayoutAlgorithm$1CharacterPositioningResolver;->horizontal:Z

    if-eqz v4, :cond_9

    .line 23
    iget-object v4, v0, Lversioned/host/exp/exponent/modules/api/components/svg/TextLayoutAlgorithm$1CharacterPositioningResolver;->resolve_y:[Ljava/lang/String;
    ...
    .line 24
    iget-object v4, v0, Lversioned/host/exp/exponent/modules/api/components/svg/TextLayoutAlgorithm$1CharacterPositioningResolver;->resolve_dx:[Ljava/lang/String;
    ...
    .line 25
    iget-object v4, v0, Lversioned/host/exp/exponent/modules/api/components/svg/TextLayoutAlgorithm$1CharacterPositioningResolver;->resolve_dy:[Ljava/lang/String;
    ...
    iput-wide v13, v4, Lversioned/host/exp/exponent/modules/api/components/svg/TextLayoutAlgorithm$CharacterInformation;->rotate:D
