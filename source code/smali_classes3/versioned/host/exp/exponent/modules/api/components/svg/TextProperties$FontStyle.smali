...
.method static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$FontStyle;

    const-string v3, "italic"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$FontStyle;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$FontStyle;->italic:Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$FontStyle;

    .line 3
    new-instance v3, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$FontStyle;

    const-string v5, "oblique"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$FontStyle;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$FontStyle;->oblique:Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$FontStyle;

    const/4 v5, 0x3

    new-array v5, v5, [Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$FontStyle;
    ...
    .line 4
    sput-object v5, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$FontStyle;->$VALUES:[Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$FontStyle;
