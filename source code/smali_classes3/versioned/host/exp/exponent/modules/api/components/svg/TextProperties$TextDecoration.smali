...
.method static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;
    ...
    invoke-direct {v1, v3, v4, v5}, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v1, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;->Underline:Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;

    .line 3
    new-instance v3, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;
    ...
    invoke-direct {v3, v5, v6, v7}, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v3, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;->Overline:Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;

    .line 4
    new-instance v5, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;
    ...
    invoke-direct {v5, v7, v8, v9}, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v5, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;->LineThrough:Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;

    .line 5
    new-instance v7, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;
    ...
    invoke-direct {v7, v9, v10, v11}, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v7, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;->Blink:Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;

    const/4 v9, 0x5

    new-array v9, v9, [Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;
    ...
    .line 6
    sput-object v9, Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;->$VALUES:[Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$TextDecoration;
