...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lhost/exp/exponent/p/j;Lexpo/modules/notifications/notifications/channels/managers/NotificationsChannelGroupManager;)V
    .locals 0
    ...
    .line 2
    iput-object p2, p0, Lversioned/host/exp/exponent/modules/api/notifications/channels/ScopedNotificationsChannelManager;->mExperienceId:Lhost/exp/exponent/p/j;
...
.method public createNotificationChannel(Ljava/lang/String;Ljava/lang/CharSequence;ILn/e/b/j/c;)Landroid/app/NotificationChannel;
    ...
    .line 1
    iget-object v0, p0, Lversioned/host/exp/exponent/modules/api/notifications/channels/ScopedNotificationsChannelManager;->mExperienceId:Lhost/exp/exponent/p/j;

    invoke-static {v0, p1}, Lversioned/host/exp/exponent/modules/api/notifications/ScopedNotificationsIdUtils;->getScopedChannelId(Lhost/exp/exponent/p/j;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-super {p0, p1, p2, p3, p4}, Lexpo/modules/notifications/notifications/channels/managers/AndroidXNotificationsChannelManager;->createNotificationChannel(Ljava/lang/String;Ljava/lang/CharSequence;ILn/e/b/j/c;)Landroid/app/NotificationChannel;
...
.method public getNotificationChannels()Ljava/util/List;
    ...
    .line 4
    iget-object v3, p0, Lversioned/host/exp/exponent/modules/api/notifications/channels/ScopedNotificationsChannelManager;->mExperienceId:Lhost/exp/exponent/p/j;

    invoke-static {v3, v2}, Lversioned/host/exp/exponent/modules/api/notifications/ScopedNotificationsIdUtils;->checkIfChannelBelongsToExperience(Lhost/exp/exponent/p/j;Landroid/app/NotificationChannel;)Z
