...
.method public constructor <init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V
    ...
    .line 2
    iput-object p2, p0, Lversioned/host/exp/exponent/modules/api/notifications/channels/ScopedNotificationsGroupManager;->mExperienceId:Lhost/exp/exponent/p/j;
...
.method public createNotificationChannelGroup(Ljava/lang/String;Ljava/lang/CharSequence;Ln/e/b/j/c;)Landroid/app/NotificationChannelGroup;
    ...
    .line 1
    iget-object v0, p0, Lversioned/host/exp/exponent/modules/api/notifications/channels/ScopedNotificationsGroupManager;->mExperienceId:Lhost/exp/exponent/p/j;

    invoke-static {v0, p1}, Lversioned/host/exp/exponent/modules/api/notifications/ScopedNotificationsIdUtils;->getScopedGroupId(Lhost/exp/exponent/p/j;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-super {p0, p1, p2, p3}, Lexpo/modules/notifications/notifications/channels/managers/AndroidXNotificationsChannelGroupManager;->createNotificationChannelGroup(Ljava/lang/String;Ljava/lang/CharSequence;Ln/e/b/j/c;)Landroid/app/NotificationChannelGroup;
...
.method public getNotificationChannelGroups()Ljava/util/List;
    ...
    .line 4
    iget-object v3, p0, Lversioned/host/exp/exponent/modules/api/notifications/channels/ScopedNotificationsGroupManager;->mExperienceId:Lhost/exp/exponent/p/j;

    invoke-static {v3, v2}, Lversioned/host/exp/exponent/modules/api/notifications/ScopedNotificationsIdUtils;->checkIfGroupBelongsToExperience(Lhost/exp/exponent/p/j;Landroid/app/NotificationChannelGroup;)Z
