...
.method public constructor <init>(Lcom/facebook/react/bridge/ReactContext;)V
    ...
    .line 10
    iput-boolean v0, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mTryRunBatchUpdatesSynchronously:Z
    ...
    .line 13
    new-instance v1, Lversioned/host/exp/exponent/modules/api/reanimated/UpdateContext;

    invoke-direct {v1}, Lversioned/host/exp/exponent/modules/api/reanimated/UpdateContext;-><init>()V

    iput-object v1, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->updateContext:Lversioned/host/exp/exponent/modules/api/reanimated/UpdateContext;
    ...
    iput-object v1, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mUIImplementation:Lcom/facebook/react/uimanager/UIImplementation;
    ...
    iput-object v1, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mCustomEventNamesResolver:Lcom/facebook/react/uimanager/UIManagerModule$CustomEventNamesResolver;
    ...
    iput-object v1, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mEventEmitter:Lcom/facebook/react/modules/core/DeviceEventManagerModule$RCTDeviceEventEmitter;
    ...
    iput-object v1, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mReactChoreographer:Lcom/facebook/react/modules/core/ReactChoreographer;

    .line 18
    new-instance v1, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager$1;

    invoke-direct {v1, p0, p1}, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager$1;-><init>(Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;Lcom/facebook/react/bridge/ReactContext;)V

    iput-object v1, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mChoreographerCallback:Lcom/facebook/react/uimanager/GuardedFrameCallback;
...
.method private performOperations()V
    ...
    .line 2
    iget-object v6, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mOperationsInBatch:Ljava/util/Queue;
    ...
    .line 4
    iget-boolean v0, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mTryRunBatchUpdatesSynchronously:Z

    const/4 v1, 0x0

    .line 5
    iput-boolean v1, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mTryRunBatchUpdatesSynchronously:Z
    ...
    .line 7
    iget-object v8, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mContext:Lcom/facebook/react/bridge/ReactContext;

    new-instance v9, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager$2;
    ...
    invoke-direct/range {v1 .. v6}, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager$2;-><init>(Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;Lcom/facebook/react/bridge/ReactContext;ZLjava/util/concurrent/Semaphore;Ljava/util/Queue;)V
...
.method public enqueueUpdateViewOnNativeThread(ILcom/facebook/react/bridge/WritableMap;Z)V
    ...
    .line 1
    iput-boolean p3, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mTryRunBatchUpdatesSynchronously:Z

    .line 2
    :cond_0
    iget-object p3, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->mOperationsInBatch:Ljava/util/Queue;

    new-instance v0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager$NativeUpdateOperation;

    invoke-direct {v0, p0, p1, p2}, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager$NativeUpdateOperation;-><init>(Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;ILcom/facebook/react/bridge/WritableMap;)V
...
.method public updateProps(ILjava/util/Map;)V
    ...
    .line 7
    iget-object v9, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->uiProps:Ljava/util/Set;
    ...
    .line 8
    invoke-static {v0, v8, v6}, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->addProp(Lcom/facebook/react/bridge/WritableMap;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 9
    :cond_0
    iget-object v9, p0, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->nativeProps:Ljava/util/Set;
    ...
    .line 10
    invoke-static {v2, v8, v6}, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->addProp(Lcom/facebook/react/bridge/WritableMap;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 11
    :cond_1
    invoke-static {v1, v8, v6}, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->addProp(Lcom/facebook/react/bridge/WritableMap;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 13
    invoke-virtual {p0, p1, v2, v7}, Lversioned/host/exp/exponent/modules/api/reanimated/NodesManager;->enqueueUpdateViewOnNativeThread(ILcom/facebook/react/bridge/WritableMap;Z)V
