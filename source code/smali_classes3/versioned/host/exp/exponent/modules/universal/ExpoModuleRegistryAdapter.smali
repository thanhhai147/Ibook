...
.method public createNativeModules(Lhost/exp/exponent/t/i;Lhost/exp/exponent/p/j;Ljava/util/Map;Lorg/json/JSONObject;Ljava/util/List;)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lhost/exp/exponent/t/i;",
    ...
    invoke-virtual {v0, p1}, Lorg/unimodules/adapters/react/e;->c(Landroid/content/Context;)Ln/e/b/e;
    ...
    invoke-direct {v1, p2}, Lversioned/host/exp/exponent/modules/universal/sensors/ScopedAccelerometerService;-><init>(Lhost/exp/exponent/p/j;)V

    invoke-virtual {v0, v1}, Ln/e/b/e;->l(Ln/e/b/l/i;)V

    .line 3
    new-instance v1, Lversioned/host/exp/exponent/modules/universal/sensors/ScopedGravitySensorService;

    invoke-direct {v1, p2}, Lversioned/host/exp/exponent/modules/universal/sensors/ScopedGravitySensorService;-><init>(Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {v1, p2}, Lversioned/host/exp/exponent/modules/universal/sensors/ScopedGyroscopeService;-><init>(Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {v1, p2}, Lversioned/host/exp/exponent/modules/universal/sensors/ScopedLinearAccelerationSensorService;-><init>(Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {v1, p2}, Lversioned/host/exp/exponent/modules/universal/sensors/ScopedMagnetometerService;-><init>(Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {v1, p2}, Lversioned/host/exp/exponent/modules/universal/sensors/ScopedMagnetometerUncalibratedService;-><init>(Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {v1, p2}, Lversioned/host/exp/exponent/modules/universal/sensors/ScopedRotationVectorSensorService;-><init>(Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {v1, p1}, Lversioned/host/exp/exponent/modules/universal/ScopedFilePermissionModule;-><init>(Lhost/exp/exponent/t/i;)V
    ...
    invoke-virtual {v0, v1}, Ln/e/b/e;->j(Ln/e/b/c;)V

    .line 13
    new-instance v1, Lversioned/host/exp/exponent/modules/universal/ScopedErrorRecoveryModule;

    invoke-direct {v1, p1, p4, p2}, Lversioned/host/exp/exponent/modules/universal/ScopedErrorRecoveryModule;-><init>(Landroid/content/Context;Lorg/json/JSONObject;Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {v1, p1, p2}, Lversioned/host/exp/exponent/modules/universal/ScopedPermissionsService;-><init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {p3, p1}, Lversioned/host/exp/exponent/modules/universal/ScopedFacebookModule;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0, p3}, Ln/e/b/e;->j(Ln/e/b/c;)V

    .line 17
    new-instance p3, Lversioned/host/exp/exponent/modules/universal/ScopedAmplitudeModule;

    invoke-direct {p3, p1, p2}, Lversioned/host/exp/exponent/modules/universal/ScopedAmplitudeModule;-><init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {p3, p1, p4, p2}, Lversioned/host/exp/exponent/modules/universal/ScopedFirebaseCoreService;-><init>(Landroid/content/Context;Lorg/json/JSONObject;Lhost/exp/exponent/p/j;)V

    invoke-virtual {v0, p3}, Ln/e/b/e;->l(Ln/e/b/l/i;)V

    .line 19
    new-instance p3, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationsEmitter;

    invoke-direct {p3, p1, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationsEmitter;-><init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {p3, p1, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationsHandler;-><init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {p3, p1, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;-><init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {p3, p1, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationCategoriesModule;-><init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {p3, p1, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;-><init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V
    ...
    invoke-direct {p3, p1, p2}, Lversioned/host/exp/exponent/modules/api/notifications/channels/ScopedNotificationsChannelsProvider;-><init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V
    ...
    invoke-virtual {v0, p2}, Ln/e/b/e;->l(Ln/e/b/l/i;)V

    .line 27
    new-instance p2, Lversioned/host/exp/exponent/modules/universal/ScopedSecureStoreModule;

    invoke-direct {p2, p1}, Lversioned/host/exp/exponent/modules/universal/ScopedSecureStoreModule;-><init>(Lhost/exp/exponent/t/i;)V

    invoke-virtual {v0, p2}, Ln/e/b/e;->j(Ln/e/b/c;)V
    ...
    .line 33
    instance-of p4, p3, Ln/e/b/l/o;

    if-eqz p4, :cond_1

    .line 34
    check-cast p3, Ln/e/b/l/o;

    invoke-virtual {v0, p3}, Ln/e/b/e;->k(Ln/e/b/l/o;)V

    goto :goto_1

    .line 35
    :cond_2
    invoke-virtual {p0, p1, v0}, Lorg/unimodules/adapters/react/b;->getNativeModulesFromModuleRegistry(Lcom/facebook/react/bridge/ReactApplicationContext;Ln/e/b/e;)Ljava/util/List;
