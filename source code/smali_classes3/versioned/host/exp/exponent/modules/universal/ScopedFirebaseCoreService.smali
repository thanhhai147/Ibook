...
.field private mAppOptions:Lf/f/d/f;
...
.method public constructor <init>(Landroid/content/Context;Lorg/json/JSONObject;Lhost/exp/exponent/p/j;)V
    ...
    .line 4
    :goto_0
    invoke-static {p3}, Lversioned/host/exp/exponent/modules/universal/ScopedFirebaseCoreService;->getEncodedExperienceId(Lhost/exp/exponent/p/j;)Ljava/lang/String;
    ...
    .line 6
    invoke-static {p2}, Lversioned/host/exp/exponent/modules/universal/ScopedFirebaseCoreService;->getOptionsFromManifest(Lorg/json/JSONObject;)Lf/f/d/f;

    move-result-object p2

    iput-object p2, p0, Lversioned/host/exp/exponent/modules/universal/ScopedFirebaseCoreService;->mAppOptions:Lf/f/d/f;
    ...
    .line 11
    invoke-static {p1}, Lf/f/d/c;->j(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-virtual {p2}, Lf/f/d/c;->m()Ljava/lang/String;
    ...
    .line 18
    invoke-virtual {p2}, Lf/f/d/c;->f()V
    ...
    .line 28
    iget-object p1, p0, Lversioned/host/exp/exponent/modules/universal/ScopedFirebaseCoreService;->mAppOptions:Lf/f/d/f;

    iget-object p2, p0, Lversioned/host/exp/exponent/modules/universal/ScopedFirebaseCoreService;->mAppName:Ljava/lang/String;

    invoke-virtual {p0, p1, p2}, Lexpo/modules/firebase/core/FirebaseCoreService;->updateFirebaseApp(Lf/f/d/f;Ljava/lang/String;)Lf/f/d/c;
...
.method private static getEncodedExperienceId(Lhost/exp/exponent/p/j;)Ljava/lang/String;
    .locals 2

    .line 1
    :try_start_0
    invoke-virtual {p0}, Lhost/exp/exponent/p/j;->c()Ljava/lang/String;
    ...
    .line 4
    :catch_0
    invoke-virtual {p0}, Lhost/exp/exponent/p/j;->hashCode()I
...
.method private static getOptionsFromManifest(Lorg/json/JSONObject;)Lf/f/d/f;
    .locals 7
    ...
    invoke-static {v2}, Lexpo/modules/firebase/core/FirebaseCoreOptions;->fromJSON(Ljava/util/Map;)Lf/f/d/f;
...
.method protected getAppOptions()Lf/f/d/f;
    ...
    .line 1
    iget-object v0, p0, Lversioned/host/exp/exponent/modules/universal/ScopedFirebaseCoreService;->mAppOptions:Lf/f/d/f;
