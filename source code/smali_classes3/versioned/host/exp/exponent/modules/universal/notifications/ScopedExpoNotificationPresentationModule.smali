...
# instance fields
.field private final mExperienceId:Lhost/exp/exponent/p/j;
...
.method public constructor <init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V
    ...
    .line 2
    iput-object p2, p0, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;->mExperienceId:Lhost/exp/exponent/p/j;
...
.method static synthetic access$100(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;)Lhost/exp/exponent/p/j;
    .locals 0

    .line 1
    iget-object p0, p0, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;->mExperienceId:Lhost/exp/exponent/p/j;
...
.method static synthetic access$300(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;Ljava/lang/String;Ln/e/b/h;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;->doDismissNotificationAsync(Ljava/lang/String;Ln/e/b/h;)V

    return-void
.end method

.method static synthetic access$400(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;[Ljava/lang/String;Ln/e/b/h;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;->dismissSelectedAsync([Ljava/lang/String;Ln/e/b/h;)V

    return-void
.end method

.method private dismissSelectedAsync([Ljava/lang/String;Ln/e/b/h;)V
    .locals 4
    ...
    invoke-direct {v2, p0, v3, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule$3;-><init>(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;Landroid/os/Handler;Ln/e/b/h;)V
...
.method private doDismissNotificationAsync(Ljava/lang/String;Ln/e/b/h;)V
    .locals 0

    .line 1
    invoke-super {p0, p1, p2}, Lexpo/modules/notifications/notifications/presentation/ExpoNotificationPresentationModule;->dismissNotificationAsync(Ljava/lang/String;Ln/e/b/h;)V
...
.method protected createNotificationRequest(Ljava/lang/String;Lexpo/modules/notifications/notifications/model/NotificationContent;Lexpo/modules/notifications/notifications/interfaces/NotificationTrigger;)Lexpo/modules/notifications/notifications/model/NotificationRequest;
    ...
    .line 1
    iget-object v0, p0, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;->mExperienceId:Lhost/exp/exponent/p/j;
    ...
    :cond_0
    invoke-virtual {v0}, Lhost/exp/exponent/p/j;->b()Ljava/lang/String;
...
.method public dismissAllNotificationsAsync(Ln/e/b/h;)V
    .locals 4
    ...
    invoke-direct {v2, p0, v3, p1}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule$2;-><init>(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;Landroid/os/Handler;Ln/e/b/h;)V
...
.method public dismissNotificationAsync(Ljava/lang/String;Ln/e/b/h;)V
    .locals 4
    ...
    invoke-direct {v2, p0, v3, p1, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule$1;-><init>(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;Landroid/os/Handler;Ljava/lang/String;Ln/e/b/h;)V
...
.method protected serializeNotifications(Ljava/util/Collection;)Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedExpoNotificationPresentationModule;->mExperienceId:Lhost/exp/exponent/p/j;

    invoke-virtual {v2, v1, v3}, Lhost/exp/exponent/notifications/o;->b(Lexpo/modules/notifications/notifications/model/Notification;Lhost/exp/exponent/p/j;)Z
