...
.method public constructor <init>(Landroid/content/Context;Lhost/exp/exponent/p/j;)V
    ...
    .line 2
    iput-object p2, p0, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;->mExperienceId:Lhost/exp/exponent/p/j;
...
.method static synthetic access$000(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;)Lhost/exp/exponent/p/j;
    .locals 0

    .line 1
    iget-object p0, p0, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;->mExperienceId:Lhost/exp/exponent/p/j;
...
.method static synthetic access$200(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;Ljava/lang/String;Ln/e/b/h;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;->doCancelScheduledNotificationAsync(Ljava/lang/String;Ln/e/b/h;)V

    return-void
.end method

.method static synthetic access$300(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;[Ljava/lang/String;Ln/e/b/h;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;->cancelSelectedNotificationsAsync([Ljava/lang/String;Ln/e/b/h;)V

    return-void
.end method

.method private cancelSelectedNotificationsAsync([Ljava/lang/String;Ln/e/b/h;)V
    .locals 4
    ...
    invoke-direct {v2, p0, v3, p2}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler$3;-><init>(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;Landroid/os/Handler;Ln/e/b/h;)V
...
.method private doCancelScheduledNotificationAsync(Ljava/lang/String;Ln/e/b/h;)V
    .locals 0

    .line 1
    invoke-super {p0, p1, p2}, Lexpo/modules/notifications/notifications/scheduling/NotificationScheduler;->cancelScheduledNotificationAsync(Ljava/lang/String;Ln/e/b/h;)V
...
.method public cancelAllScheduledNotificationsAsync(Ln/e/b/h;)V
    ...
    invoke-direct {v2, p0, v3, p1}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler$2;-><init>(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;Landroid/os/Handler;Ln/e/b/h;)V
...
.method public cancelScheduledNotificationAsync(Ljava/lang/String;Ln/e/b/h;)V
    ...
    invoke-direct {v2, p0, v3, p2, p1}, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler$1;-><init>(Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;Landroid/os/Handler;Ln/e/b/h;Ljava/lang/String;)V
...
.method protected createNotificationRequest(Ljava/lang/String;Lexpo/modules/notifications/notifications/model/NotificationContent;Lexpo/modules/notifications/notifications/interfaces/NotificationTrigger;)Lexpo/modules/notifications/notifications/model/NotificationRequest;
    ...
    .line 1
    iget-object v0, p0, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;->mExperienceId:Lhost/exp/exponent/p/j;
...
.method protected getSchedulingContext()Landroid/content/Context;
    ...
    instance-of v0, v0, Lhost/exp/exponent/t/i;
    ...
    check-cast v0, Lhost/exp/exponent/t/i;
...
.method protected serializeScheduledNotificationRequests(Ljava/util/Collection;)Ljava/util/Collection;
    ...
    iget-object v3, p0, Lversioned/host/exp/exponent/modules/universal/notifications/ScopedNotificationScheduler;->mExperienceId:Lhost/exp/exponent/p/j;

    invoke-virtual {v2, v1, v3}, Lhost/exp/exponent/notifications/o;->c(Lexpo/modules/notifications/notifications/model/NotificationRequest;Lhost/exp/exponent/p/j;)Z
